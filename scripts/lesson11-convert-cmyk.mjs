/**
 * Lesson 11 — convert CMYK / unsupported 4-channel images to sRGB JPEG (quality 95) via sharp.
 *
 * Usage:
 *   node scripts/lesson11-convert-cmyk.mjs
 *   LESSON11_EXTRACTED="C:/path/to/extracted-exercises -images" node scripts/lesson11-convert-cmyk.mjs
 *
...
const DEFAULT_EXTRACTED = String.raw`C:\Users\Work Account\Desktop\CURSOR\a1-files\lessons\lesson-11\extracted-exercises -images`;

const ROOT = path.resolve(process.env.LESSON11_EXTRACTED || DEFAULT_EXTRACTED);
