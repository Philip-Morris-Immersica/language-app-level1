...
export const exercises: Exercise[] = [
  ...
  // ORDER 1 — Упр. 1: Поздрави
  {
    ...
    order: 1,
    sectionStart: {
      title: 'Поздрави и думи от ежедневието',
      subtitle: 'Националности, числа, храни, семейство, дни, цветове и предмети',
      titleI18n: {
        en: 'Greetings and everyday words',
        fr: 'Salutations et mots de tous les jours',
        ar: 'التحيات وكلمات الحياة اليومية',
        fa: 'سلام‌ها و واژه‌های روزمره',
        uk: 'Вітання та слова повсякденного життя',
        ru: 'Приветствия и слова повседневной жизни',
      },
      subtitleI18n: {
        en: 'Nationalities, numbers, food, family, days, colors and objects',
        fr: 'Nationalités, nombres, aliments, famille, jours, couleurs et objets',
        ar: 'الجنسيات والأرقام والأطعمة والعائلة والأيام والألوان والأشياء',
        fa: 'ملیت‌ها، اعداد، غذاها، خانواده، روزها، رنگ‌ها و اشیاء',
        uk: 'Національності, числа, їжа, родина, дні, кольори та предмети',
        ru: 'Национальности, числа, еда, семья, дни, цвета и предметы',
      },
      theme: 'vocabulary',
    },
    points: 4,
  ...
  // ORDER 17 — Упр. 15: Глаголът „съм" — справочна таблица
  {
    ...
    order: 17,
    sectionStart: {
      title: 'Глаголът „съм", род и множествено число',
      subtitle: 'Лични местоимения, форми на „съм", един, една, едно и множествено число',
      titleI18n: {
        en: 'The verb "съм" (to be), gender and the plural',
        fr: 'Le verbe «съм» (être), le genre et le pluriel',
        ar: 'الفعل «съм» (يكون) والجنس والجمع',
        fa: 'فعل «съм» (بودن)، جنس دستوری و جمع',
        uk: 'Дієслово «съм» (бути), рід і множина',
        ru: 'Глагол «съм» (быть), род и множественное число',
      },
      subtitleI18n: {
        en: 'Personal pronouns, forms of "съм" (to be), "един / една / едно" (one) and the plural',
        fr: 'Pronoms personnels, formes de «съм» (être), «един / една / едно» (un) et le pluriel',
        ar: 'الضمائر الشخصية وصيغ «съм» (يكون) و«един / една / едно» (واحد) والجمع',
        fa: 'ضمایر شخصی، شکل‌های «съм» (بودن)، «един / една / едно» (یک) و جمع',
        uk: 'Особові займенники, форми «съм» (бути), «един / една / едно» (один) і множина',
        ru: 'Личные местоимения, формы «съм» (быть), «един / една / едно» (один) и множественное число',
      },
      theme: 'grammar',
    },
  ...
  // ORDER 25 — Упр. 18: Прилагателни — справочна таблица
  {
    ...
    order: 25,
    sectionStart: {
      title: 'Прилагателни, степенуване и членуване',
      subtitle: 'Род на прилагателните, сравнителна степен и определителен член',
      titleI18n: {
        en: 'Adjectives, comparison and the definite article',
        fr: 'Adjectifs, comparaison et article défini',
        ar: 'الصفات ودرجات المقارنة وأداة التعريف',
        fa: 'صفت‌ها، درجه‌بندی و حرف تعریف',
        uk: 'Прикметники, ступенювання та означений член',
        ru: 'Прилагательные, степени сравнения и определённый член',
      },
      subtitleI18n: {
        en: 'Adjective gender, the comparative and the definite article',
        fr: 'Genre des adjectifs, degré comparatif et article défini',
        ar: 'جنس الصفات ودرجة المقارنة وأداة التعريف',
        fa: 'جنس دستوری صفت‌ها، درجه تطبیقی و حرف تعریف',
        uk: 'Рід прикметників, вищий ступінь і означений член',
        ru: 'Род прилагательных, сравнительная степень и определённый член',
      },
      theme: 'grammar',
    },
  ...
  // ORDER 35 — Упр. 23а: Предлози за място — илюстрирани схеми
  {
    ...
    order: 35,
    sectionStart: {
      title: 'Предлози и сегашно време',
      subtitle: 'Предлози за място, движение и време и спрежение в сегашно време',
      titleI18n: {
        en: 'Prepositions and the present tense',
        fr: 'Prépositions et présent',
        ar: 'حروف الجر والزمن المضارع',
        fa: 'حروف اضافه و زمان حال',
        uk: 'Прийменники та теперішній час',
        ru: 'Предлоги и настоящее время',
      },
      subtitleI18n: {
        en: 'Prepositions of place, movement and time, and present-tense conjugation',
        fr: 'Prépositions de lieu, de mouvement et de temps, et conjugaison au présent',
        ar: 'حروف الجر للمكان والحركة والزمان وتصريف المضارع',
        fa: 'حروف اضافه مکان، حرکت و زمان و صرف زمان حال',
        uk: 'Прийменники місця, руху й часу та дієвідміна в теперішньому часі',
        ru: 'Предлоги места, движения и времени и спряжение в настоящем времени',
      },
      theme: 'grammar',
    },
    cards: [
  ...
  // ORDER 41 — Упр. 25: Кратки притежателни местоимения — справка
  {
    ...
    order: 41,
    sectionStart: {
      title: 'Местоимения и въпросителни думи',
      subtitle: 'Притежателни, показателни и обобщителни местоимения и въпроси',
      titleI18n: {
        en: 'Pronouns and question words',
        fr: 'Pronoms et mots interrogatifs',
        ar: 'الضمائر وكلمات الاستفهام',
        fa: 'ضمیرها و واژه‌های پرسشی',
        uk: 'Займенники та питальні слова',
        ru: 'Местоимения и вопросительные слова',
      },
      subtitleI18n: {
        en: 'Possessive, demonstrative and generalizing pronouns, and questions',
        fr: 'Pronoms possessifs, démonstratifs et généralisants, et questions',
        ar: 'ضمائر الملكية والإشارة والتعميم والأسئلة',
        fa: 'ضمایر ملکی، اشاره و تعمیم و پرسش‌ها',
        uk: 'Присвійні, вказівні й узагальнювальні займенники та питання',
        ru: 'Притяжательные, указательные и обобщительные местоимения и вопросы',
      },
      theme: 'grammar',
    },
