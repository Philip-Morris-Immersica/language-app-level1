...
export const exercises: Exercise[] = [
  ...
  // ORDER 32 — Упр. 21: Употреба на члена в изречения
  {
    ...
    groupSize: 1,
    questions: [
      { id: 'ch01', left: 'Град… е голям.',              options: ['ът', 'а', 'ят', 'я', 'те'],  correctAnswer: 'ът'  },
      { id: 'ch02', left: 'В град… има много хотели.',   options: ['а', 'ът', 'ят', 'я', 'те'],   correctAnswer: 'а'   },
      { id: 'ch03', left: 'Музе… е интересен.',          options: ['ят', 'я', 'ът', 'а', 'те'],   correctAnswer: 'ят'  },
      { id: 'ch04', left: 'В музе… има много хора.',     options: ['я', 'ят', 'ът', 'а', 'те'],    correctAnswer: 'я'   },
      { id: 'ch05', left: 'Болница… е модерна.',         options: ['та', 'то', 'те', 'ът'],        correctAnswer: 'та'  },
      { id: 'ch06', left: 'Училище… е малко.',           options: ['то', 'та', 'те', 'ят'],        correctAnswer: 'то'  },
      { id: 'ch07', left: 'Магазини… са отворени.',      options: ['те', 'ът', 'та', 'то'],        correctAnswer: 'те'  },
      { id: 'ch08', left: 'Къщи… са обзаведени.',        options: ['те', 'та', 'то', 'ът'],        correctAnswer: 'те'  },
      { id: 'ch09', left: 'Кафенета… са затворени.',     options: ['та', 'то', 'те', 'ята'],       correctAnswer: 'та'  },
    ],
  ...
  // ORDER 36 — Упр. 23а: Предлози за място — упражнение (с план на къщата)
  {
    ...
    questions: [
      ...
      { id: 'pm03', left: 'Спалнята е … кухнята.',              options: ['над', 'до', 'в', 'под', 'зад'], correctAnswer: 'над'   },
      { id: 'pm04', left: 'Печката е … кухнята.',               options: ['в', 'до', 'на', 'над', 'зад'],  correctAnswer: 'в'     },
      ...
      { id: 'pm12', left: 'Тоалетната е … банята.',             options: ['до', 'в', 'на', 'пред', 'зад'], correctAnswer: 'до'    },
      { id: 'pm13', left: 'Килимът е … вратата на спалнята.',   options: ['пред', 'зад', 'до', 'в', 'над'], correctAnswer: 'пред' },
    ],
  },
