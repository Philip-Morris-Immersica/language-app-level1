...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 2 — НОВИ ДУМИ 1 (стр. 91): КАК СЕ ЧУВСТВАТЕ? ────────────────────
  {
    ...
    title: 'НОВИ ДУМИ 1',
    subtitle: 'КАК СЕ ЧУВСТВАТЕ?',
    order: 2,
    cards: [
      { id: 'spokoyen',    imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/01-spokoen.jpg`,    label: 'спокоен',              ttsLabel: 'спокоен' },
      ...
      { id: 'dovolen',     imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/03-dovolen.jpg`,    label: 'доволен',              ttsLabel: 'доволен' },
      { id: 'nedovolen',   imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/04-nedovolen.jpg`,  label: 'недоволен',            ttsLabel: 'недоволен' },
      { id: 'shchasliv',   imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/05-shtastliv.jpg`,  label: 'щастлив',              ttsLabel: 'щастлив' },
      { id: 'neshchasten', imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/06-neshtasten.jpg`, label: 'нещастен',             ttsLabel: 'нещастен' },
      { id: 'oburkan',     imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/07-oburkan.jpg`,    label: 'объркан',              ttsLabel: 'объркан' },
      { id: 'samoten',     imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/08-samoten.jpg`,    label: 'самотен',              ttsLabel: 'самотен' },
      { id: 'iznenadan',   imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/09-iznenadan.jpg`,  label: 'изненадан',            ttsLabel: 'изненадан' },
      ...
      { id: 'razstroen',   imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/12-razstroen.jpg`,  label: 'разстроен',            ttsLabel: 'разстроен' },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          ...
          { text: '– Съжалявам. Как да ти помогна?', voiceGender: 'male' },
          { text: '– Имам нужда от шоколад и кафе. Помага ми много, когато съм разстроена.', voiceGender: 'female' },
  ...
  // ─── ORDER 8 — ГРАМАТИКА 2 (стр. 93): Повелително наклонение (правилни) ──────
  {
    ...
    rows: [
      ...
      { pronoun: 'давам',   cells: ['Давай!',    'Давайте!',   'Не давай!',    'Не давайте!'],    ttsText: 'давам. Давай! Давайте! Не давай! Не давайте!',         ttsPrompt: GEMINI_BG_SMOOTH_PROMPT },
    ...
    ttsNotes: [
      'Първо спрежение, например гледам. Заповед: гледай, гледайте. Забрана: не гледай, не гледайте.',
      'Второ спрежение, например говоря. Заповед: говори, говорете. Забрана: не говори, не говорете.',
    ],
  ...
  // ─── ORDER 12 — ГРАМАТИКА 3 (стр. 94): Неправилни глаголи ────────────────────
  {
    ...
    ttsNotes: [
      'Внимание. Забраната се образува от несвършения вид: не влизай, не излизай, не отивай.',
      'Специална форма: дойда прави ела, елате.',
    ],
    ttsNoteModels: ['pro', 'pro'],
  } as GrammarTableExercise,
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          ...
          { text: '– Подобно!', voiceGender: 'female' },
        ],
      },
    ],
  } as unknown as Exercise,
  ...
  // ─── ORDER 24 — Упр. 22 (стр. 97): Свържете думите по модела ────────────────
  {
    ...
    subtitle: 'Модел: търпелив ↔ нетърпелив',
    order: 24,
    points: 9,
    pairs: [
