...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 1 — Упр. 1 (стр. 91): Напишете думите под картинките ─────────────
  {
    ...
    order: 1,
    sectionStart: {
      title: 'Чувства и причини',
      subtitle: 'Нови думи за чувства, „когато" и „защото", диалози и съвети',
      titleI18n: {
        en: 'Feelings and reasons',
        fr: 'Sentiments et raisons',
        ar: 'المشاعر والأسباب',
        fa: 'احساسات و علت‌ها',
        uk: 'Почуття і причини',
        ru: 'Чувства и причины',
      },
      subtitleI18n: {
        en: 'New words for feelings, „когато" (when) and „защото" (because), dialogues and advice',
        fr: 'Nouveaux mots pour les sentiments, «когато» (quand) et «защото» (parce que), dialogues et conseils',
        ar: 'كلمات جديدة عن المشاعر، «когато» (عندما) و«защото» (لأن)، وحوارات ونصائح',
        fa: 'کلمات جدید برای احساسات، «когато» (وقتی که) و «защото» (چون)، گفتگوها و توصیه‌ها',
        uk: 'Нові слова для почуттів, «когато» (коли) і «защото» (тому що), діалоги та поради',
        ru: 'Новые слова для чувств, «когато» (когда) и «защото» (потому что), диалоги и советы',
      },
      theme: 'vocabulary',
    },
    points: 8,
  ...
  // ─── ORDER 2 — НОВИ ДУМИ 1 (стр. 91): КАК СЕ ЧУВСТВАТЕ? ────────────────────
  {
    ...
    cards: [
      ...
      { id: 'shchasliv',   imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/05-shtastliv.jpg`,  label: 'щастлив',              ttsLabel: 'щастлив',  ttsModel: 'flash' },
      ...
      { id: 'iznenadan',   imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/09-iznenadan.jpg`,  label: 'изненадан',            ttsLabel: 'изненадан', ttsModel: 'flash' },
      ...
      { id: 'razstroen',   imageUrl: `${ASSET}/02-novi-dumi-1-chuvstva/12-razstroen.jpg`,  label: 'разстроен',            ttsLabel: 'разстроен', ttsModel: 'pro', ttsPrompt: 'Pronounce the ordinary Bulgarian word „разстроен" as one single fluent word. Stress the SECOND syllable: raz-STRO-en (Раз-СТРО-ен). Do NOT stress the last syllable -ен. Do not spell it out. Do not add explanation or extra words.' },
    ],
  ...
  // ─── ORDER 8 — ГРАМАТИКА 2 (стр. 93): Повелително наклонение (правилни) ──────
  {
    ...
    order: 8,
    sectionStart: {
      title: 'Повелително наклонение',
      subtitle: 'Заповеди и забрани при правилни и неправилни глаголи, диалог в офиса',
      titleI18n: {
        en: 'The imperative mood',
        fr: "L'impératif",
        ar: 'صيغة الأمر',
        fa: 'وجه امری',
        uk: 'Наказовий спосіб',
      ...
      subtitleI18n: {
        en: 'Commands and prohibitions with regular and irregular verbs, plus an office dialogue',
        fr: 'Ordres et interdictions avec des verbes réguliers et irréguliers, plus un dialogue au bureau',
        ar: 'أوامر ونواهٍ مع أفعال قياسية وشاذة، وحوار في المكتب',
        fa: 'دستورها و منع‌ها با فعل‌های باقاعده و بی‌قاعده، به‌همراه گفتگو در دفتر',
        uk: 'Накази й заборони при правильних і неправильних дієсловах, діалог в офісі',
        ru: 'Приказы и запреты у правильных и неправильных глаголов, диалог в офисе',
      },
      theme: 'grammar',
    },
    ...
    rows: [
      ...
      { pronoun: 'работя',  cells: ['Работи!',   'Работете!',  'Не работи!',   'Не работете!'],   ttsText: 'работя. Работи! Работете! Не работИ! Не работете!',    ttsModel: 'pro', ttsPrompt: 'Read aloud clearly and smoothly in standard Bulgarian, in this exact order, without rearranging: работя. Работи! Работете! Не работИ! Не работете! Do not split words into syllables. Do not add extra words. In „Не работИ" the uppercase И marks last-syllable stress (ne rabot-I).' },
      { pronoun: 'говоря',  cells: ['Говори!',   'Говорете!',  'Не говори!',   'Не говорете!'],   ttsText: 'говоря. Говори! Говорете! Не говорИ! Не говорете!',    ttsModel: 'pro', ttsPrompt: 'Read aloud clearly and smoothly in standard Bulgarian, in this exact order, without rearranging: говоря. Говори! Говорете! Не говорИ! Не говорете! Do not split words into syllables. Do not add extra words. In „Не говорИ" the uppercase И marks last-syllable stress (ne govor-I).' },
      ...
      { pronoun: 'мисля',   cells: ['Мисли!',    'Мислете!',   'Не мисли!',    'Не мислете!'],    ttsText: 'мисля. мислИ! Мислете! Не мислИ! Не мислете!',        ttsModel: 'pro', ttsPrompt: 'Read aloud clearly and smoothly in standard Bulgarian, in this exact order, without rearranging: мисля. мислИ! Мислете! Не мислИ! Не мислете! Do not split words into syllables. Do not add extra words. In „мислИ" and „Не мислИ" the uppercase И marks last-syllable stress (misl-I).' },
      ...
      { pronoun: 'правя',   cells: ['Прави!',    'Правете!',   'Не прави!',    'Не правете!'],    ttsText: 'правя. Прави! Правете! Не правИ! Не правете!',         ttsModel: 'pro', ttsPrompt: 'Read the list clearly and smoothly in standard Bulgarian. Speak only these words — no extra explanation. In „Не правИ" stress the LAST syllable: ne prav-I. The uppercase И marks that stress. Other words keep natural stress.' },
  ...
  // ─── ORDER 17 — ДИАЛОЗИ 3 (стр. 95–96): а. Мария, б. Диана, в. Дима ─────────
  {
    ...
    order: 17,
    sectionStart: {
      title: 'Характер и условни изречения',
      subtitle: 'Диалози за хората около нас и изречения с „ако" и „ще"',
      titleI18n: {
        en: 'Character and conditional sentences',
        fr: 'Caractère et phrases conditionnelles',
        ar: 'الشخصية والجمل الشرطية',
        fa: 'شخصیت و جمله‌های شرطی',
        uk: 'Характер і умовні речення',
        ru: 'Характер и условные предложения',
      },
      subtitleI18n: {
        en: 'Dialogues about the people around us and sentences with „ако" (if) and „ще" (will)',
        fr: 'Dialogues sur les personnes autour de nous et phrases avec «ако» (si) et «ще» (futur)',
        ar: 'حوارات عن الناس من حولنا وجمل مع «ако» (إذا) و«ще» (سوف)',
        fa: 'گفتگوها درباره اطرافیان و جمله‌ها با «ако» (اگر) و «ще» (خواهد)',
        uk: 'Діалоги про людей навколо нас і речення з «ако» (якщо) і «ще» (майбутнє)',
        ru: 'Диалоги о людях вокруг нас и предложения с «ако» (если) и «ще» (будущее)',
      },
      theme: 'dialogue',
    },
    sections: [
  ...
  // ─── ORDER 21 — ДОП. Упр. (стр. 96): Бележка на Ива за Ваня — част а. ───────
  {
    ...
    order: 21,
    sectionStart: {
      title: 'Бележки, приятели и сезони',
      subtitle: 'Повелителни бележки и текстове за приятелство и характер',
      titleI18n: {
        en: 'Notes, friends and seasons',
        fr: 'Notes, amis et saisons',
        ar: 'ملاحظات وأصدقاء وفصول السنة',
        fa: 'یادداشت‌ها، دوستان و فصل‌ها',
        uk: 'Нотатки, друзі та пори року',
        ru: 'Записки, друзья и времена года',
      },
      subtitleI18n: {
        en: 'Notes in the imperative and texts about friendship and character',
        fr: 'Notes à l\'impératif et textes sur l\'amitié et le caractère',
        ar: 'ملاحظات بصيغة الأمر ونصوص عن الصداقة والشخصية',
        fa: 'یادداشت‌های امری و متن‌هایی درباره دوستی و شخصیت',
        uk: 'Нотатки в наказовому способі та тексти про дружбу й характер',
        ru: 'Записки в повелительном наклонении и тексты о дружбе и характере',
      },
      theme: 'reading',
    },
    points: 8,
    ...
    sentences: [
      {
        ...
        correctAnswers: ['Гледай', 'чисти', 'пазарувай', 'Яж', 'Помогни', 'Покани', 'Отиди', 'Излез'],
        options: [
          ['Гледай', 'Гледайте', 'Виж'],
          ...
          ['Отиди', 'Отидете', 'Отиваш'],
          ['Излез', 'Излезте', 'Излизай'],
        ],
        acceptableAnswers: [['Гледай', 'гледай'], ['чисти', 'почисти'], ['пазарувай'], ['Яж', 'яж'], ['Помогни', 'помогни'], ['Покани', 'покани'], ['Отиди', 'отиди'], ['Излез', 'излез']],
      },
    ],
  } as WorkbookFillBlankExercise,
