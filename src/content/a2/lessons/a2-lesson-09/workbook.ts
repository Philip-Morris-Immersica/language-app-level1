...
export const workbookExercises: Exercise[] = [
  ...
  // ─── ORDER 28 — WB 1: Трябва да…! → повелителна форма ──────────────────────
  {
    ...
    subtitle2: 'Модел: Трябва да пиете много вода! → Пийте много вода!',
    order: 28,
    points: 9,
    layout: 'single',
    sentences: [
      ...
      { text: 'Не трябва да ядете много сладко! → _____!',
        blanks: [1], correctAnswers: ['Не яжте много сладко'],   options: ['Не яжте много сладко', 'Не яждайте много сладко', 'Не яш много сладко'], acceptableAnswers: [['Не яжте много сладко', 'не яжте много сладко']] },
      ...
      { text: 'Не трябва да вечеряте късно! → _____!',
        blanks: [1], correctAnswers: ['Не вечеряйте късно'], options: ['Не вечеряйте късно', 'Не вечеряй късно', 'Не вечерявате'], acceptableAnswers: [['Не вечеряйте късно', 'не вечеряйте късно']] },
  ...
  // ─── ORDER 30 — WB 3: отрицателна → положителна (неправилни глаголи) ─────────
  {
    ...
    subtitle: 'Модел: Не отивай там! → Иди там!',
    order: 30,
    points: 7,
    layout: 'single',
    sentences: [
