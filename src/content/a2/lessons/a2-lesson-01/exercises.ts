...
export const exercises: Exercise[] = [
  // ORDER 1 — Упр. 1 (стр. 16): думи под картинките (телефони)
  {
    ...
    order: 1,
    sectionStart: {
      title: 'Телефони и телефонни разговори',
      subtitle: 'Думи за телефона и първи разговори по телефона',
      titleI18n: {
        en: 'Phones and phone conversations',
        fr: 'Téléphones et conversations téléphoniques',
        ar: 'الهواتف والمحادثات الهاتفية',
        fa: 'تلفن‌ها و گفتگوهای تلفنی',
        uk: 'Телефони та телефонні розмови',
        ru: 'Телефоны и телефонные разговоры',
      },
      subtitleI18n: {
        en: 'Words for the phone and first phone conversations',
        fr: 'Mots pour le téléphone et premières conversations téléphoniques',
        ar: 'كلمات عن الهاتف وأول محادثات هاتفية',
        fa: 'کلمات مربوط به تلفن و اولین گفتگوهای تلفنی',
        uk: 'Слова про телефон і перші телефонні розмови',
        ru: 'Слова о телефоне и первые телефонные разговоры',
      },
      theme: 'dialogue',
    },
    points: 4,
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          ...
          { text: 'Благодаря, дочуване.', ttsText: 'Благодаря. До чу-ване.', voiceGender: 'male' },
        ],
      },
      {
        id: 'в.',
      ...
      },
      {
        id: 'г.',
        lines: [
          { text: 'Ало, автогарата ли е?', ttsText: 'Ало, авто-гарата ли е?', voiceGender: 'female' },
  ...
  // ORDER 6 — Упр. 6 (стр. 17): подредете фразите в диалози
  {
    ...
    title: 'УПРАЖНЕНИЕ 6',
    instruction: 'Подредете фразите, за да получите диалози. В по-дългите диалози първата фраза е фиксирана (в зелено).',
    order: 6,
    sections: [
      {
        id: 'а.',
  ...
  // ORDER 8 — ГРАМАТИКА 1 (стр. 18): кратки винителни форми
  {
    ...
    order: 8,
    sectionStart: {
      title: 'Кратки винителни местоимения',
      subtitle: 'Глаголи с преки допълнения и кратки форми на местоименията',
      titleI18n: {
        en: 'Short accusative pronouns',
        fr: "Pronoms courts à l'accusatif",
        ar: 'الضمائر القصيرة في حالة النصب',
        fa: 'ضمایر کوتاه حالت مفعولی',
        uk: 'Короткі знахідні займенники',
        ru: 'Краткие винительные местоимения',
      },
      subtitleI18n: {
        en: 'Verbs with direct objects and short pronoun forms',
        fr: 'Verbes avec compléments directs et formes courtes des pronoms',
        ar: 'أفعال بمفعول مباشر والصيغ المختصرة للضمائر',
        fa: 'افعال دارای مفعول مستقیم و شکل‌های کوتاه ضمایر',
        uk: 'Дієслова з прямим додатком і короткі форми займенників',
        ru: 'Глаголы с прямым дополнением и краткие формы местоимений',
      },
      theme: 'grammar',
    },
    ...
    columns: [],
    rows: [
      { pronoun: 'аз',  cells: ['ме', 'Ето ме.'] },
      {
        pronoun: 'ти',
        cells: ['те', 'Ето те.'],
        ttsText: 'ти, те, Ето те.',
        ttsPrompt: 'Make sure the word is clearly in Bulgarian with the right pronunciation; pronounce "ти" distinctly, not as "те". Say "Ето те" as one close, flowing phrase, with no gap between the two words.',
      },
      { pronoun: 'той', cells: ['го', 'Ето го.'] },
      { pronoun: 'тя',  cells: ['я',  'Ето я.']  },
      { pronoun: 'то',  cells: ['го', 'Ето го.'] },
      { pronoun: 'ние', cells: ['ни', 'Ето ни.'] },
      { pronoun: 'вие', cells: ['ви', 'Ето ви.'] },
      { pronoun: 'те',  cells: ['ги', 'Ето ги.'] },
    ],
    notes: [
  ...
  // ORDER 10 — НОВИ ДУМИ: глаголи с преки допълнения (стр. 18–19)
  {
    ...
    order: 10,
    cards: [
      { id: 'gledam',      imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/01-gledam-filma.jpg',                  label: 'Гледам филма.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it. The second word is "filma" and starts with an f-sound; do not pronounce it as "hilma".' },
      { id: 'vizhdam',     imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/02-vizhdam-momcheto.jpg',              label: 'Виждам момчето.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'slusham',     imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/03-slusham-radioto.jpg',               label: 'Слушам радиото.' },
      { id: 'chuvam',      imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/04-chuvam-telefona.jpg',               label: 'Чувам телефона.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it. The last word is "telefona" with clear e-vowels; do not reduce them to i ("tilifona").' },
      { id: 'razbiram',    imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/05-razbiram-uchitelya.jpg',            label: 'Разбирам учителя.' },
      { id: 'pitam',       imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/06-pitam-uchitelya.jpg',               label: 'Питам учителя.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it. The last word is "uchitelya" with a clear e; do not reduce it to "uchitilya".' },
      ...
      { id: 'kanya',       imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/08-kanyam-decata.jpg',                 label: 'Каня децата на рожден ден.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'obicham',     imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/09-obicham-tsvetyata.jpg',             label: 'Обичам цветята.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it. The last word is "tsvetyata" with a t before the ending; do not turn the t into a k ("tsvekyata").' },
      { id: 'haresvam',    imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/10-haresvam-parka.jpg',                label: 'Харесвам парка.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'tseluvam',    imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/11-celuvam-bebe.jpg',                  label: 'Целувам бебето.' },
      { id: 'pregrashtam', imageUrl: '/assets/a2-lesson-01/03-glagoli-s-preki-dopulnienia/12-pregryashtam-deteto.jpg',          label: 'Прегръщам детето.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'pomnya',      imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/01-pomnya-datata.jpg',           label: 'Помня датата.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'zabravyam',   imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/02-zabravyam-klyuchovete.jpg',   label: 'Забравям ключовете.', ttsLabel: 'Забравям ключовете.', ttsModel: 'pro', ttsPrompt: 'Read this whole Bulgarian sentence "Забравям ключовете." once, fluently and at a natural, normal conversational pace, in clear standard Bulgarian with no foreign accent. You MUST pronounce BOTH words fully — first "забравям", then the second word "ключовете". Never stop after the first word. In "ключовете" the stress falls on the second syllable, on the vowel "о": say it as клю-ЧО-ве-те (klyu-CHO-ve-te), clearly stressing the "О". Do not read it syllable by syllable and do not repeat it.' },
      { id: 'tarsya',      imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/03-tarsya-telefona.jpg',         label: 'Търся телефона.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'namiram',     imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/04-namiram-telefona.jpg',        label: 'Намирам телефона.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'iskam',       imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/05-iskam-igrachkata.jpg',        label: 'Искам играчката.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'chakam',      imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/06-chakam-avtobusa.jpg',         label: 'Чакам автобуса.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      { id: 'vklyuchvam',  imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/07-vklyuchvam-lampata.jpg',      label: 'Включвам лампата.', ttsModel: 'flash', ttsPrompt: 'Speak in clear standard Bulgarian, pronouncing every letter exactly as written. Say the last word as "lampata" with a clear m and p — never as "lamkata". Read the phrase as one flowing sentence at a brisk, natural conversational tempo, like normal everyday speech — not slow and not syllable by syllable. Read it only once.' },
      { id: 'izklyuchvam', imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/08-izklyuchvam-lampata.jpg',     label: 'Изключвам лампата.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence aloud exactly once, as one natural fluent sentence in clear standard Bulgarian with correct native stress and no foreign accent. Do not spell it out, do not read it syllable by syllable, and do not repeat it.' },
      ...
      { id: 'otklyuchvam', imageUrl: '/assets/a2-lesson-01/04-gramatika-2-vinitelni-mestoimenia/11-otklyuchvam-vratata.jpg',     label: 'Отключвам вратата.', ttsModel: 'pro', ttsPrompt: 'Read this Bulgarian sentence once, fluently and at a natural, normal conversational speaking pace (not slow), in clear standard Bulgarian with no foreign accent. Pronounce every consonant and vowel fully and exactly as written — do not drop, add or replace any letter. Do not read it syllable by syllable and do not repeat it.' },
  ...
  // ORDER 11 — ГРАМАТИКА 3 (правило преди Упр. 9): заместване на прякото допълнение
  {
    id: 'a2-l01-gramatika-03',
    type: 'grammar_table',
    title: 'ГРАМАТИКА 3',
    instruction: 'Запознайте се с правилото за заместване на прякото допълнение.',
    instructionKey: 'a2.grammar.l01.zamestvane.instruction',
    order: 11,
    tableTitle: 'Кратките винителни местоимения заместват прякото допълнение (кого? какво?)',
    columns: ['Местоимение', 'Пример'],
    rows: [
      { pronoun: 'мъжки род',          cells: ['го', 'телефонът → Виждам телефона. Виждам **го**.'] },
      { pronoun: 'женски род',         cells: ['я',  'масата → Виждам масата. Виждам **я**.'] },
      { pronoun: 'среден род',         cells: ['го', 'кафето → Виждам кафето. Искам **го**.'] },
      { pronoun: 'множествено число',  cells: ['ги', 'децата → Виждам децата. Виждам **ги**.'] },
    ],
  } as GrammarTableExercise,
  ...
  // ORDER 13 — Упр. 9 (стр. 19): замени допълнението с правилното местоимение — dropdown
  {
    id: 'a2-l01-ex-09',
    type: 'dropdown_match',
    instruction: 'Изберете правилното местоимение. Първото е дадено като пример.',
    order: 13,
    points: 29,
    questions: [
      { id: 'model', left: 'Каня Георги на кафе. →', options: [], correctAnswer: 'Каня го на кафе.', isExample: true },
      ...
      { id: 'q4',  left: 'Чувам музиката. →',                     options: ['Чувам я.', 'Чувам го.', 'Чувам ги.'],                           correctAnswer: 'Чувам я.' },
      { id: 'q5',  left: 'Искам пицата. →',                       options: ['Искам я.', 'Искам го.', 'Искам ги.'],                           correctAnswer: 'Искам я.' },
      { id: 'q6',  left: 'Искам кафето. →',                       options: ['Искам го.', 'Искам я.', 'Искам ги.'],                           correctAnswer: 'Искам го.' },
      { id: 'q7',  left: 'Искам сандвичите. →',                   options: ['Искам ги.', 'Искам я.', 'Искам го.'],                           correctAnswer: 'Искам ги.' },
      { id: 'q8',  left: 'Искаш ли ябълката? →',                  options: ['Искаш ли я?', 'Искаш ли го?', 'Искаш ли ги?'],                  correctAnswer: 'Искаш ли я?' },
      { id: 'q9',  left: 'Разбирам Мони и Светла. →',             options: ['Разбирам ги.', 'Разбирам го.', 'Разбирам я.'],                  correctAnswer: 'Разбирам ги.' },
      { id: 'q10', left: 'Каня бежанците на гости. →',            options: ['Каня ги на гости.', 'Каня го на гости.', 'Каня я на гости.'],  correctAnswer: 'Каня ги на гости.' },
      { id: 'q11', left: 'Познаваш ли Асен? →',                   options: ['Познаваш ли го?', 'Познаваш ли я?', 'Познаваш ли ги?'],         correctAnswer: 'Познаваш ли го?' },
      { id: 'q12', left: 'Търся парите. →',                       options: ['Търся ги.', 'Търся го.', 'Търся я.'],                           correctAnswer: 'Търся ги.' },
      { id: 'q13', left: 'Чакам учителите. →',                    options: ['Чакам ги.', 'Чакам го.', 'Чакам я.'],                           correctAnswer: 'Чакам ги.' },
      { id: 'q14', left: 'Обичам Елена. →',                       options: ['Обичам я.', 'Обичам го.', 'Обичам ги.'],                        correctAnswer: 'Обичам я.' },
      { id: 'q15', left: 'Ана целува детето. →',                  options: ['Ана го целува.', 'Ана я целува.', 'Ана ги целува.'],            correctAnswer: 'Ана го целува.' },
      { id: 'q16', left: 'Не харесвам града. →',                  options: ['Не го харесвам.', 'Не я харесвам.', 'Не ги харесвам.'],         correctAnswer: 'Не го харесвам.' },
      { id: 'q17', left: 'Отварят прозореца. →',                  options: ['Отварят го.', 'Отварят я.', 'Отварят ги.'],                     correctAnswer: 'Отварят го.' },
      { id: 'q18', left: 'Не заключвам вратата. →',               options: ['Не я заключвам.', 'Не го заключвам.', 'Не ги заключвам.'],      correctAnswer: 'Не я заключвам.' },
      { id: 'q19', left: 'Затваряме магазина. →',                 options: ['Затваряме го.', 'Затваряме я.', 'Затваряме ги.'],               correctAnswer: 'Затваряме го.' },
      { id: 'q20', left: 'Изключвам телефона. →',                 options: ['Изключвам го.', 'Изключвам я.', 'Изключвам ги.'],               correctAnswer: 'Изключвам го.' },
      { id: 'q21', left: 'Те питат учителката. →',                options: ['Те я питат.', 'Те го питат.', 'Те ги питат.'],                  correctAnswer: 'Те я питат.' },
      { id: 'q22', left: 'Помниш ли това момче? →',               options: ['Помниш ли го?', 'Помниш ли я?', 'Помниш ли ги?'],               correctAnswer: 'Помниш ли го?' },
      { id: 'q23', left: 'Тя включва компютъра. →',               options: ['Тя го включва.', 'Тя я включва.', 'Тя ги включва.'],            correctAnswer: 'Тя го включва.' },
      { id: 'q24', left: 'Аз гледам децата. →',                   options: ['Аз ги гледам.', 'Аз го гледам.', 'Аз я гледам.'],               correctAnswer: 'Аз ги гледам.' },
      { id: 'q25', left: 'Разбираш ли Амал? →',                   options: ['Разбираш ли я?', 'Разбираш ли го?', 'Разбираш ли ги?'],         correctAnswer: 'Разбираш ли я?' },
      { id: 'q26', left: 'Те прегръщат момичето. →',              options: ['Те го прегръщат.', 'Те я прегръщат.', 'Те ги прегръщат.'],      correctAnswer: 'Те го прегръщат.' },
      { id: 'q27', left: 'Той забравя ключа често. →',            options: ['Той го забравя често.', 'Той я забравя често.', 'Той ги забравя често.'], correctAnswer: 'Той го забравя често.' },
      { id: 'q28', left: 'Заключвам офиса в 6:00 часа. →',        options: ['Заключвам го в 6:00 часа.', 'Заключвам я в 6:00 часа.', 'Заключвам ги в 6:00 часа.'], correctAnswer: 'Заключвам го в 6:00 часа.' },
      { id: 'q29', left: 'Намирам нови приятели във Фейсбук. →',  options: ['Намирам ги във Фейсбук.', 'Намирам го във Фейсбук.', 'Намирам я във Фейсбук.'], correctAnswer: 'Намирам ги във Фейсбук.' },
    ],
  } as DropdownMatchExercise,
  ...
  // ORDER 14 — ДИАЛОЗИ 3 (стр. 20)
  {
    ...
    order: 14,
    sectionStart: {
      title: 'Обаждане за работа и за апартамент под наем',
      subtitle: 'Диалози по телефона и обяви за работа и за жилище под наем',
      titleI18n: {
        en: 'Calling about a job and a rental apartment',
        fr: "Appeler pour un emploi et un appartement à louer",
        ar: 'الاتصال بخصوص وظيفة وشقة للإيجار',
        fa: 'تماس تلفنی برای کار و اجارهٔ آپارتمان',
        uk: 'Дзвінок про роботу та квартиру в оренду',
        ru: 'Звонок по поводу работы и квартиры в аренду',
      },
      subtitleI18n: {
        en: 'Phone dialogues and job and rental-apartment ads',
        fr: "Dialogues téléphoniques et annonces d'emploi et de location",
        ar: 'حوارات هاتفية وإعلانات عن وظائف وشقق للإيجار',
        fa: 'گفتگوهای تلفنی و آگهی‌های کار و اجارهٔ آپارتمان',
        uk: 'Телефонні діалоги та оголошення про роботу й оренду житла',
        ru: 'Телефонные диалоги и объявления о работе и аренде жилья',
      },
      theme: 'dialogue',
    },
    sections: [
  ...
  // ORDER 19 — Упр. 12 (стр. 21): направете въпросителни изречения
  {
    ...
    order: 19,
    sectionStart: {
      title: 'Още практика с кратки местоимения',
      titleI18n: {
        en: 'More practice with short pronouns',
        fr: 'Encore de la pratique avec les pronoms courts',
        ar: 'تدريب إضافي على الضمائر القصيرة',
        fa: 'تمرین بیشتر با ضمایر کوتاه',
        uk: 'Ще практика з короткими займенниками',
        ru: 'Ещё практика с краткими местоимениями',
      },
      theme: 'review',
    },
    points: 6,
  ...
  // ORDER 24 — Упр. 17 (стр. 22): профили + телефонни номера — изберете чутия номер
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 17',
    instruction: 'Слушайте и попълнете телефонните номера. Изслушайте отговорите на въпросите „Колко често и за какво използвате телефона?" и ги повторете на глас.',
    order: 24,
    sectionStart: {
      title: 'Телефонни номера',
      subtitle: 'Слушане на профили и телефонни номера',
      titleI18n: {
        en: 'Phone numbers',
        ...
        fa: 'شماره‌های تلفن',
        uk: 'Телефонні номери',
        ru: 'Телефонные номера',
      },
      subtitleI18n: {
        en: 'Listening to profiles and phone numbers',
        fr: 'Écoute de profils et de numéros de téléphone',
        ar: 'الاستماع إلى الملفات الشخصية وأرقام الهاتف',
        fa: 'شنیدن پروفایل‌ها و شماره‌های تلفن',
        uk: 'Прослуховування профілів і телефонних номерів',
        ru: 'Прослушивание профилей и телефонных номеров',
      },
      theme: 'review',
    },
    points: 7,
    ...
    listeningText: 'Милена, на двайсет и четири години. Колко често използвам телефона? Много, много често! Проверявам и отговарям на имейлите, влизам във Фейсбук и Инстаграм. Телефонът ми е за работа и за удоволствие. Телефонният ѝ номер е: нула, осем, осем, шест, три, девет, две, седем, пет, четири. Катя, на трийсет и три години. Много често говоря с мъжа ми, децата, приятелите. Използвам го като часовник, календар. Нямам интернет на телефона и не искам. Имам интернет вкъщи. Телефонният ѝ номер е: нула, осем, девет, четири, едно, две, четири, седем, шест, едно. Иво, на седемнайсет години. Не излизам без телефона. Не излизам от Дискорд и Инстаграм, спя с телефона. Няма телефон, няма живот! Телефонният му номер е: нула, осем, девет, нула, нула, нула, седем, четири, три. Симона, на четирийсет и осем години. Не много често. Обаждам се на приятели, но използвам повече Вайбър. Безплатно е. Децата ми не са в България и говорим само по Скайп. Телефонният ѝ номер е: нула, осем, девет, девет, едно, четири, четири, седем, две, осем, едно. Стефан, на двайсет и девет години. Използвам го през цялото време. Обаждам се, правя снимки, пращам ги на приятели, пращам есемеси. Никога не изключвам телефона, само в самолета. Телефонният му номер е: нула, осем, девет, пет, седем, пет, три, три, осем, нула. Диана, на петдесет и пет години. Не говоря много по телефона. Забравям го често вкъщи. Телефонният ѝ номер е: нула, осем, четири, осем, девет, пет, две, три, три, три. Симеон, на осемдесет и осем години. Имам телефон от дъщеря ми, но имам проблем — не виждам числата добре и не чувам добре. Децата и внуците се обаждат често. Телефонният му номер е: нула, осем, осем, седем, едно, пет, две, три, девет, девет.',
    sentences: [
      {
        ...
        blanks: [1], correctAnswers: ['0886/ 392754'],
        acceptableAnswers: [['0886/ 392754', '0886/392754', '0886392754', '0886 392 754']],
        options: ['0886/ 392754', '0886/ 392745', '0886/ 329754'],
      },
      {
        ...
        blanks: [1], correctAnswers: ['0894/ 124761'],
        acceptableAnswers: [['0894/ 124761', '0894/124761', '0894124761', '0894 124 761']],
        options: ['0894/ 124761', '0894/ 142761', '0894/ 124716'],
      },
      {
        ...
        blanks: [1], correctAnswers: ['0890/ 00743'],
        acceptableAnswers: [['0890/ 00743', '0890/00743', '089000743', '0890 00 743']],
        options: ['0890/ 00743', '0890/ 00734', '0890/ 00473'],
      },
      {
        ...
        acceptableAnswers: [['0899/ 1447281', '0899/1447281', '08991447281', '0899 1447281']],
      ...
      },
      {
        ...
        acceptableAnswers: [['0895/ 753380', '0895/753380', '0895753380', '0895 753 380']],
      ...
      },
      {
        ...
        acceptableAnswers: [['0848/ 952333', '0848/952333', '0848952333', '0848 952 333']],
      ...
      },
      {
        ...
        acceptableAnswers: [['0887/ 152399', '0887/152399', '0887152399', '0887 152 399']],
  ...
  // ORDER 26 — ТЕКСТ + Упр. 19 (стр. 23): Мария и нейният телефон
  {
    ...
    order: 26,
    sectionStart: {
      title: 'Мария и нейният телефон',
      subtitle: 'Текст за четене и въпроси към него',
      titleI18n: {
        en: 'Maria and her phone',
        fr: 'Maria et son téléphone',
        ar: 'ماريا وهاتفها',
        fa: 'ماریا و تلفنش',
        uk: 'Мария та її телефон',
        ru: 'Мария и её телефон',
      },
      subtitleI18n: {
        en: 'A reading text and questions about it',
        fr: 'Un texte de lecture et des questions à ce sujet',
        ar: 'نص للقراءة وأسئلة حوله',
        fa: 'یک متن خوانداری و پرسش‌هایی درباره‌ی آن',
        uk: 'Текст для читання і запитання до нього',
        ru: 'Текст для чтения и вопросы к нему',
      },
      theme: 'reading',
    },
    showDictionary: true,
