...
export const exercises: Exercise[] = [
  ...
  // ORDER 14 — ДИАЛОЗИ 3 (стр. 20)
  {
    ...
    sectionStart: {
      ...
      subtitleI18n: {
        en: 'Phone dialogues, job and rental-apartment ads, and pronoun practice',
        fr: "Dialogues téléphoniques, annonces d'emploi et de location, et exercices sur les pronoms",
        ar: 'حوارات هاتفية، وإعلانات عن وظائف وشقق للإيجار، وتدريبات على الضمائر',
        fa: 'گفتگوهای تلفنی، آگهی‌های کار و اجارهٔ آپارتمان، و تمرین ضمایر',
        uk: 'Телефонні діалоги, оголошення про роботу й оренду житла та вправи на займенники',
        ru: 'Телефонные диалоги, объявления о работе и аренде жилья и упражнения на местоимения',
      },
      theme: 'dialogue',
    },
    sections: [
  ...
  // ORDER 24 — Упр. 17 (стр. 22): профили + телефонни номера — изберете чутия номер
  {
    ...
    order: 24,
    sectionStart: {
      title: 'Телефонът в ежедневието',
      subtitle: 'Телефонни номера, лични навици и текст за Мария',
      titleI18n: {
        en: 'The phone in everyday life',
        fr: 'Le téléphone dans la vie quotidienne',
        ar: 'الهاتف في الحياة اليومية',
        fa: 'تلفن در زندگی روزمره',
        uk: 'Телефон у повсякденному житті',
        ru: 'Телефон в повседневной жизни',
      },
      subtitleI18n: {
        en: 'Phone numbers, personal habits, and a text about Maria',
        fr: 'Numéros de téléphone, habitudes personnelles et un texte sur Maria',
        ar: 'أرقام الهاتف، والعادات الشخصية، ونص عن ماريا',
        fa: 'شماره‌های تلفن، عادت‌های شخصی، و متنی درباره‌ی ماریا',
        uk: 'Телефонні номери, особисті звички та текст про Марію',
        ru: 'Телефонные номера, личные привычки и текст о Марии',
      },
      theme: 'reading',
    },
    points: 7,
