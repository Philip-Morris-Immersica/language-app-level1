...
export const exercises: Exercise[] = [
    ...
    sections: [
      {
        ...
        lines: [
          { text: '– Ана, какво прави вчера?', voiceGender: 'female' },
          ...
          { text: '– Аз работих до късно. Нищо интересно.', voiceGender: 'female' },
        ],
      },
      {
        ...
        lines: [
          { text: '– Здравей, как беше купонът снощи?', voiceGender: 'male' },
          { text: '– Беше много забавно. Запознах се с нови хора, храната беше страхотна. Ядохме много! Танцувахме, две момчета свириха на китара. Защо не дойде? Чакахме те.', voiceGender: 'female' },
          { text: '– Съжалявам, но бях заета. Трябваше да свърша един проект. Върнах се вкъщи в 10:00 часа и бях много уморена. Легнах си веднага.', voiceGender: 'male',
          ...
          { text: '– Съжалявам. Следващата седмица пак ще има купон. Надявам се да дойдеш.', voiceGender: 'female' },
          { text: '– Ако нямам много работа, ще дойда.', voiceGender: 'male' },
          { text: '– Ти винаги мислиш за работа! Нямаш свободно време. Не се забавляваш, а си на 25 години!', voiceGender: 'female' },
          { text: '– Не е вярно, имам хоби — много обичам да рисувам и да чета.', voiceGender: 'male' },
          { text: '– Не знаех, че рисуваш. Аз също рисувам. Всяка събота ходя на курс. Курсът е безплатен. Искаш ли да дойдеш с мен?', voiceGender: 'female' },
          { text: '– Да, разбира се. Миналата година ходих на курс. Беше много скъп. Дадох много пари. Много ти благодаря за поканата.', voiceGender: 'male' },
          { text: '– Няма защо, до скоро.', voiceGender: 'female' },
        ],
      },
      {
        id: 'в. Закъсняваш!',
        ...
        lines: [
          { text: '– Закъсняваш! Срещата беше в 5:30, а сега е 5:45. Защо не се обади?', voiceGender: 'female',
            ttsText: '– Закъсняваш! Срещата беше в пет и половина, а сега е пет и четиридесет и пет. Защо не се обади?' },
          { text: '– Съжалявам, но аз дойдох точно в 5:30. Ти не беше тук и аз влязох в мола за няколко минути, после излязох, чаках малко и пак влязох. Беше ми студено навън. Забравих телефона си вкъщи и затова не ти се обадих. Ти кога дойде?', voiceGender: 'male',
            ttsText: '– Съжалявам, но аз дойдох точно в пет и половина. Ти не беше тук и аз влязох в мола за няколко минути, после излязох, чаках малко и пак влязох. Беше ми студено навън. Забравих телефона си вкъщи и затова не ти се обадих. Ти кога дойде?' },
          { text: '– Дойдох в 5:40, видях, че те няма и също влязох в мола. Наистина е ужасно студено!', voiceGender: 'female',
            ttsText: '– Дойдох в пет и четиридесет, видях, че те няма и също влязох в мола. Наистина е ужасно студено!' },
      ...
      },
      {
        ...
        lines: [
          ...
          { text: '– Бях в Созопол. Беше страхотно! Морето, хората, храната — всичко беше прекрасно. Разходжда се, плувах, танцувах, спортувах. Как я прекара?', voiceGender: 'male' },
  ...
  // ─── ORDER 6 — НОВИ ДУМИ 1 (стр. 83–84): Хоби ─────────────────────────────
  {
    ...
    order: 6,
    cards: [
      { id: 'futbol',         imageUrl: `${ASSET}/03-novi-dumi-1-hobi/01-futbol.jpg`,         label: 'играя футбол',        ttsLabel: 'играя футбол' },
      { id: 'tenis',          imageUrl: `${ASSET}/03-novi-dumi-1-hobi/02-tenis.jpg`,           label: 'играя тенис',         ttsLabel: 'играя тенис' },
      { id: 'basketbol',      imageUrl: `${ASSET}/03-novi-dumi-1-hobi/03-basketbol.jpg`,       label: 'играя баскетбол',     ttsLabel: 'играя баскетбол' },
      { id: 'voleybol',       imageUrl: `${ASSET}/03-novi-dumi-1-hobi/04-voleybol.jpg`,        label: 'играя волейбол',      ttsLabel: 'играя волейбол' },
      { id: 'shah',           imageUrl: `${ASSET}/03-novi-dumi-1-hobi/05-shah.jpg`,            label: 'играя шах',           ttsLabel: 'играя шах' },
      { id: 'karti',          imageUrl: `${ASSET}/03-novi-dumi-1-hobi/06-karti.jpg`,           label: 'играя карти',         ttsLabel: 'играя карти' },
      { id: 'ski',            imageUrl: `${ASSET}/03-novi-dumi-1-hobi/07-ski.jpg`,             label: 'карам ски',           ttsLabel: 'карам ски' },
      { id: 'kolelo',         imageUrl: `${ASSET}/03-novi-dumi-1-hobi/08-kolelo.jpg`,          label: 'карам колело',        ttsLabel: 'карам колело' },
      { id: 'sarf',           imageUrl: `${ASSET}/03-novi-dumi-1-hobi/09-sarf.jpg`,            label: 'карам сърф',          ttsLabel: 'карам сърф' },
      { id: 'knigi',          imageUrl: `${ASSET}/03-novi-dumi-1-hobi/10-knigi.jpg`,           label: 'чета книги',          ttsLabel: 'чета книги' },
      { id: 'vestnitsi',      imageUrl: `${ASSET}/03-novi-dumi-1-hobi/11-vestnitsi.jpg`,       label: 'чета вестници',       ttsLabel: 'чета вестници' },
      { id: 'spisania',       imageUrl: `${ASSET}/03-novi-dumi-1-hobi/12-spisania.jpg`,        label: 'чета списания',       ttsLabel: 'чета списания' },
      { id: 'filmi',          imageUrl: `${ASSET}/03-novi-dumi-1-hobi/13-filmi.jpg`,           label: 'гледам филми',        ttsLabel: 'гледам филми' },
      { id: 'televiziya',     imageUrl: `${ASSET}/03-novi-dumi-1-hobi/14-televiziya.jpg`,      label: 'гледам телевизия',    ttsLabel: 'гледам телевизия' },
      { id: 'mach',           imageUrl: `${ASSET}/03-novi-dumi-1-hobi/15-mach.jpg`,            label: 'гледам мач',          ttsLabel: 'гледам мач' },
      { id: 'radio',          imageUrl: `${ASSET}/03-novi-dumi-1-hobi/16-radio.jpg`,           label: 'слушам радио',        ttsLabel: 'слушам радио' },
      { id: 'muzika',         imageUrl: `${ASSET}/03-novi-dumi-1-hobi/17-muzika.jpg`,          label: 'слушам музика',       ttsLabel: 'слушам музика' },
      { id: 'gimnastika',     imageUrl: `${ASSET}/03-novi-dumi-1-hobi/18-gimnastika.jpg`,      label: 'правя гимнастика',    ttsLabel: 'правя гимнастика' },
      { id: 'snimki',         imageUrl: `${ASSET}/03-novi-dumi-1-hobi/19-snimki.jpg`,          label: 'правя снимки',        ttsLabel: 'правя снимки' },
      { id: 'narodni-tantsi', imageUrl: `${ASSET}/03-novi-dumi-1-hobi/20-narodni-tantsi.jpg`,  label: 'танцувам народни танци', ttsLabel: 'танцувам народни танци' },
      { id: 'moderni-tantsi', imageUrl: `${ASSET}/03-novi-dumi-1-hobi/21-moderni-tantsi.jpg`,  label: 'танцувам модерни танци', ttsLabel: 'танцувам модерни танци' },
      { id: 'planina',        imageUrl: `${ASSET}/03-novi-dumi-1-hobi/22-planina.jpg`,         label: 'ходя на планината',   ttsLabel: 'ходя на планината' },
      { id: 'teatar',         imageUrl: `${ASSET}/03-novi-dumi-1-hobi/23-teatar.jpg`,          label: 'ходя на театър',      ttsLabel: 'ходя на театър' },
      { id: 'kontsert',       imageUrl: `${ASSET}/03-novi-dumi-1-hobi/24-kontsert.jpg`,        label: 'ходя на концерт',     ttsLabel: 'ходя на концерт' },
      { id: 'balet',          imageUrl: `${ASSET}/03-novi-dumi-1-hobi/25-balet.jpg`,           label: 'ходя на балет',       ttsLabel: 'ходя на балет' },
      { id: 'fitnes',         imageUrl: `${ASSET}/03-novi-dumi-1-hobi/26-fitnes.jpg`,          label: 'ходя на фитнес',      ttsLabel: 'ходя на фитнес' },
      { id: 'piano',          imageUrl: `${ASSET}/03-novi-dumi-1-hobi/27-piano.jpg`,           label: 'свиря на пиано',      ttsLabel: 'свиря на пиано' },
      { id: 'kitara',         imageUrl: `${ASSET}/03-novi-dumi-1-hobi/28-kitara.jpg`,          label: 'свиря на китара',     ttsLabel: 'свиря на китара' },
      { id: 'baseyn',         imageUrl: `${ASSET}/03-novi-dumi-1-hobi/29-baseyn.jpg`,          label: 'плувам в басейна',    ttsLabel: 'плувам в басейна' },
      { id: 'reka',           imageUrl: `${ASSET}/03-novi-dumi-1-hobi/30-reka.jpg`,            label: 'плувам в реката',     ttsLabel: 'плувам в реката' },
      { id: 'more',           imageUrl: `${ASSET}/03-novi-dumi-1-hobi/31-more.jpg`,            label: 'плувам в морето',     ttsLabel: 'плувам в морето' },
      { id: 'ezero',          imageUrl: `${ASSET}/03-novi-dumi-1-hobi/32-ezero.jpg`,           label: 'плувам в езерото',    ttsLabel: 'плувам в езерото' },
      { id: 'peya',           imageUrl: `${ASSET}/03-novi-dumi-1-hobi/33-peya.jpg`,            label: 'пея',                 ttsLabel: 'пея' },
      { id: 'risuvam',        imageUrl: `${ASSET}/03-novi-dumi-1-hobi/34-risuvam.jpg`,         label: 'рисувам',             ttsLabel: 'рисувам' },
      { id: 'sportuvam',      imageUrl: `${ASSET}/03-novi-dumi-1-hobi/35-sportuvam.jpg`,       label: 'спортувам',           ttsLabel: 'спортувам' },
    ],
  ...
  // ─── ORDER 9 — Упр. 11 (стр. 84): Слушайте двата текста — верни/грешни ──────
  // 🎧 TODO Фаза 2: audioUrl ще се генерира с npm run tts:generate -- --lesson 08
  {
    id: 'a2-l08-ex-11',
    type: 'true_false',
    title: 'УПРАЖНЕНИЕ 11',
    ...
    order: 9,
    points: 10,
    audioUrl: '/assets/a2-lesson-08/audio/tts/listening/a2-l08-ex-11.mp3',
    listeningText: 'Аз съм Стефан. Миналата събота отидох в парка с приятели. Времето беше много приятно. Тичахме, играхме футбол, правихме снимки. За обяд ядохме сандвичи. После отидохме на кино. Беше чудесен ден! Аз съм Роза. Миналата седмица учих много, работих до късно. Не ходих на кафе с приятели, не отидох на фитнес, не гледах телевизия. Писах и четох имейли. Искам почивка, дълга почивка на море!',
    sentences: [
  ...
  // ─── ORDER 14 — ГРАМАТИКА 3 (стр. 86): Съюзи ────────────────────────────────
  {
    ...
    columns: ['Изречение'],
    rows: [
      { pronoun: 'а',   cells: ['Аз говоря български, **а** той говори арабски.'], ttsText: 'Съюз а. Аз говоря български, а той говори арабски.', ttsPrompt: GEMINI_BG_SMOOTH_PROMPT },
      { pronoun: 'но',  cells: ['Имам баба, **но** нямам дядо.'],                   ttsText: 'Съюз но. Имам баба, но нямам дядо.',                  ttsPrompt: GEMINI_BG_SMOOTH_PROMPT },
      { pronoun: 'или', cells: ['Какво искаш — чай **или** кафе?'],                 ttsText: 'Съюз или. Какво искаш — чай или кафе?',               ttsPrompt: GEMINI_BG_SMOOTH_PROMPT },
      { pronoun: 'че',  cells: ['Мисля, **че** те са добре.'],                      ttsText: 'Съюз че. Мисля, че те са добре.',                      ttsPrompt: GEMINI_BG_SMOOTH_PROMPT },
    ],
    ttsNoteModels: [],
  } as GrammarTableExercise,
  ...
  // дали да се добави интерактивен компонент за спрежение в бъдеще.
  {
    ...
    ttsNotes: [
      'Пример за а-х група: вечерях, вечеря, вечеря, вечеряхме, вечеряхте, вечеряха.',
      'Пример за о-х група: отидох, отиде, отиде, отидохме, отидохте, отидоха.',
    ],
    ttsNoteModels: ['pro', 'pro'],
  } as GrammarTableExercise,
  ...
  // ─── ORDER 21 — Упр. 22 (стр. 89): ТЕКСТ „НЕЗАБРАВИМА ВАКАНЦИЯ!" ────────────
  {
    ...
    ttsParagraphs: [
      ...
      'Ало, ало, Христо! Да, мамо! Добро утро! Как си? Ти как си? В колко часа си легнал снощи? Единадесет и половина. В единадесет и половина? Толкова късно! Какво прави? Разхождах се из града. Спа ли добре? Къде е хотелът? Да, но сега е много рано, може ли да говорим по-късно? Искам да спя още малко. Вечерял ли? Какво яде? Сандвич. Какво пи? Кафе с мляко. Говори ли френски? Да, говорих, в кафето. Разбрах всичко, но те не ме разбраха. Трябва да учиш повече! Мамо, купих ти подарък. Благодаря, но нямам нужда от нищо. Мамо, срещнах едно момиче и тя е много красива! Мисля, че съм влюбен! Какво момиче? Как така си влюбен? Откъде е? Как се казва? Мамо, не те чувам добре. Връзката не е добра. Ще ти се обадя по-късно. Христо, Христо... Тръгвам веднага за Париж.',
    ],
