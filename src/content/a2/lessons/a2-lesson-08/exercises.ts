...
export const exercises: Exercise[] = [
  ...
  //       рисувам→рисувах, гледам→гледах
  {
    ...
    sentences: [
      ...
      { text: '_____ в басейна.',       blanks: [1], correctAnswers: ['Плувах'],   options: ['Плувах', 'Свирих', 'Четох', 'Гледах'],  acceptableAnswers: [['Плувах', 'плувах']] },
      { text: '_____ на пиано.',        blanks: [1], correctAnswers: ['Свирих'],   options: ['Свирих', 'Слушах', 'Играх', 'Рисувах'], acceptableAnswers: [['Свирих', 'свирих']] },
      { text: '_____ на концерт.',      blanks: [1], correctAnswers: ['Ходих'],    options: ['Ходих', 'Гледах', 'Плувах', 'Четох'],   acceptableAnswers: [['Ходих', 'ходих']] },
      { text: '_____ телевизия.',       blanks: [1], correctAnswers: ['Гледах'],   options: ['Гледах', 'Свирих', 'Плувах', 'Карах'],  acceptableAnswers: [['Гледах', 'гледах']] },
      { text: '_____ ски.',             blanks: [1], correctAnswers: ['Карах'],    options: ['Карах', 'Плувах', 'Четох', 'Гледах'],   acceptableAnswers: [['Карах', 'карах']] },
      { text: '_____ картина.',         blanks: [1], correctAnswers: ['Рисувах'],  options: ['Рисувах', 'Гледах', 'Слушах', 'Карах'], acceptableAnswers: [['Рисувах', 'рисувах']] },
      { text: '_____ снимки.',          blanks: [1], correctAnswers: ['Правих'],   options: ['Правих', 'Рисувах', 'Свирих', 'Плувах'], acceptableAnswers: [['Правих', 'правих']] },
      { text: '_____ книга.',           blanks: [1], correctAnswers: ['Четох'],    options: ['Четох', 'Карах', 'Плувах', 'Свирих'],   acceptableAnswers: [['Четох', 'четох']] },
  ...
  // ─── ORDER 22 — Упр. 23 (стр. 89): Довършете изреченията ────────────────────
  {
    ...
    sentences: [
      ...
      { text: 'Христо _____ сандвич за вечеря.',
        blanks: [1], correctAnswers: ['яде'], options: ['яде', 'ядох', 'ядоха'], acceptableAnswers: [['яде']] },
      { text: 'Той _____ кафе с мляко.',
        blanks: [1], correctAnswers: ['пи'], options: ['пи', 'пих', 'пиха'], acceptableAnswers: [['пи']] },
