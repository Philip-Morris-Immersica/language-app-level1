...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 1 — Упр. 1 (стр. 43): Димо и Галя през седмицата ─────────────────
  {
    ...
    order: 1,
    sectionStart: {
      title: 'Планове за седмицата',
      subtitle: 'Какво ще правят Димо и Галя и диалози за уикенда',
      titleI18n: {
        en: 'Plans for the week',
        fr: 'Projets pour la semaine',
        ar: 'خطط للأسبوع',
        fa: 'برنامه‌های هفته',
        uk: 'Плани на тиждень',
        ru: 'Планы на неделю',
      ...
      subtitleI18n: {
        en: 'What Dimo and Galya will do, and weekend dialogues',
        fr: 'Ce que feront Dimo et Galya, et des dialogues pour le week-end',
        ar: 'ماذا سيفعل ديمو وغاليا، وحوارات عن عطلة نهاية الأسبوع',
        fa: 'دیمو و گالیا چه خواهند کرد و گفتگوهایی دربارهٔ آخر هفته',
        uk: 'Що робитимуть Дімо і Галя, і діалоги про вихідні',
        ru: 'Что будут делать Димо и Галя, и диалоги о выходных',
      },
      theme: 'dialogue',
    },
    points: 5,
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          ...
          { text: 'Да, ще дойда! Кога?', voiceGender: 'female', ttsText: 'Да, ще дойда, кога?' },
      ...
      },
      {
        ...
        lines: [
          ...
          { text: 'Добре.', voiceGender: 'male', ttsText: 'добрре.' },
        ],
      },
      {
        id: 'е.',
  ...
  // ─── ORDER 3 — ГРАМАТИКА 1 (стр. 44): несъвършен / свършен вид ─────────────
  {
    ...
    order: 3,
    sectionStart: {
      title: 'Глаголен вид и бъдеще време',
      subtitle: 'Несвършен и свършен вид, планове за лятото и денят на Митко',
      titleI18n: {
        en: 'Verb aspect and the future tense',
        fr: 'Aspect verbal et futur',
        ar: 'وجه الفعل وزمن المستقبل',
        fa: 'نمود فعل و زمان آینده',
        uk: 'Вид дієслова і майбутній час',
        ru: 'Вид глагола и будущее время',
      },
      subtitleI18n: {
        en: 'Imperfective and perfective aspect, summer plans and Mitko\'s day',
        fr: 'Aspect imperfectif et perfectif, projets d\'été et journée de Mitko',
        ar: 'الوجه غير التام والوجه التام، خطط الصيف ويوم ميتكو',
        fa: 'نمود ناقص و کامل، برنامه‌های تابستان و روز میتکو',
        uk: 'Недоконаний і доконаний вид, плани на літо і день Мітка',
        ru: 'Несовершенный и совершенный вид, планы на лето и день Митко',
      },
      theme: 'grammar',
    },
    layout: 'centered',
    examples: [
      {
        ...
        ttsText: 'Несвършен вид. Много пъти. Всеки ден отивам на училище. Често купувам плодове. През седмицата ставам рано. Винаги идвам на работа в осем часа. Обикновено се връщам вкъщи в осемнадесет часа.',
        ttsPrompt: 'Думата се произнася "несвършен" (не "несъваршен") — не добавяй гласна в средата. Числото "осемнадесет" се чете точно така (18), а не "седемнадесет". Думата "вкъщи" се произнася "вкъ-шти" (буквата "щ" = "шт"), не "вкъсти".',
        voiceGender: 'female',
      },
      {
        imageUrl: '',
        ...
        ttsText: 'Свършен вид. Един път. Утре също ще отида на училище. Днес също ще купя плодове. В събота ще стана късно. Утре ще дойда в осем и тридесет. Довечера ще се върна в деветнадесет часа.',
        voiceGender: 'female',
      },
    ],
  ...
  // ─── ORDER 11 — Упр. 10 (стр. 47–48): Какво ще прави Митко утре ─────────────
  {
    ...
    images: [
      { id: 'stane',       imageUrl: `${ASSET}/04-upr-10-mitko/01-stane.jpg`,       correctLabel: 'Утре Митко ще стане в 7:00.', isExample: true,
        imageOptions: ['Утре Митко ще стане в 7:00.', 'Ще вземе душ.', 'Ще закусва.', 'Ще излезе от вкъщи в 8:00 часа.'] },
      ...
      { id: 'izliza',      imageUrl: `${ASSET}/04-upr-10-mitko/05-izliza.jpg`,      correctLabel: 'Ще излезе от вкъщи в 8:00 часа.',
        imageOptions: ['Ще излезе от вкъщи в 8:00 часа.', 'Утре Митко ще стане в 7:00.', 'Ще отиде на училище.', 'Ще отвори вратата.'] },
      { id: 'uchilishte',  imageUrl: `${ASSET}/04-upr-10-mitko/06-uchilishte.jpg`,  correctLabel: 'Ще отиде на училище.',
        imageOptions: ['Ще отиде на училище.', 'Ще излезе от вкъщи в 8:00 часа.', 'Ще отиде на кино.', 'Ще се срещне с приятели.'] },
      { id: 'zakasnyava',  imageUrl: `${ASSET}/04-upr-10-mitko/07-zakasnyava.jpg`,  correctLabel: 'Ще закъснее за час.',
        imageOptions: ['Ще закъснее за час.', 'Ще отиде на училище.', 'Ще учи.', 'Ще излезе от вкъщи в 8:00 часа.'] },
      ...
      { id: 'priyateli',   imageUrl: `${ASSET}/04-upr-10-mitko/12-priyateli.jpg`,   correctLabel: 'Ще се срещне с приятели.',
        imageOptions: ['Ще се срещне с приятели.', 'Ще се обади по телефона.', 'Ще отиде на кино.', 'Ще отиде на училище.'] },
      { id: 'kino',        imageUrl: `${ASSET}/04-upr-10-mitko/13-kino.jpg`,        correctLabel: 'Ще отиде на кино.',
        imageOptions: ['Ще отиде на кино.', 'Ще се срещне с приятели.', 'Ще отиде на училище.', 'Ще се обади по телефона.'] },
      { id: 'patuva',      imageUrl: `${ASSET}/04-upr-10-mitko/14-patuva.jpg`,      correctLabel: 'Ще забрави телефона си в киното.',
        imageOptions: ['Ще забрави телефона си в киното.', 'Ще отиде на кино.', 'Ще се срещне с приятели.', 'Ще отвори вратата.'] },
      { id: 'vrata',       imageUrl: `${ASSET}/04-upr-10-mitko/15-vrata.jpg`,       correctLabel: 'Ще отвори вратата.',
        imageOptions: ['Ще отвори вратата.', 'Ще разбере, че си е забравил телефона.', 'Ще излезе от вкъщи в 8:00 часа.', 'Ще вземе душ.'] },
      { id: 'ranitsa',     imageUrl: `${ASSET}/04-upr-10-mitko/16-ranitsa.jpg`,     correctLabel: 'Ще разбере, че си е забравил телефона.',
        imageOptions: ['Ще разбере, че си е забравил телефона.', 'Ще отвори вратата.', 'Ще излезе от вкъщи в 8:00 часа.', 'Ще учи.'] },
    ...
    options: [
      ...
      'Ще закусва.',
      'Ще пие мляко.',
      'Ще излезе от вкъщи в 8:00 часа.',
      'Ще отиде на училище.',
      'Ще закъснее за час.',
      'Ще учи.',
      ...
      'Ще отиде на кино.',
      'Ще забрави телефона си в киното.',
      'Ще отвори вратата.',
      'Ще разбере, че си е забравил телефона.',
  ...
  // ─── ORDER 13 — Упр. 14 текст (стр. 49): Пловдив ───────────────────────────
  {
    ...
    order: 13,
    sectionStart: {
      title: 'Пътувания и планове за неделя',
      subtitle: 'Текстове за Пловдив, Калина и Боряна',
      titleI18n: {
        en: 'Trips and Sunday plans',
        fr: 'Voyages et projets pour dimanche',
        ar: 'رحلات وخطط ليوم الأحد',
        fa: 'سفرها و برنامه‌های یکشنبه',
        uk: 'Подорожі та плани на неділю',
        ru: 'Поездки и планы на воскресенье',
      },
      subtitleI18n: {
        en: 'Texts about Plovdiv, Kalina and Boryana',
        fr: 'Textes sur Plovdiv, Kalina et Boryana',
        ar: 'نصوص عن بلوفديف وكالينا وبوريانا',
        fa: 'متن‌هایی دربارهٔ پلوودیو، کالینا و بوریانا',
        uk: 'Тексти про Пловдив, Калину і Боряну',
        ru: 'Тексты о Пловдиве, Калине и Боряне',
      },
      theme: 'reading',
    },
    showDictionary: true,
  ...
  // ─── ORDER 18 — Упр. 17 (стр. 49): Веси и Боян ─────────────────────────────
  {
    id: 'a2-l04-ex-17',
    type: 'workbook_fill_blank',
    instruction: 'По модела на текста „Неделя на Боряна" изберете правилните глаголни форми и разкажете какво ще правят Веси и Боян.',
    order: 18,
    points: 10,
    layout: 'single',
    sentences: [
  ...
  // ─── ORDER 20 — ТЕКСТОВЕ Упр. 19 (стр. 50): Мечтата на Али ──────────────────
  {
    ...
    order: 20,
    sectionStart: {
      title: 'Мечти за бъдещето',
      subtitle: 'Мечтите на Али, Невена и Николай',
      titleI18n: {
        en: 'Dreams for the future',
        fr: 'Rêves d\'avenir',
        ar: 'أحلام للمستقبل',
        fa: 'رؤیاهای آینده',
        uk: 'Мрії про майбутнє',
        ru: 'Мечты о будущем',
      },
      subtitleI18n: {
        en: 'The dreams of Ali, Nevena and Nikolay',
        fr: 'Les rêves d\'Ali, de Nevena et de Nikolay',
        ar: 'أحلام علي ونيفينا ونيكولاي',
        fa: 'رؤیاهای علی، نوِنا و نیکولای',
        uk: 'Мрії Алі, Невени і Ніколая',
        ru: 'Мечты Али, Невены и Николая',
      },
      theme: 'reading',
    },
    showDictionary: true,
