...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 1 — Упр. 1 (стр. 51): хотели и стаи ────────────────────────────
  {
    ...
    order: 1,
    sectionStart: {
      title: 'Хотели и „искам да"',
      subtitle: 'Думи за хотели и стаи, резервация и глаголите „искам да", „мога да" и „трябва да"',
      titleI18n: {
        en: 'Hotels and "искам да" (I want to)',
        fr: 'Hôtels et «искам да» (je veux)',
        ar: 'الفنادق و«искам да» (أريد أن)',
        fa: 'هتل‌ها و «искам да» (می‌خواهم)',
        uk: 'Готелі та «искам да» (хочу)',
        ru: 'Отели и «искам да» (хочу)',
      },
      subtitleI18n: {
        en: 'Words for hotels and rooms, a reservation, and the verbs "искам да" (I want to), "мога да" (I can) and "трябва да" (I must)',
        fr: 'Mots pour les hôtels et les chambres, une réservation et les verbes «искам да» (je veux), «мога да» (je peux) et «трябва да» (je dois)',
        ar: 'كلمات عن الفنادق والغرف، وحجز، والأفعال «искам да» (أريد أن) و«мога да» (أستطيع أن) و«трябва да» (يجب أن)',
        fa: 'واژه‌های هتل و اتاق، رزرو و فعل‌های «искам да» (می‌خواهم)، «мога да» (می‌توانم) و «трябва да» (باید)',
        uk: 'Слова для готелів і кімнат, резервація та дієслова «искам да» (хочу), «мога да» (можу) і «трябва да» (мушу)',
        ru: 'Слова для отелей и номеров, бронь и глаголы «искам да» (хочу), «мога да» (могу) и «трябва да» (должен)',
      },
      theme: 'grammar',
    },
    points: 6,
  ...
  // ─── ORDER 3 — ГРАМАТИКА 1 (стр. 51): искам да ─────────────────────────────
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 1',
    instruction: 'Запознайте се със спрежението на „искам да" в положителна, отрицателна и въпросителна форма.',
  ...
  // ─── ORDER 4 — ГРАМАТИКА 2 (стр. 52): мога да / трябва да ─────────────────
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 2',
    instruction: 'Запознайте се със спрежението на глаголите „мога да" и „трябва да".',
    ...
    examples: [
      {
        ...
        ttsText: 'Много пъти — несвършен вид. Всеки ден искам да купувам плодове. Всеки ден мога да купувам плодове. Всеки ден трябва да купувам плодове. Винаги трябва да идвам на работа рано.',
        voiceGender: 'female',
      },
      {
        imageUrl: '',
        ...
        ttsText: 'Един път — свършен вид. Сега искам да купя плодове. Сега мога да купя плодове. Сега трябва да купя плодове. Днес искам да дойда на работа по-късно.',
        voiceGender: 'female',
      },
    ],
  ...
  // ─── ORDER 10 — ДИАЛОЗИ 2 (стр. 53) ───────────────────────────────────────
  {
    ...
    order: 10,
    sectionStart: {
      title: 'Резервации и „може ли"',
      subtitle: 'Диалози в ресторанта, текст за Анелия и учтиви молби',
      titleI18n: {
        en: 'Reservations and "може ли" (may I)',
        fr: 'Réservations et «може ли» (puis-je)',
        ar: 'الحجوزات و«може ли» (هل يمكن)',
        fa: 'رزروها و «може ли» (می‌شود)',
        uk: 'Резервації та «може ли» (чи можна)',
        ru: 'Бронирование и «може ли» (можно ли)',
      },
      subtitleI18n: {
        en: 'Dialogues in the restaurant, a text about Aneliya, and polite requests',
        fr: 'Dialogues au restaurant, un texte sur Aneliya et des demandes polies',
        ar: 'حوارات في المطعم، ونص عن أنيليا، وطلبات مهذبة',
        fa: 'گفتگو در رستوران، متنی درباره آنلیا و درخواست‌های مؤدبانه',
        uk: 'Діалоги в ресторані, текст про Анелію та ввічливі прохання',
        ru: 'Диалоги в ресторане, текст об Анелии и вежливые просьбы',
      },
      theme: 'dialogue',
    },
    sections: [
      ...
      },
      {
        ...
        lines: [
          ...
          { text: 'Може ли адреса и телефона Ви?', voiceGender: 'female', ttsText: 'Може ли адреса и телефона ви?' },
  ...
  // ─── ORDER 11 — Упр. 12 текст (стр. 53–54): Анелия ─────────────────────────
  {
    ...
    paragraphs: [
      ...
      'Често Анелия и приятелите й се срещат в петък вечерта и вечерят заедно в ресторант „Добре дошли". Те правят резервация в четвъртък, защото много хора харесват този ресторант и често няма свободни места.',
    ],
    ttsParagraphs: [
      'Анелия не обича да готви. Обикновено тя обядва в ресторанта близо до офиса. Там не е скъпо и храната е вкусна. Всеки ден има различно обедно меню.',
      'За вечеря тя прави сандвич и салата или поръчва пица от близката пицария. Доставката е бърза и безплатна.',
  ...
  // ─── ORDER 18 — ДИАЛОЗИ 3 (стр. 54–55): банка, банкомат, обменно бюро ─────
  {
    ...
    order: 18,
    sectionStart: {
      title: 'Банка и пълни местоимения',
      subtitle: 'Диалози в банката и пълните форми след предлог',
      titleI18n: {
        en: 'The bank and full pronoun forms',
        fr: 'La banque et les formes pleines des pronoms',
        ar: 'البنك والصيغ الكاملة للضمائر',
        fa: 'بانک و شکل‌های کامل ضمایر',
        uk: 'Банк і повні форми займенників',
        ru: 'Банк и полные формы местоимений',
      },
      subtitleI18n: {
        en: 'Dialogues at the bank and the full forms after a preposition',
        fr: 'Dialogues à la banque et les formes pleines après une préposition',
        ar: 'حوارات في البنك والصيغ الكاملة بعد حرف الجر',
        fa: 'گفتگو در بانک و شکل‌های کامل پس از حرف اضافه',
        uk: 'Діалоги в банку та повні форми після прийменника',
        ru: 'Диалоги в банке и полные формы после предлога',
      },
      theme: 'grammar',
    },
    sections: [
      {
        ...
        lines: [
          { text: 'Може ли да открия сметка?', voiceGender: 'male', ttsText: 'Може ли да открия смет-ка?' },
      ...
      },
      {
        ...
        lines: [
          ...
          { text: 'Има ли комисионна?', voiceGender: 'male' },
  ...
  // ─── ORDER 24 — НОВИ ДУМИ 2 (стр. 56): фризьорски услуги ──────────────────
  {
    ...
    order: 24,
    sectionStart: {
      title: 'Фризьор, сметки и четива',
      subtitle: 'Фризьорски салон, плащане на сметки и текстове за ежедневието',
      titleI18n: {
        en: 'Hairdresser, bills and reading texts',
        fr: 'Coiffeur, factures et textes de lecture',
        ar: 'صالون الحلاقة والفواتير ونصوص القراءة',
        fa: 'آرایشگر، قبض‌ها و متن‌های خواندن',
        uk: 'Перукар, рахунки і тексти',
        ru: 'Парикмахер, счета и тексты',
      },
      subtitleI18n: {
        en: 'A hair salon, paying bills, and everyday reading texts',
        fr: 'Un salon de coiffure, le paiement des factures et des textes sur le quotidien',
        ar: 'صالون حلاقة، ودفع الفواتير، ونصوص عن الحياة اليومية',
        fa: 'سالن آرایش، پرداخت قبض‌ها و متن‌هایی درباره زندگی روزمره',
        uk: 'Перукарня, оплата рахунків і тексти про повсякденне життя',
        ru: 'Парикмахерская, оплата счетов и тексты о повседневной жизни',
      },
      theme: 'reading',
    },
    cards: [
      { id: 'podstrigvane', imageUrl: `${ASSET}/06-novi-dumi-2-frizyor/01-podstrizvane.jpg`, label: 'подстригване', ttsLabel: 'подстриг-ване', ttsModel: 'pro', ttsPrompt: 'Bulgarian noun meaning a haircut. Say one fluent word: подстригване. After Г comes a clear В (the letter ve / English V) — под-стриг-ВА-не. It is NOT подстригнане: there is no Н. Neutral standard Bulgarian, no extra sounds.' },
    ...
    sections: [
      {
        id: 'а.',
        lines: [
          { text: 'Добър ден. Искам подстригване, моля.', voiceGender: 'male', ttsText: 'Добър ден. Искам подстриг-ване, моля.' },
  ...
  // ─── ORDER 28 — ТЕКСТОВЕ Упр. 31 (стр. 58): Васил и Снежана ───────────────
  {
    ...
    ttsParagraphs: [
      'Васил и Снежана са младо семейство. Имат две деца. Васил работи в банка. Винаги има много клиенти от България и от чужбина. Те внасят пари, правят трансфери от други страни в България и обменят валута.',
      'Снежана има малък, но хубав фризьорски салон. Тя може да прави всичко — подстриг-ване, боядисване, къдрене. В салона идват много хора — млади и стари. Всички искат да имат хубави прически.',
      'След работа Васил и Снежана трябва да правят още много неща. Васил пазарува, а Снежана готви и помага на децата за училище. В началото на всеки месец Васил плаща сметките за ток, вода, парно, интернет, телефон и кабелна телевизия.',
      'През уикенда обичат да пътуват в България и в чужбина. Правят резервации по интернет в малки хотели. Посещават интересни места. Връщат се вкъщи доволни и щастливи.',
    ],
