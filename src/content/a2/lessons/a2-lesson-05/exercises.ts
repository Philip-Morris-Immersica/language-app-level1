...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 7 — Упр. 5 (стр. 52): отговорете по модела ─────────────────────
  {
    ...
    layout: 'single',
    sentences: [
      { text: 'Искаш ли да пиеш черен чай? | Да: Да, искам да пия черен чай. / Не: Не, не искам да пия черен чай.', blanks: [], correctAnswers: [], isExample: true },
      { text: 'Искаш ли да вечеряш в ресторант „Хепи" с приятели? | Да: _______ / Не: _______', blanks: [1, 2], correctAnswers: ['Да, искам да вечерям в ресторант „Хепи" с приятели.', 'Не, не искам да вечерям в ресторант „Хепи" с приятели.'], options: [['Да, искат да вечерят в ресторант „Хепи" с приятели.', 'Да, искам да вечерям в ресторант „Хепи" с приятели.', 'Да, искаш да вечеряш в ресторант „Хепи" с приятели.'], ['Не, не искаш да вечеряш в ресторант „Хепи" с приятели.', 'Не, не искат да вечерят в ресторант „Хепи" с приятели.', 'Не, не искам да вечерям в ресторант „Хепи" с приятели.']], acceptableAnswers: [['да, искам да вечерям в ресторант „хепи" с приятели.', 'да, искам да вечерям'], ['не, не искам да вечерям в ресторант „хепи" с приятели.', 'не, не искам да вечерям']] },
      { text: 'Искаш ли да отидеш на планина през уикенда? | Да: _______ / Не: _______', blanks: [1, 2], correctAnswers: ['Да, искам да отида на планина през уикенда.', 'Не, не искам да отида на планина през уикенда.'], options: [['Да, искаш да отидеш на планина през уикенда.', 'Да, искам да отида на планина през уикенда.', 'Да, искат да отидат на планина през уикенда.'], ['Не, не искат да отидат на планина през уикенда.', 'Не, не искам да отида на планина през уикенда.', 'Не, не искаш да отидеш на планина през уикенда.']], acceptableAnswers: [['да, искам да отида на планина през уикенда.', 'да, искам да отида'], ['не, не искам да отида на планина през уикенда.', 'не, не искам да отида']] },
      { text: 'Искаш ли да гледаш телевизия тази вечер? | Да: _______ / Не: _______', blanks: [1, 2], correctAnswers: ['Да, искам да гледам телевизия тази вечер.', 'Не, не искам да гледам телевизия тази вечер.'], options: [['Да, искат да гледат телевизия тази вечер.', 'Да, искаш да гледаш телевизия тази вечер.', 'Да, искам да гледам телевизия тази вечер.'], ['Не, не искам да гледам телевизия тази вечер.', 'Не, не искат да гледат телевизия тази вечер.', 'Не, не искаш да гледаш телевизия тази вечер.']], acceptableAnswers: [['да, искам да гледам телевизия тази вечер.', 'да, искам да гледам'], ['не, не искам да гледам телевизия тази вечер.', 'не, не искам да гледам']] },
      { text: 'Искаш ли да дойдеш вкъщи? | Да: _______ / Не: _______', blanks: [1, 2], correctAnswers: ['Да, искам да дойда вкъщи.', 'Не, не искам да дойда вкъщи.'], options: [['Да, искам да дойда вкъщи.', 'Да, искат да дойдат вкъщи.', 'Да, искаш да дойдеш вкъщи.'], ['Не, не искаш да дойдеш вкъщи.', 'Не, не искам да дойда вкъщи.', 'Не, не искат да дойдат вкъщи.']], acceptableAnswers: [['да, искам да дойда вкъщи.', 'да, искам да дойда'], ['не, не искам да дойда вкъщи.', 'не, не искам да дойда']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 9 — Упр. 8 (стр. 53): направете въпроси ─────────────────────────
  {
    ...
    sentences: [
      ...
      { text: 'Аз мога да говоря български. | _______', blanks: [1], correctAnswers: ['А ти можеш ли да говориш български?'], options: ['А ти можеш ли да говори български?', 'А ти можеш ли да говориш български?', 'А ти можеш ли да говорим български?'], acceptableAnswers: [['А ти можеш ли да говориш български?', 'а ти можеш ли да говориш български?']] },
      { text: 'Христо може да прави баница. | _______', blanks: [1], correctAnswers: ['А ти можеш ли да правиш баница?'], options: ['А ти можеш ли да правим баница?', 'А ти можеш ли да прави баница?', 'А ти можеш ли да правиш баница?'], acceptableAnswers: [['А ти можеш ли да правиш баница?', 'а ти можеш ли да правиш баница?']] },
      { text: 'Ахмед може да танцува сирийски танци. | _______', blanks: [1], correctAnswers: ['А ти можеш ли да танцуваш сирийски танци?'], options: ['А ти можеш ли да танцуват сирийски танци?', 'А ти можеш ли да танцувам сирийски танци?', 'А ти можеш ли да танцуваш сирийски танци?'], acceptableAnswers: [['А ти можеш ли да танцуваш сирийски танци?', 'а ти можеш ли да танцуваш сирийски танци?']] },
      { text: 'Ширин и Ханан могат да готвят иракска храна. | _______', blanks: [1], correctAnswers: ['А ти можеш ли да готвиш иракска храна?'], options: ['А ти можеш ли да готвиш иракска храна?', 'А ти можеш ли да готви иракска храна?', 'А ти можеш ли да готвим иракска храна?'], acceptableAnswers: [['А ти можеш ли да готвиш иракска храна?', 'а ти можеш ли да готвиш иракска храна?']] },
      { text: 'Ние можем да тичаме бързо. | _______', blanks: [1], correctAnswers: ['А ти можеш ли да тичаш бързо?'], options: ['А ти можеш ли да тичам бързо?', 'А ти можеш ли да тичат бързо?', 'А ти можеш ли да тичаш бързо?'], acceptableAnswers: [['А ти можеш ли да тичаш бързо?', 'а ти можеш ли да тичаш бързо?']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 15 — Упр. 15 (стр. 54): попълнете с ли / да / пия / ли да ──────
  {
    id: 'a2-l05-ex-15',
    type: 'workbook_fill_blank',
    instruction: 'Попълнете с подходящата дума или израз: ли, да, пия, ли да.',
    order: 15,
    points: 5,
    layout: 'single',
    sentences: [
      { text: 'Може ли да говоря с г-н Иванов?', blanks: [], correctAnswers: [], isExample: true },
      { text: 'Може _______ да слушам радио?', blanks: [1], correctAnswers: ['ли'], options: ['ли', 'да', 'пия', 'ли да'], acceptableAnswers: [['ли']] },
      { text: 'Може _______ гледам телевизия?', blanks: [1], correctAnswers: ['ли да'], options: ['ли', 'да', 'пия', 'ли да'], acceptableAnswers: [['ли да']] },
      { text: 'Може _______ едно кафе?', blanks: [1], correctAnswers: ['ли'], options: ['ли', 'да', 'пия', 'ли да'], acceptableAnswers: [['ли']] },
      { text: 'Може ли да _______ вода?', blanks: [1], correctAnswers: ['пия'], options: ['ли', 'да', 'пия', 'ли да'], acceptableAnswers: [['пия']] },
      { text: 'Може _______ едно кафе, моля?', blanks: [1], correctAnswers: ['ли'], options: ['ли', 'да', 'пия', 'ли да'], acceptableAnswers: [['ли']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 16 — Упр. 16 (стр. 54): подчертайте правилната форма ────────────
  {
    ...
    sentences: [
      ...
      { text: 'Може ли да _______ / _______ това цвете?', blanks: [1], correctAnswers: ['купя'], options: ['купувам', 'купя'], acceptableAnswers: [['купя']] },
      { text: 'Може ли да _______ / _______ на кино довечера?', blanks: [1], correctAnswers: ['отида'], options: ['отивам', 'отида'], acceptableAnswers: [['отида']] },
      { text: 'Може ли да ми _______ / _______ за домашното днес?', blanks: [1], correctAnswers: ['помогнеш'], options: ['помагаш', 'помогнеш'], acceptableAnswers: [['помогнеш']] },
      { text: 'Може ли да _______ / _______ прозореца сега?', blanks: [1], correctAnswers: ['отворя'], options: ['отварям', 'отворя'], acceptableAnswers: [['отворя']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 17 — Упр. 17 (стр. 54): трансформирайте по модела ──────────────
  {
    ...
    sentences: [
      ...
      { text: 'Ние плащаме сметката. | _______', blanks: [1], correctAnswers: ['Може ли да платим сметката?'], options: ['Може ли да платят сметката?', 'Може ли да платиш сметката?', 'Може ли да платим сметката?'], acceptableAnswers: [['Може ли да платим сметката?', 'може ли да платим сметката?']] },
      { text: 'Те идват тук. | _______', blanks: [1], correctAnswers: ['Може ли да дойдат тук?'], options: ['Може ли да дойде тук?', 'Може ли да дойдат тук?', 'Може ли да дойда тук?'], acceptableAnswers: [['Може ли да дойдат тук?', 'може ли да дойдат тук?']] },
      { text: 'Вие купувате шоколадови бонбони. | _______', blanks: [1], correctAnswers: ['Може ли да купите шоколадови бонбони?'], options: ['Може ли да купят шоколадови бонбони?', 'Може ли да купим шоколадови бонбони?', 'Може ли да купите шоколадови бонбони?'], acceptableAnswers: [['Може ли да купите шоколадови бонбони?', 'може ли да купите шоколадови бонбони?']] },
      { text: 'Ти затваряш вратата. | _______', blanks: [1], correctAnswers: ['Може ли да затвориш вратата?'], options: ['Може ли да затворим вратата?', 'Може ли да затвори вратата?', 'Може ли да затвориш вратата?'], acceptableAnswers: [['Може ли да затвориш вратата?', 'може ли да затвориш вратата?']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 21 — Упр. 21 (стр. 55): напишете подходящ предлог ──────────────
  {
    id: 'a2-l05-ex-21',
    type: 'workbook_fill_blank',
    instruction: 'Изберете подходящия предлог по модела „Ще дойдеш ли с мене на екскурзия?"',
    order: 21,
    points: 6,
    layout: 'single',
    sentences: [
      { text: 'Ще дойдеш ли с мене на екскурзия?', blanks: [], correctAnswers: [], isExample: true },
      { text: 'Имам бонбони _______ тях.', blanks: [1], correctAnswers: ['за'], options: ['от', 'за', 'с'], acceptableAnswers: [['за']] },
      { text: 'Тази роза е _______ мене _______ тебе.', blanks: [1, 2], correctAnswers: ['от', 'за'], options: [['за', 'от', 'с'], ['за', 'до', 'от']], acceptableAnswers: [['от'], ['за']] },
      { text: 'Децата ще купят цветя _______ нея.', blanks: [1], correctAnswers: ['за'], options: ['до', 'от', 'за'], acceptableAnswers: [['за']] },
      { text: 'Свободен ли е столът _______ Вас?', blanks: [1], correctAnswers: ['до'], options: ['за', 'до', 'от'], acceptableAnswers: [['до']] },
  ...
  // ще позволи: audioUrl → аудио горе, после текст с 7 blanks.
  {
    ...
    sentences: [
      { text: 'Днес имам много работа. Първо ще _______ в банката.', blanks: [1], correctAnswers: ['отида'], options: ['отидем', 'отиде', 'отида'], acceptableAnswers: [['отида']] },
      { text: 'Трябва да _______ пари.', blanks: [1], correctAnswers: ['изтегля'], options: ['изтегли', 'изтегля', 'изтеглим'], acceptableAnswers: [['изтегля']] },
      { text: 'След това искам да _______ в супермаркета.', blanks: [1], correctAnswers: ['отида'], options: ['отидат', 'отида', 'отидем'], acceptableAnswers: [['отида']] },
      { text: 'Трябва да _______ мляко, яйца, хляб, месо.', blanks: [1], correctAnswers: ['купя'], options: ['купи', 'купим', 'купя'], acceptableAnswers: [['купя']] },
      { text: 'Мога да _______ също и плодове.', blanks: [1], correctAnswers: ['взема'], options: ['вземе', 'взема', 'вземат'], acceptableAnswers: [['взема']] },
      { text: 'После искам да _______ тока и парното.', blanks: [1], correctAnswers: ['платя'], options: ['плати', 'платя', 'платим'], acceptableAnswers: [['платя']] },
      { text: 'Накрая ще се _______ вкъщи – спокойна, но без пари.', blanks: [1], correctAnswers: ['върна'], options: ['върне', 'върнем', 'върна'], acceptableAnswers: [['върна']] },
    ],
  } as WorkbookFillBlankExercise,
