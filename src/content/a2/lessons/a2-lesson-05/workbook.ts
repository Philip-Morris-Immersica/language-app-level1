...
export const workbookExercises: Exercise[] = [
  ...
  // ─── ORDER 34 — WB 3: Подчертайте правилната форма (трябва да) ────────────
  {
    ...
    layout: 'single',
    sentences: [
      { text: 'Камен трябва да _______ в Пловдив през уикенда.', blanks: [1], correctAnswers: ['отиде'], options: ['отива', 'отиде'], acceptableAnswers: [['отиде']] },
      { text: 'Силвия трябва да _______ на детето всеки ден.', blanks: [1], correctAnswers: ['помага'], options: ['помага', 'помогне'], acceptableAnswers: [['помага']] },
      { text: 'Асен и Петър трябва да ми _______ по телефона тази вечер.', blanks: [1], correctAnswers: ['се обадят'], options: ['се обаждат', 'се обадят'], acceptableAnswers: [['се обадят', 'обадят се']] },
      { text: 'Аз и Ани трябва да _______ пари в сметката утре.', blanks: [1], correctAnswers: ['внесем'], options: ['внасяме', 'внесем'], acceptableAnswers: [['внесем']] },
      { text: 'Ти трябва да _______ на работа рано всеки ден.', blanks: [1], correctAnswers: ['идваш'], options: ['идваш', 'дойдеш'], acceptableAnswers: [['идваш']] },
      { text: 'Ти и Виктор трябва да _______ проекта преди 16:00.', blanks: [1], correctAnswers: ['свършите'], options: ['свършвате', 'свършите'], acceptableAnswers: [['свършите']] },
    ],
  } as WorkbookFillBlankExercise,
