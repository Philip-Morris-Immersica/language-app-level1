...
export const exercises: Exercise[] = [
    ...
    examples: [
      {
        ...
        ttsText: 'Иво е учител. Иво и Милен са учители. Катя е учителка. Катя и Светла са учителки. Иво и Катя са учители.',
        voiceGender: 'female',
      },
      {
        imageUrl: '',
      ...
      },
      {
        ...
        ttsText: 'Той е полицай. Тя е полицай. Той е инженер. Тя е инженер. Той е адвокат. Тя е адвокат. Той е директор. Тя е директор. Той е шофьор. Тя е шофьор.',
        voiceGender: 'female',
      },
    ],
    ...
    sections: [
      {
        ...
        lines: [
          { text: '– Какъв сте по професия?', voiceGender: 'male' },
          { text: '– Аз съм инженер. Бях директор на фирма. Сега съм пенсионер. А Вие каква сте?', voiceGender: 'female' },
          { text: '– Аз съм преводачка. Превеждам документи от английски на български.', voiceGender: 'male' },
        ],
      },
    ],
  ...
  // ─── ORDER 9 — ГРАМАТИКА 2 (стр. 72): Минало свършено — ИХ група ──────────────
  {
    ...
    columns: ['(+)'],
    rows: [
      { pronoun: 'аз',        cells: ['работих'],   ttsText: 'аз. Работих.' },
      { pronoun: 'ти',        cells: ['работи'],    ttsText: 'ти. Работи.' },
      { pronoun: 'той/тя/то', cells: ['работи'],    ttsText: 'той, тя, то. Работи.' },
      { pronoun: 'ние',       cells: ['работихме'], ttsText: 'ние. Работихме.' },
      { pronoun: 'Вие',       cells: ['работихте'], ttsText: 'Вие. Работихте.' },
      { pronoun: 'те',        cells: ['работиха'],  ttsText: 'те. Работиха.' },
    ],
    notes: [
  ...
  // ─── ORDER 30 — ГРАМАТИКА 5 (стр. 76): Местоимения ──────────────────────────
  {
    ...
    rows: [
      { pronoun: '',  cells: ['кой',   'някой',   'никой'],   ttsText: 'кой — някой — никой.' },
      { pronoun: '',  cells: ['колко', 'няколко', 'николко'],  ttsText: 'колко — няколко — николко.' },
      { pronoun: '',  cells: ['къде',  'някъде',  'никъде'],   ttsText: 'къде — някъде — никъде.' },
      { pronoun: '',  cells: ['кога',  'някога',  'никога'],   ttsText: 'кога — някога — никога.' },
      { pronoun: '',  cells: ['нещо',  'нещо',    'нищо'],     ttsText: 'нещо — нищо.' },
    ],
    notes: [
      '⚠️ **Никой не** иска кафе. / **Никъде не** мога да намеря…',
    ],
    ttsNotes: [
      'Внимание. Никой не иска кафе. Никъде не мога да намеря…',
    ],
    ttsNoteModels: ['pro'],
  } as GrammarTableExercise,
  ...
  // ─── ORDER 37 — ГРАМАТИКА 6 (стр. 77–78): Глагол → Съществително ──────────
  {
    ...
    rows: [
      { pronoun: 'разхождам се / разходя се', cells: ['разходка',              'Всеки ден ходя на разходка. Приятна разходка!'],     ttsText: 'разхождам се. разходка. Всеки ден ходя на разходка. Приятна разходка!' },
      { pronoun: 'срещам се / срещна се',     cells: ['среща',                 'Имам среща с приятели.'],                            ttsText: 'срещам се. среща. Имам среща с приятели.' },
      { pronoun: 'помагам / помогна',         cells: ['помощ',                 'Трябва ми помощ. = Имам нужда от помощ.'],           ttsText: 'помагам. помощ. Трябва ми помощ.' },
      { pronoun: 'закъснявам / закъснея',     cells: ['закъснение',            'Влакът има десет минути закъснение.'],               ttsText: 'закъснявам. закъснение. Влакът има десет минути закъснение.' },
      { pronoun: 'превеждам / преведа',       cells: ['преводач',              'Аз съм преводач от арабски на български.'],          ttsText: 'превеждам. преводач. Аз съм преводач от арабски на български.' },
      { pronoun: 'каня / поканя',             cells: ['покана',                'Благодаря за поканата!'],                            ttsText: 'каня. покана. Благодаря за поканата!' },
      { pronoun: 'работя',                    cells: ['работа / работник',     'Имам нова работа! Лека работа! Петър е добър работник.'], ttsText: 'работя. работа, работник. Имам нова работа! Лека работа! Петър е добър работник.' },
      { pronoun: 'играя',                     cells: ['игра / играчка',        'Учениците обичат видеоигри. Децата ми имат много играчки.'], ttsText: 'играя. игра, играчка. Учениците обичат видеоигри. Децата ми имат много играчки.' },
      { pronoun: 'ям',                        cells: ['ядене / ястие',         'Нещо за ядене? Това е любимото ми ястие.'],          ttsText: 'ям. ядене, ястие. Нещо за ядене? Това е любимото ми ястие.' },
      { pronoun: 'пия',                       cells: ['пиене / напитка',       'Какво искате за пиене? Има ли безалкохолни напитки?'], ttsText: 'пия. пиене, напитка. Какво искате за пиене? Има ли безалкохолни напитки?' },
      { pronoun: 'пуша',                      cells: ['пушене / пушач',        'Пушенето е забранено. Пушач ли сте?'],               ttsText: 'пуша. пушене, пушач. Пушенето е забранено. Пушач ли сте?' },
      { pronoun: 'пътувам',                   cells: ['пътуване / път',        'Приятно пътуване! Лек път!'],                        ttsText: 'пътувам. пътуване, път. Приятно пътуване! Лек път!' },
      { pronoun: 'разговарям',                cells: ['разговор',              'Директорът има важен разговор с работниците.'],      ttsText: 'разговарям. разговор. Директорът има важен разговор с работниците.' },
    ],
    ttsNoteModels: [],
  } as GrammarTableExercise,
  ...
  // 🎧 TODO Фаза 2: audioUrl ще се генерира с npm run tts:generate -- --lesson 07
  {
    ...
    sentences: [
      { text: '1. Обичам да ходя на _____ с приятели в парка през пролетта.', blanks: [1], correctAnswers: ['разходка'],   options: ['разходка', 'среща', 'работа', 'пътуване'],    acceptableAnswers: [['разходка']] },
      { text: '2. Старите хора често имат нужда от _____.', blanks: [1], correctAnswers: ['помощ'],      options: ['помощ', 'работа', 'покана', 'разговор'],     acceptableAnswers: [['помощ']] },
      { text: '3. Малките деца много обичат _____, по-големите обичат видеоигри.', blanks: [1], correctAnswers: ['играчки'],   options: ['играчки', 'игри', 'напитки', 'ястия'],        acceptableAnswers: [['играчки']] },
      { text: '4. _____ от България до Китай е много трудно.', blanks: [1], correctAnswers: ['Пътуването'], options: ['Пътуването', 'Работата', 'Разходката', 'Срещата'], acceptableAnswers: [['Пътуването', 'пътуването']] },
      { text: '5. В хладилника няма нищо за _____ и _____.', blanks: [1, 2], correctAnswers: ['ядене', 'пиене'], options: [['ядене', 'пиене', 'ястие', 'напитка'], ['пиене', 'ядене', 'разговор', 'пушене']], acceptableAnswers: [['ядене'], ['пиене']] },
      { text: '6. В момента търсят _____ за сезонна _____ във Франция през лятото.', blanks: [1, 2], correctAnswers: ['работници', 'работа'], options: [['работници', 'преводачи', 'шофьори', 'готвачи'], ['работа', 'среща', 'разходка', 'покана']], acceptableAnswers: [['работници'], ['работа']] },
      { text: '7. Автобусите от Бургас често пристигат на автогарата със _____.', blanks: [1], correctAnswers: ['закъснение'], options: ['закъснение', 'пушене', 'ядене', 'пиене'],   acceptableAnswers: [['закъснение']] },
      { text: '8. Тази вечер имам _____ с приятели от училище.', blanks: [1], correctAnswers: ['среща'],      options: ['среща', 'разходка', 'покана', 'разговор'],    acceptableAnswers: [['среща']] },
      { text: '9. В Държавната агенция за бежанците търсят _____ с добър арабски език.', blanks: [1], correctAnswers: ['преводачи'],  options: ['преводачи', 'работници', 'готвачи', 'шофьори'], acceptableAnswers: [['преводачи']] },
      { text: '10. Утре имам _____ с учителката на сина ми.', blanks: [1], correctAnswers: ['разговор'],   options: ['разговор', 'среща', 'разходка', 'пътуване'],  acceptableAnswers: [['разговор', 'среща']] },
      { text: '11. Имам две _____ за концерт за утре вечер. Искаш ли да дойдеш с мен?', blanks: [1], correctAnswers: ['покани'],     options: ['покани', 'срещи', 'разговори', 'разходки'],  acceptableAnswers: [['покани']] },
    ],
  } as WorkbookFillBlankExercise,

  // ─── ORDER 39 — Упр. 31 (стр. 78): Напишете изречения със съществителните ──
  // TODO: Оригиналното упражнение е свободно писане. Апроксимирано с a2-free-fill (0 т.).
  // Предложение: бъдещ тип „free_write" с текстово поле, ако клиентът поиска.
  {
    id: 'a2-l07-ex-31',
    type: 'a2-free-fill',
    title: 'УПРАЖНЕНИЕ 31',
    instruction: 'Напишете изречения със съществителните имена от таблицата.',
    order: 39,
    sentences: [
      { label: 'писмо' },
      { label: 'огледало' },
  ...
  // ─── ORDER 40 — ДОП. упражнения (стр. 79): CV на Васил ─────────────────────
  {
    ...
    ttsParagraphs: [
      'Трите имена: Васил Иванов Петров. Адрес: град София, жилищен квартал Младост три. Телефон: плюс триста петдесет и девет, осемстотин деветдесет и седем, деветстотин и деветдесет, двеста и пет. Имейл: vasil iv, в abv bg. Дата на раждане: осемнадесети юли хиляда деветстотин и деветдесета година. Националност: българин.',
  ...
  // TODO: Оригиналното упражнение е графична CV бланка.
  // Апроксимирано с a2-free-fill (0 т.). Предложение: бъдещ тип „cv_form" за структурирано CV.
  {
    id: 'a2-l07-ex-36',
    type: 'a2-free-fill',
    title: 'УПРАЖНЕНИЕ 36',
    instruction: 'Попълнете автобиографията на Мустафа, като използвате информацията от текста.',
    order: 44,
    sentences: [
      { label: 'Име' },
      { label: 'Телефон' },
      ...
      { label: 'Националност' },
      { label: 'Трудов стаж (2005 – сега)' },
      { label: 'Образование (1999 – 2004)' },
      { label: 'Образование (до 1998 г.)' },
      { label: 'Майчин език' },
      { label: 'Други езици' },
      { label: 'Компютърни умения' },
    ],
  } as unknown as Exercise,
