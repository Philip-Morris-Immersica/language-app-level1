...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 4 — Упр. 3 (стр. 71): Свържете професията с работното място ───────
  {
    ...
    points: 7,
    questions: [
      { id: 'q1', left: 'полицай',  options: ['полиция', 'болница', 'магазин', 'ресторант'], correctAnswer: 'полиция' },
      { id: 'q2', left: 'учител',   options: ['училище', 'болница', 'ресторант', 'офис'], correctAnswer: 'училище' },
      { id: 'q3', left: 'готвач',   options: ['ресторант', 'болница', 'магазин', 'училище'], correctAnswer: 'ресторант' },
      { id: 'q4', left: 'фризьор',  options: ['фризьорски салон', 'болница', 'магазин', 'ресторант'], correctAnswer: 'фризьорски салон' },
      { id: 'q5', left: 'директор', options: ['офис', 'училище', 'болница', 'магазин'], correctAnswer: 'офис', alternateCorrectAnswers: ['училище'] },
      { id: 'q6', left: 'продавач', options: ['магазин', 'болница', 'ресторант', 'офис'], correctAnswer: 'магазин' },
      { id: 'q7', left: 'лекар',    options: ['болница', 'магазин', 'ресторант', 'офис'], correctAnswer: 'болница' },
    ],
  ...
  // ─── ORDER 10 — Упр. 8 (стр. 73): Попълнете окончанията на глаголите ──────────
  {
    ...
    sentences: [
      ...
      { text: 'Снощи ти _____ ли до късно?',                    blanks: [1], correctAnswers: ['работи'],    options: ['работих', 'работи', 'работихме', 'работихте', 'работиха'], acceptableAnswers: [['работи']] },
      { text: 'Преди три дни той _____ на концерт.',               blanks: [1], correctAnswers: ['ходи'],    options: ['ходих', 'ходи', 'ходихме', 'ходихте', 'ходиха'], acceptableAnswers: [['ходи']] },
      { text: 'Те какво _____ миналия уикенд?',                   blanks: [1], correctAnswers: ['правиха'],  options: ['правих', 'прави', 'правихме', 'правихте', 'правиха'], acceptableAnswers: [['правиха']] },
      { text: 'Миналата седмица ние _____ много за вас.',          blanks: [1], correctAnswers: ['мислихме'], options: ['мислих', 'мисли', 'мислихме', 'мислихте', 'мислиха'], acceptableAnswers: [['мислихме']] },
      { text: 'Снощи вие _____ ли супа?',                         blanks: [1], correctAnswers: ['готвихте'], options: ['готвих', 'готви', 'готвихме', 'готвихте', 'готвиха'], acceptableAnswers: [['готвихте']] },
      { text: 'Преди един месец те _____ квартира.',               blanks: [1], correctAnswers: ['търсиха'],  options: ['търсих', 'търси', 'търсихме', 'търсихте', 'търсиха'], acceptableAnswers: [['търсиха']] },
      { text: 'През уикенда децата _____ по английски.',             blanks: [1], correctAnswers: ['учиха'],  options: ['учих', 'учи', 'учихме', 'учихте', 'учиха'], acceptableAnswers: [['учиха']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 11 — Упр. 9 (стр. 73): Попълнете с подходящ глагол от списъка ──────
  {
    ...
    sentences: [
      ...
      { text: 'Миналото лято ние _____ в един магазин за обувки.',   blanks: [1], correctAnswers: ['работихме'], options: ['работихме', 'готвихме', 'говорихме', 'благодарихме'], acceptableAnswers: [['работихме']] },
      { text: 'Миналия уикенд той _____ на фитнес.',                 blanks: [1], correctAnswers: ['ходи'],      options: ['ходи', 'готви', 'благодари', 'говори'],               acceptableAnswers: [['ходи']] },
      { text: 'Вчера те _____ мусака.',                              blanks: [1], correctAnswers: ['готвиха'],   options: ['готвиха', 'говориха', 'работиха', 'благодариха'],    acceptableAnswers: [['готвиха']] },
      { text: 'Тя _____ на Петър за хубавите цветя.',                blanks: [1], correctAnswers: ['благодари'], options: ['благодари', 'готви', 'работи', 'ходи'],               acceptableAnswers: [['благодари']] },
      { text: 'Преди една седмица те _____ по телефона с директора.', blanks: [1], correctAnswers: ['говориха'],  options: ['говориха', 'готвиха', 'работиха', 'ходиха'],    acceptableAnswers: [['говориха']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 22 — Упр. 19 (стр. 75): Свържете професията със специалността ─────
  {
    ...
    points: 8,
    questions: [
      { id: 'q1', left: 'лекар',               options: ['медицина', 'история', 'физика', 'архитектура'],  correctAnswer: 'медицина' },
      { id: 'q2', left: 'учител',              options: ['педагогика', 'медицина', 'архитектура', 'психология'],  correctAnswer: 'педагогика' },
      { id: 'q3', left: 'психолог',            options: ['психология', 'история', 'медицина', 'архитектура'],  correctAnswer: 'психология' },
      { id: 'q4', left: 'архитект',            options: ['архитектура', 'история', 'медицина', 'физика'],  correctAnswer: 'архитектура' },
      { id: 'q5', left: 'историк',             options: ['история', 'медицина', 'физика', 'архитектура'],  correctAnswer: 'история' },
      { id: 'q6', left: 'физик',               options: ['физика', 'история', 'медицина', 'педагогика'],  correctAnswer: 'физика' },
      { id: 'q7', left: 'преводач',            options: ['филология', 'медицина', 'физика', 'архитектура'],  correctAnswer: 'филология' },
      { id: 'q8', left: 'компютърен инженер',  options: ['информатика', 'история', 'медицина', 'архитектура'],  correctAnswer: 'информатика' },
    ],
  } as DropdownMatchExercise,
  ...
  // ─── ORDER 25 — Упр. 23 (стр. 76): Попълнете окончанията — завърш- ────────────
  {
    ...
    sentences: [
      ...
      { text: 'Брат ми _____ университет преди две години.',         blanks: [1], correctAnswers: ['завърши'],    options: ['завърших', 'завърши', 'завършихме', 'завършихте', 'завършиха'], acceptableAnswers: [['завърши']] },
      { text: 'Приятелката ми _____ езикова гимназия преди един месец.', blanks: [1], correctAnswers: ['завърши'],    options: ['завърших', 'завърши', 'завършихме', 'завършихте', 'завършиха'], acceptableAnswers: [['завърши']] },
      { text: 'Ние _____ Информатика преди три години.',               blanks: [1], correctAnswers: ['завършихме'], options: ['завърших', 'завърши', 'завършихме', 'завършихте', 'завършиха'], acceptableAnswers: [['завършихме']] },
      { text: 'Вие кога _____ средно образование?',                   blanks: [1], correctAnswers: ['завършихте'], options: ['завърших', 'завърши', 'завършихме', 'завършихте', 'завършиха'], acceptableAnswers: [['завършихте']] },
      { text: 'Те _____ Английска филология през 2022 година.',        blanks: [1], correctAnswers: ['завършиха'],  options: ['завърших', 'завърши', 'завършихме', 'завършихте', 'завършиха'], acceptableAnswers: [['завършиха']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 38 — Упр. 36 (стр. 80): Попълнете автобиографията на Мустафа ──────
  {
    ...
    type: 'multiple_choice',
    title: 'УПРАЖНЕНИЕ 36',
    instruction: 'Прочетете текста и попълнете автобиографията на Мустафа.',
    order: 38,
    points: 10,
    questions: [
      { question: 'Как се казва?',                          options: ['Васил', 'Мустафа', 'Ахмед'],                                                          correctIndex: 1 },
      { question: 'Какъв е телефонният му номер?',          options: ['+359888123456', '+4915779967413', '+4915770000000'],                                  correctIndex: 1 },
      { question: 'Кога е роден?',                          options: ['17 април 1990 г.', '17 април 1980 г.', '7 април 1980 г.'],                            correctIndex: 1 },
      { question: 'Каква е националността му?',              options: ['Германец', 'Иракчанин', 'Сириец'],                                                    correctIndex: 2 },
      { question: 'Какво работи от 2005 г. до сега?',       options: ['Компютърен специалист в Берлин', 'Учител в София', 'Преводач в Дамаск'],              correctIndex: 0 },
      { question: 'Какво учи между 1999 и 2004 г.?',        options: ['Гимназия в Берлин', 'Университет в Дамаск, Информатика', 'Университет в София'],      correctIndex: 1 },
      { question: 'Какво образование завършва до 1998 г.?', options: ['Основно образование', 'Средно образование', 'Висше образование'],                     correctIndex: 1 },
      { question: 'Кой е майчиният му език?',               options: ['Английски', 'Испански', 'Арабски'],                                                   correctIndex: 2 },
      { question: 'Какви други езици говори?',              options: ['Английски и испански', 'Френски и немски', 'Руски и турски'],                         correctIndex: 0 },
      { question: 'Какви са компютърните му умения?',       options: ['Основни', 'Отлични', 'Нямам'],                                                        correctIndex: 1 },
    ],
  } as MultipleChoiceExercise,
