...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 1 — Упр. 1 (стр. 24): думи под картинките (мъж, жена, момиче, момче) ────────────
  {
    ...
    order: 1,
    sectionStart: {
      title: 'Части на тялото, болести и симптоми',
      subtitle: 'Нови думи за тялото и болестите, неправилно множествено число и „боли ме"',
      titleI18n: {
        en: 'Body parts, illnesses and symptoms',
        fr: 'Parties du corps, maladies et symptômes',
        ar: 'أجزاء الجسم والأمراض والأعراض',
        fa: 'اعضای بدن، بیماری‌ها و علائم',
        uk: 'Частини тіла, хвороби та симптоми',
        ru: 'Части тела, болезни и симптомы',
      },
      subtitleI18n: {
        en: 'New words for the body and illnesses, irregular plurals and "боли ме" (it hurts me)',
        fr: 'Nouveaux mots pour le corps et les maladies, pluriels irréguliers et «боли ме» (j\'ai mal)',
        ar: 'كلمات جديدة عن الجسم والأمراض، جمع غير منتظم و«боли ме» (يؤلمني)',
        fa: 'کلمات جدید برای بدن و بیماری‌ها، جمع نامنظم و «боли ме» (درد می‌کند)',
        uk: 'Нові слова для тіла і хвороб, неправильна множина і «боли ме» (мене болить)',
        ru: 'Новые слова для тела и болезней, неправильное множественное число и «боли ме» (мне больно)',
      },
      theme: 'vocabulary',
    },
    points: 4,
  ...
  // ─── ORDER 14 — ГРАМАТИКА 3 (стр. 27): Дателни местоимения ─────────────────────────────────
  {
    ...
    order: 14,
    sectionStart: {
      title: 'Дателни местоимения и безлични изречения',
      subtitle: 'Кратки дателни форми, „трябва ми" и безлични конструкции',
      titleI18n: {
        en: 'Dative pronouns and impersonal sentences',
        fr: 'Pronoms au datif et phrases impersonnelles',
        ar: 'الضمائر في حالة الجر والجمل غير الشخصية',
        fa: 'ضمایر مفعولی غیرمستقیم و جملات غیرشخصی',
        uk: 'Давальні займенники та безособові речення',
        ru: 'Дательные местоимения и безличные предложения',
      },
      subtitleI18n: {
        en: 'Short dative forms, "трябва ми" (I need) and impersonal constructions',
        fr: 'Formes courtes au datif, «трябва ми» (j\'ai besoin) et constructions impersonnelles',
        ar: 'الصيغ القصيرة في حالة الجر، «трябва ми» (أحتاج) والتراكيب غير الشخصية',
        fa: 'شکل‌های کوتاه مفعولی غیرمستقیم، «трябва ми» (لازم دارم) و ساخت‌های غیرشخصی',
        uk: 'Короткі давальні форми, «трябва ми» (мені потрібно) і безособові конструкції',
        ru: 'Краткие дательные формы, «трябва ми» (мне нужно) и безличные конструкции',
      },
      theme: 'grammar',
    },
  ...
  // ─── ORDER 24 — НОВИ ДУМИ 3 (стр. 29): състояния и емоции ──────────────────────────────────
  {
    ...
    order: 24,
    sectionStart: {
      title: 'Здравословно и емоционално състояние',
      subtitle: 'Състояния като здрав и болен и въпросът „Как се чувствате?"',
      titleI18n: {
        en: 'Physical and emotional state',
        fr: 'État de santé et émotions',
        ar: 'الحالة الصحية والعاطفية',
        fa: 'وضعیت جسمی و عاطفی',
        uk: 'Здоров\'я та емоційний стан',
        ru: 'Здоровье и эмоциональное состояние',
      },
      subtitleI18n: {
        en: 'States such as healthy and ill, and the question "Как се чувствате?" (How do you feel?)',
        fr: 'États comme en bonne santé et malade, et la question «Как се чувствате?» (Comment allez-vous ?)',
        ar: 'حالات مثل صحيح ومريض، والسؤال «Как се чувствате?» (كيف تشعر؟)',
        fa: 'حالت‌هایی مانند سالم و بیمار و پرسش «Как се чувствате?» (حال‌تان چطور است؟)',
        uk: 'Стани на кшталт здоровий і хворий та питання «Как се чувствате?» (Як ви себе почуваєте?)',
        ru: 'Состояния вроде здоров и болен и вопрос «Как се чувствате?» (Как вы себя чувствуете?)',
      },
      theme: 'vocabulary',
    },
    cards: [
  ...
  // ─── ORDER 31 — НОВИ ДУМИ 4 (стр. 30–31): В ПОЛИКЛИНИКАТА ──────────────────────────────────
  {
    ...
    order: 31,
    sectionStart: {
      title: 'В поликлиниката и в аптеката',
      subtitle: 'Лекари, специалности, лекарства и диалози при преглед',
      titleI18n: {
        en: 'At the clinic and at the pharmacy',
        fr: 'À la polyclinique et à la pharmacie',
        ar: 'في العيادة وفي الصيدلية',
        fa: 'در درمانگاه و داروخانه',
        uk: 'У поліклініці та в аптеці',
        ru: 'В поликлинике и в аптеке',
      },
      subtitleI18n: {
        en: 'Doctors, medical specialties, medicines and dialogues at the examination',
        fr: 'Médecins, spécialités, médicaments et dialogues lors de la consultation',
        ar: 'أطباء وتخصصات وأدوية وحوارات أثناء الفحص',
        fa: 'پزشکان، تخصص‌ها، داروها و گفتگو هنگام معاینه',
        uk: 'Лікарі, спеціальності, ліки та діалоги на огляді',
        ru: 'Врачи, специальности, лекарства и диалоги на приёме',
      },
      theme: 'vocabulary',
    },
    cards: [
  ...
  // ─── ORDER 36 — ТЕКСТОВЕ / Упр. 26 (стр. 32): Антон при лекар ──────────────────────────────
  {
    ...
    order: 36,
    sectionStart: {
      title: 'Текстове за здравето',
      subtitle: 'Четива за Антон и Али, полезни навици и билки',
      titleI18n: {
        en: 'Texts about health',
        fr: 'Textes sur la santé',
        ar: 'نصوص عن الصحة',
        fa: 'متن‌هایی درباره سلامت',
        uk: 'Тексти про здоров\'я',
        ru: 'Тексты о здоровье',
      },
      subtitleI18n: {
        en: 'Readings about Anton and Ali, healthy habits and herbs',
        fr: 'Lectures sur Anton et Ali, habitudes saines et plantes médicinales',
        ar: 'قراءات عن أنطون وعلي، وعادات صحية وأعشاب',
        fa: 'خواندنی‌هایی درباره آنتون و علی، عادت‌های سالم و گیاهان دارویی',
        uk: 'Читанки про Антона й Алі, корисні звички та трави',
        ru: 'Тексты про Антона и Али, полезные привычки и травы',
      },
      theme: 'reading',
    },
    showDictionary: true,
