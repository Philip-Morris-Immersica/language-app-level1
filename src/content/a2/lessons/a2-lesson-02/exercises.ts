...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 10 — Упр. 8 (стр. 26): правилното местоимение ───────────────────────────────────
  {
    ...
    questions: [
      ...
      { id: 'q1', left: 'Той не е добре. Боли … кракът.',  options: ['ме', 'те', 'го', 'я', 'ни', 'ви', 'ги'], correctAnswer: 'го' },
      { id: 'q2', left: 'Те не са добре. Болят … зъбите.', options: ['ме', 'те', 'го', 'я', 'ни', 'ви', 'ги'], correctAnswer: 'ги' },
      { id: 'q3', left: 'Тя не е добре. Боли … коремът.',  options: ['ме', 'те', 'го', 'я', 'ни', 'ви', 'ги'], correctAnswer: 'я'  },
      { id: 'q4', left: 'Ние не сме добре. Болят … очите.', options: ['ме', 'те', 'го', 'я', 'ни', 'ви', 'ги'], correctAnswer: 'ни' },
      { id: 'q5', left: 'Ти не си добре. Боли … ухото.',   options: ['ме', 'те', 'го', 'я', 'ни', 'ви', 'ги'], correctAnswer: 'те' },
      { id: 'q6', left: 'Вие не сте добре. Болят … гърдите.', options: ['ме', 'те', 'го', 'я', 'ни', 'ви', 'ги'], correctAnswer: 'ви' },
    ],
  } as DropdownMatchExercise,
  ...
  // ─── ORDER 21 — Упр. 15 (стр. 28): изберете подходящото изречение (модел + 5 опции) ────────────
  {
    ...
    questions: [
      ...
      { id: 'q1', left: 'Навън е студено. Нямам палто. →', options: ['Студено ми е.', 'Топло ми е.', 'Приятно ми е.', 'Трудно ми е.', 'Лошо ми е.'], correctAnswer: 'Студено ми е.' },
      { id: 'q2', left: 'Лятото е. Слънцето е силно. →',   options: ['Топло ми е.', 'Студено ми е.', 'Трудно ми е.', 'Лошо ми е.', 'Интересно ми е.'], correctAnswer: 'Топло ми е.' },
      { id: 'q3', left: 'Гледам интересен филм. →',        options: ['Интересно ми е.', 'Студено ми е.', 'Топло ми е.', 'Лошо ми е.', 'Трудно ми е.'], correctAnswer: 'Интересно ми е.' },
      { id: 'q4', left: 'Имам температура и кашлица. →',   options: ['Лошо ми е.', 'Приятно ми е.', 'Топло ми е.', 'Лесно ми е.', 'Интересно ми е.'], correctAnswer: 'Лошо ми е.' },
      { id: 'q5', left: 'Уча трудна математика. →',        options: ['Трудно ми е.', 'Лесно ми е.', 'Приятно ми е.', 'Студено ми е.', 'Топло ми е.'], correctAnswer: 'Трудно ми е.' },
      { id: 'q6', left: 'Срещам стар приятел. →',          options: ['Приятно ми е.', 'Лошо ми е.', 'Студено ми е.', 'Трудно ми е.', 'Топло ми е.'], correctAnswer: 'Приятно ми е.' },
      { id: 'q7', left: 'Задачата е много лесна. →',       options: ['Лесно ми е.', 'Трудно ми е.', 'Лошо ми е.', 'Студено ми е.', 'Приятно ми е.'], correctAnswer: 'Лесно ми е.' },
    ],
  } as DropdownMatchExercise,
  ...
  // ─── ORDER 23 — Упр. 16 (стр. 29): попълнете правилното местоимение (модел + inline + 5 опции) ──
  {
    ...
    questions: [
      ...
      { id: 'q1', left: 'Аз съм Мария. Приятно … е.',                options: ['ми', 'ти', 'му', 'ѝ', 'ни'], correctAnswer: 'ми' },
      { id: 'q2', left: 'Прозорецът е затворен. Топло ли … е?',      options: ['ти', 'ми', 'му', 'ѝ', 'ви'], correctAnswer: 'ти' },
      { id: 'q3', left: 'Той е без яке навън. Студено ли … е?',      options: ['му', 'ми', 'ти', 'ѝ', 'им'], correctAnswer: 'му' },
      { id: 'q4', left: 'Ние сме в един музей. Интересно … е.',      options: ['ни', 'ми', 'ви', 'им', 'му'], correctAnswer: 'ни' },
      { id: 'q5', left: 'Тя има пет деца. Трудно … е.',              options: ['ѝ', 'ми', 'му', 'ти', 'им'], correctAnswer: 'ѝ'  },
      { id: 'q6', left: 'Боли ме стомахът. Лошо … е.',               options: ['ми', 'ти', 'му', 'ѝ', 'ни'], correctAnswer: 'ми' },
      { id: 'q7', left: 'Вие вечеряте с приятели. Приятно ли … е?',  options: ['ви', 'ми', 'ти', 'му', 'им'], correctAnswer: 'ви' },
    ],
  } as DropdownMatchExercise,
  ...
  // ─── ORDER 27 — Упр. 18 (стр. 30): изберете подходящата реакция (модел + 5 опции) ─────────────
  {
    ...
    questions: [
      ...
      { id: 'q1', left: 'Работя много всеки ден. →',              options: ['Уморен съм.', 'Жадна съм.', 'Весел е.', 'Доволен си.', 'Тъжни са.'], correctAnswer: 'Уморен съм.' },
      { id: 'q2', left: 'Детето иска три кюфтета и салата. →',    options: ['Гладно е.', 'Жадна съм.', 'Здрава е.', 'Весел е.', 'Уморен съм.'], correctAnswer: 'Гладно е.' },
      { id: 'q3', left: 'Искам една минерална вода. →',           options: ['Жадна съм.', 'Гладно е.', 'Уморен съм.', 'Доволен си.', 'Весел е.'], correctAnswer: 'Жадна съм.' },
      { id: 'q4', left: 'Те нямат работа, нямат пари. →',         options: ['Тъжни са.', 'Весел е.', 'Доволен си.', 'Болен сте.', 'Здрава е.'], correctAnswer: 'Тъжни са.' },
      { id: 'q5', left: 'Петър има рожден ден и много гости. →',  options: ['Весел е.', 'Тъжни са.', 'Уморен съм.', 'Гладно е.', 'Доволен си.'], correctAnswer: 'Весел е.' },
      { id: 'q6', left: 'Вие имате високо кръвно. →',             options: ['Болен сте.', 'Здрава е.', 'Уморен съм.', 'Тъжни са.', 'Жадна съм.'], correctAnswer: 'Болен сте.' },
      { id: 'q7', left: 'Нямаш проблеми. →',                      options: ['Доволен си.', 'Весел е.', 'Уморен съм.', 'Тъжни са.', 'Болен сте.'], correctAnswer: 'Доволен си.' },
      { id: 'q8', left: 'Мариам няма температура. →',             options: ['Здрава е.', 'Болен сте.', 'Весел е.', 'Доволен си.', 'Гладно е.'], correctAnswer: 'Здрава е.' },
    ],
  } as DropdownMatchExercise,
