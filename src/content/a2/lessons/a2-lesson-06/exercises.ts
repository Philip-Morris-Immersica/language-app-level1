...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 7 — Упр. 6 (стр. 61): форми на съм ─────────────────────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 6',
    instruction: 'Изберете правилната форма на глагола **съм** в минало свършено по модела. Модел: Аз **бях** в парка.',
    order: 7,
    points: 6,
    layout: 'single',
    sentences: [
  ...
  // ─── ORDER 9 — Упр. 7 (стр. 62): глаголи в 1 л. ед.ч. минало ──────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 7',
    instruction: 'Изберете глаголите в 1 л. ед.ч. минало свършено по модела: играя → **играх**.',
    order: 9,
    points: 10,
    layout: 'two-column',
    sentences: [
  ...
  // ─── ORDER 19 — Упр. 13 (стр. 64): трансформирайте ─────────────────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 13',
    instruction: 'Изберете правилната форма по модела: „Аз искам да уча → Миналото лято **исках** да уча."',
    order: 19,
    points: 3,
    layout: 'single',
    sentences: [
  ...
  // ─── ORDER 28 — Упр. 22 (стр. 66): окончанията ─────────────────────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 22',
    instruction: 'Изберете правилната форма на минало свършено (ЯХ група). Модел: „Снощи вечерях вкъщи. (вечерям)".',
    order: 28,
    points: 5,
    layout: 'single',
    sentences: [
  ...
  // ─── ORDER 41 — ТЕКСТ Упр. 35 (стр. 70): Кирил и Методий ──────────────────
  {
    ...
    ttsParagraphs: [
      ...
      'По-късно е създадена кирилицата, на която пишем днес. Буквите на новата азбука са по-различни и по-лесни от старите. Използват ги и в други страни — Русия, Украйна, Сърбия, Босна и Херцего́вина, Северна Македония, Монголия, Черна гора, Беларус и други. В Гърция използват гръцката азбука, а в другите страни на Европа — латиницата.',
