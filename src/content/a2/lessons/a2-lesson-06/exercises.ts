...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 1 — Упр. 1 (стр. 60): поздрави под картинките ──────────────────
  {
    ...
    type: 'image_labeling',
    title: 'УПРАЖНЕНИЕ 1',
    instruction: 'Напишете подходящия поздрав под всяка картинка.',
    order: 1,
    points: 6,
    displayType: 'default',
    columns: 3,
  ...
  // ─── ORDER 3 — Именни дни в България (стр. 60): справочна таблица ──────────
  {
    ...
    columns: ['Имен ден на:'],
    rows: [
      { pronoun: 'Йордановден (6 януари)',    cells: ['Йордан, Йорданка'],          ttsText: 'Йордановден е на шести януари. Имен ден на Йордан и Йорданка.' },
      { pronoun: 'Ивановден (7 януари)',       cells: ['Иван, Иванка'],              ttsText: 'Ивановден е на седми януари. Имен ден на Иван и Иванка.' },
      { pronoun: 'Антоновден (17 януари)',     cells: ['Антон, Антоанета'],          ttsText: 'Антоновден е на седемнадесети януари. Имен ден на Антон и Антоанета.' },
      { pronoun: 'Атанасовден (18 януари)',    cells: ['Атанас, Атанаска'],          ttsText: 'Атанасовден е на осемнадесети януари. Имен ден на Атанас и Атанаска.' },
      { pronoun: 'Цветница (м. март / м. април)', cells: ['всички с имена на цветя'], ttsText: 'Цветница е през март или април. Имен ден на всички хора с имена на цветя.' },
      { pronoun: 'Гергьовден (6 май)',         cells: ['Георги, Гергана'],           ttsText: 'Гергьовден е на шести май. Имен ден на Георги и Гергана.' },
      { pronoun: 'Петровден (29 юни)',         cells: ['Петър, Петра'],              ttsText: 'Петровден е на двадесет и девети юни. Имен ден на Петър и Петра.' },
      { pronoun: 'Петковден (14 октомври)',    cells: ['Петко, Петя'],               ttsText: 'Петковден е на четиринадесети октомври. Имен ден на Петко и Петя.' },
      { pronoun: 'Димитровден (26 октомври)',  cells: ['Димитър, Димитрина'],        ttsText: 'Димитровден е на двадесет и шести октомври. Имен ден на Димитър и Димитрина.' },
      { pronoun: 'Никулден (6 декември)',      cells: ['Николай, Николина'],         ttsText: 'Никулден е на шести декември. Имен ден на Николай и Николина.' },
    ],
    ttsNoteModels: [],
  ...
  // ─── ORDER 4 — Упр. 4 (стр. 61): отговорете по модела ─────────────────────
  {
    ...
    type: 'dropdown_match',
    title: 'УПРАЖНЕНИЕ 4',
    instruction: 'Отговорете на въпросите по модела „– Кога има имен ден Иван? – Иван има имен ден на 7 януари." Използвайте таблицата.',
    order: 4,
    points: 7,
    questions: [
      { id: 'q1', left: 'Кога има имен ден Димитър?',           options: ['На 26 октомври.', 'На 29 юни.', 'На 6 май.', 'На 6 декември.'],        correctAnswer: 'На 26 октомври.' },
      { id: 'q2', left: 'Кога е именният ден на Петър?',        options: ['На 29 юни.', 'На 14 октомври.', 'На 26 октомври.', 'На 6 май.'],       correctAnswer: 'На 29 юни.' },
      { id: 'q3', left: 'На коя дата е именният ден на Георги?', options: ['На 6 май.', 'На 29 юни.', 'На 17 януари.', 'На 6 декември.'],         correctAnswer: 'На 6 май.' },
      { id: 'q4', left: 'Кой има имен ден на Цветница?',        options: ['Всички хора с имена на цветя.', 'Само Георги.', 'Само Иван и Иванка.', 'Всички депутати.'], correctAnswer: 'Всички хора с имена на цветя.' },
      { id: 'q5', left: 'Кой има имен ден на 6 януари?',        options: ['Йордан и Йорданка.', 'Иван и Иванка.', 'Антон и Антоанета.', 'Атанас и Атанаска.'], correctAnswer: 'Йордан и Йорданка.' },
      { id: 'q6', left: 'Кога е именният ден на Маргарита?',    options: ['На Цветница (м. март или м. април).', 'На 6 май.', 'На 8 март.', 'На 24 май.'], correctAnswer: 'На Цветница (м. март или м. април).' },
      { id: 'q7', left: 'Кога е Цветница?',                     options: ['Цветница е през март или април.', 'Цветница е на 24 май.', 'Цветница е на 1 март.', 'Цветница е на Великден.'], correctAnswer: 'Цветница е през март или април.' },
    ],
  ...
  // ─── ORDER 5 — ГРАМАТИКА 1 (стр. 61): минало на съм ────────────────────────
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 1',
    subtitle: 'Минало свършено на съм',
  ...
  // Апроксимирано като workbook_fill_blank. Предложение: бъдещ тип a2-find-in-text.
  {
    ...
    title: 'УПРАЖНЕНИЕ 5',
    instruction: 'Попълнете формите на глагола **съм** в минало свършено от диалог б. (В оригинала: подчертайте.)',
    order: 6,
    points: 5,
    layout: 'single',
    sentences: [
      { text: 'Вчера _____ помогнах на един приятел. (Модел)', blanks: [], correctAnswers: [], isExample: true },
  ...
  // ─── ORDER 7 — Упр. 6 (стр. 61): форми на съм ─────────────────────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 6',
    instruction: 'Напишете подходящите форми на глагола **съм** в минало свършено. Модел: Аз **бях** в парка.',
    order: 7,
    points: 6,
    layout: 'single',
    sentences: [
  ...
  // ─── ORDER 8 — ГРАМАТИКА 2 (стр. 61): АХ група ─────────────────────────────
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 2',
    subtitle: 'Минало свършено — АХ група',
  ...
  // ─── ORDER 9 — Упр. 7 (стр. 62): глаголи в 1 л. ед.ч. минало ──────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 7',
    instruction: 'Напишете глаголите в 1 л. ед.ч. минало свършено по модела: играя → **играх**.',
    order: 9,
    points: 10,
    layout: 'two-column',
    sentences: [
  ...
  // ─── ORDER 11 — ГРАМАТИКА 3 (стр. 62): времеви изрази ──────────────────────
  {
    ...
    title: 'ГРАМАТИКА 3',
    subtitle: 'Времеви изрази за минало',
    ...
    examples: [
      {
        ...
        lines: [
          ...
          '**онзи ден** (= преди два дни / the day before yesterday)',
        ],
      ...
      },
      {
        ...
        lines: [
          '**миналия** месец (last month)',
          '**миналата** седмица (last week)',
          '**миналото** лято / лято (last summer)',
        ],
  ...
  // ─── ORDER 13 — ГРАМАТИКА 4 (стр. 62): минало на имам ──────────────────────
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 4',
    subtitle: 'Минало свършено на имам',
    ...
    notes: [
      'Също: аз обичах / ти обичаше; аз исках / ти искаше; аз можах / ти можаше.',
    ],
    ttsNoteModels: ['pro'],
  } as GrammarTableExercise,
  ...
  // ─── ORDER 16 — ГРАМАТИКА 5 (стр. 63): има–имаше ───────────────────────────
  {
    ...
    type: 'grammar_examples',
    title: 'ГРАМАТИКА 5',
    subtitle: 'Има – имаше / Няма – нямаше',
  ...
  // ─── ORDER 18 — ГРАМАТИКА 6 (стр. 63–64): исках/трябваше/не можах + да ─────
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 6',
    subtitle: 'Исках / Трябваше / Не можах + да',
  ...
  // ─── ORDER 19 — Упр. 13 (стр. 64): трансформирайте ─────────────────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 13',
    instruction: 'Трансформирайте изреченията по модела: „Аз искам да уча → Миналото лято **исках** да уча."',
    order: 19,
    points: 3,
    layout: 'single',
    sentences: [
  ...
  // ─── ORDER 20 — Упр. 14 (стр. 64): аз → ти ────────────────────────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 14',
    instruction: 'Попълнете по модела, като замените **аз** с **ти**. Модел: „Вчера аз **помогнах** → Вчера ти **помогна**."',
    order: 20,
    points: 4,
    layout: 'two-column',
    sentences: [
  ...
  // ─── ORDER 21 — Упр. 15 (стр. 64): ти → той/ние/вие/те ────────────────────
  {
    id: 'a2-l06-ex-15',
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 15',
    instruction: 'Преобразувайте изреченията от упр. 14, като замените **ти** с **той**, **ние**, **вие**, **те**.',
    order: 21,
    points: 16,
    layout: 'single',
    sentences: [
      { text: 'Вчера ти помогна → той **помогна** / ние **помогнахме** / вие **помогнахте** / те **помогнаха**.', blanks: [], correctAnswers: [], isExample: true },
      { text: 'Снощи ти легна → той _____ / ние _____ / вие _____ / те _____.',
        blanks: [1, 2, 3, 4],
        correctAnswers: ['легна', 'легнахме', 'легнахте', 'легнаха'],
        options: [['легна', 'легнах', 'легнаха'], ['легнахме', 'легнахте', 'легнаха'], ['легнахте', 'легнахме', 'легнаха'], ['легнаха', 'легнахме', 'легнахте']],
        acceptableAnswers: [['легна'], ['легнахме'], ['легнахте'], ['легнаха']] },
      { text: 'Миналата седмица ти пристигна → той _____ / ние _____ / вие _____ / те _____.',
        blanks: [1, 2, 3, 4],
        correctAnswers: ['пристигна', 'пристигнахме', 'пристигнахте', 'пристигнаха'],
        options: [['пристигна', 'пристигнах', 'пристигнаха'], ['пристигнахме', 'пристигнахте', 'пристигнаха'], ['пристигнахте', 'пристигнахме', 'пристигнаха'], ['пристигнаха', 'пристигнахме', 'пристигнахте']],
        acceptableAnswers: [['пристигна'], ['пристигнахме'], ['пристигнахте'], ['пристигнаха']] },
      { text: 'Преди месец ти се срещна → той _____ / ние _____ / вие _____ / те _____.',
        blanks: [1, 2, 3, 4],
        correctAnswers: ['се срещна', 'се срещнахме', 'се срещнахте', 'се срещнаха'],
        options: [['се срещна', 'се срещнах', 'се срещнаха'], ['се срещнахме', 'се срещнахте', 'се срещнаха'], ['се срещнахте', 'се срещнахме', 'се срещнаха'], ['се срещнаха', 'се срещнахме', 'се срещнахте']],
        acceptableAnswers: [['се срещна', 'срещна се'], ['се срещнахме', 'срещнахме се'], ['се срещнахте', 'срещнахте се'], ['се срещнаха', 'срещнаха се']] },
      { text: 'Сутринта ти тръгна → той _____ / ние _____ / вие _____ / те _____.',
        blanks: [1, 2, 3, 4],
        correctAnswers: ['тръгна', 'тръгнахме', 'тръгнахте', 'тръгнаха'],
        options: [['тръгна', 'тръгнах', 'тръгнаха'], ['тръгнахме', 'тръгнахте', 'тръгнаха'], ['тръгнахте', 'тръгнахме', 'тръгнаха'], ['тръгнаха', 'тръгнахме', 'тръгнахте']],
        acceptableAnswers: [['тръгна'], ['тръгнахме'], ['тръгнахте'], ['тръгнаха']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 22 — Упр. 16 (стр. 64): сегашно → минало свършено ───────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 16',
    instruction: 'Трансформирайте глаголите от сегашно в минало свършено по модела.',
    order: 22,
    points: 4,
    layout: 'two-column',
    sentences: [
  ...
  // ─── ORDER 23 — ГРАМАТИКА 7 (стр. 64): станах — НАХ група ──────────────────
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 7',
    subtitle: 'Минало свършено — НАХ група',
    ...
    columns: ['(+)', '(−)', '(?)'],
    rows: [
      { pronoun: 'аз',        cells: ['станах',   'не станах',   'станах ли?'],   ttsText: 'аз. Станах. Не станах. Станах ли?' },
  ...
  // ─── ORDER 24 — Упр. 17 (стр. 65): попълнете НАХ форми ─────────────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 17',
    instruction: 'Попълнете празните места, като следвате модела. Модел: „Сутринта **станах** рано. (ставам)".',
    order: 24,
    points: 6,
    layout: 'single',
    sentences: [
  ...
  // ─── ORDER 27 — ГРАМАТИКА 8 (стр. 66): ЯХ група ────────────────────────────
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 8',
    subtitle: 'Минало свършено — ЯХ група',
    ...
    columns: ['(+)', '(−)', '(?)'],
    rows: [
      { pronoun: 'аз',        cells: ['видях',    'не видях',    'видях ли?'],    ttsText: 'аз. Видях. Не видях. Видях ли?' },
      ...
      { pronoun: 'ние',       cells: ['видяхме',  'не видяхме',  'видяхме ли?'],  ttsText: 'ние. Видяхме. Не видяхме. Видяхме ли?' },
  ...
  // ─── ORDER 28 — Упр. 22 (стр. 66): окончанията ─────────────────────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 22',
    instruction: 'Напишете глаголите в правилната форма на минало свършено (ЯХ група). Модел: „Снощи вечерях вкъщи. (вечерям)".',
    order: 28,
    points: 5,
    layout: 'single',
    sentences: [
      { text: 'Снощи **вечерях** вкъщи. (вечерям)',                                 blanks: [], correctAnswers: [], isExample: true },
      { text: 'Миналата година той _____ в Турция. (живея)',                         blanks: [1], correctAnswers: ['живя'],     options: ['живях', 'живя', 'живяха'],   acceptableAnswers: [['живя']] },
      ...
      { text: 'Вие _____ в тази къща преди 10 години. (живея)',                      blanks: [1], correctAnswers: ['живяхте'], options: ['живяхме', 'живяхте', 'живяха'], acceptableAnswers: [['живяхте']] },
      { text: 'Където _____ Лора и Марин снощи? (вечерям)',                          blanks: [1], correctAnswers: ['вечеряха'], options: ['вечерях', 'вечеряхме', 'вечеряха'], acceptableAnswers: [['вечеряха']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 29 — Упр. 23 (стр. 66): изберете правилната форма ───────────────
  {
    ...
    type: 'workbook_fill_blank',
    title: 'УПРАЖНЕНИЕ 23',
    instruction: 'Изберете правилната глаголна форма — сегашно или минало свършено. Модел: „Сега не те **виждам** / видя добре."',
    order: 29,
    points: 4,
    layout: 'single',
    sentences: [
      { text: 'Сега не те **виждам** / видя добре.',                                 blanks: [], correctAnswers: [], isExample: true },
      { text: 'Преди малко виждаме / _____ учителката.',                             blanks: [1], correctAnswers: ['видяхме'], options: ['виждаме', 'видяхме'], acceptableAnswers: [['видяхме']] },
      { text: 'Често _____ / видях Петър в супера.',                                 blanks: [1], correctAnswers: ['виждам'],  options: ['виждам', 'видях'],   acceptableAnswers: [['виждам']] },
      { text: 'Вчера _____ / видяхте ли новите колеги? (вие)',                       blanks: [1], correctAnswers: ['видяхте'], options: ['виждате', 'видяхте'], acceptableAnswers: [['видяхте']] },
      { text: 'Снощи тя не ме _____ / видя в метрото.',                              blanks: [1], correctAnswers: ['видя'],    options: ['вижда', 'видя'],     acceptableAnswers: [['видя']] },
    ],
  } as WorkbookFillBlankExercise,
  ...
  // ─── ORDER 30 — ДОП. Упр. 24 (стр. 66): попълнете с дадените глаголи ───────
  {
    id: 'a2-l06-ex-24',
    type: 'workbook_fill_blank',
    title: 'ДОПЪЛНИТЕЛНИ УПРАЖНЕНИЕ 24',
  ...
  // ─── ORDER 31 — Упр. 25 (стр. 66): съкращения ЧБМ/ЧНГ/ЧРД ─────────────────
  {
    ...
    type: 'dropdown_match',
    title: 'УПРАЖНЕНИЕ 25',
    instruction: 'Запомнете тези съкращения и изберете пълния поздрав. Модел: ЧБМ = Честита Баба Марта!',
    order: 31,
    points: 2,
    questions: [
  ...
  // ─── ORDER 32 — Упр. 26 (стр. 66): слушайте и попълнете ────────────────────
  {
    ...
    sentences: [
      {
        text: 'Вчера сутринта _____ (1) късно. _____ (2) неделя и не _____ (3) на работа. _____ (4) на майка ми в кухнята.',
        blanks: [1, 2, 3, 4],
      ...
      {
        text: 'На обяд _____ (1) на гости една приятелка. _____ (2) заедно супа, кюфтета и салата. _____ (3) и десерт.',
        blanks: [1, 2, 3],
      ...
      {
        text: 'Вечерта _____ (1) с колеги и _____ (2) в малка пицария. _____ (3) вкъщи около 11 часа и _____ (4) да спя.',
        blanks: [1, 2, 3, 4],
  ...
  // ─── ORDER 34 — Упр. 28 (стр. 67): въпроси за Коледа ──────────────────────
  {
    ...
    points: 5,
    questions: [
      { id: 'q1', left: 'Защо всички българи обичат коледните празници?', options: ['Защото в тях има много радост.', 'Защото получават подаръци.', 'Защото почиват три дни.', 'Защото ядат много.'], correctAnswer: 'Защото в тях има много радост.' },
  ...
  // ─── ORDER 38 — Упр. 33 (стр. 69): въпроси за 24 май (фактически) ──────────
  {
    ...
    points: 3,
    questions: [
      { id: 'q1', left: 'Какъв празник е 24 май?', options: ['Денят на българските букви, на пролетните цветя и на детските усмивки.', 'Националният ден на свободата.', 'Денят на жената.', 'Денят на православните светци.'], correctAnswer: 'Денят на българските букви, на пролетните цветя и на детските усмивки.' },
      { id: 'q2', left: 'Какво носят децата в училище на 24 май?', options: ['Цветя (букети).', 'Книги и тетрадки.', 'Подаръци за учителите.', 'Козунаци.'], correctAnswer: 'Цветя (букети).' },
      { id: 'q3', left: 'Какво правят учениците и учителите пред паметника на Кирил и Методий?', options: ['Пеят песни и слушат стихове.', 'Играят на хора.', 'Боядисват яйца.', 'Rozdávát мартеници.'], correctAnswer: 'Пеят песни и слушат стихове.' },
    ],
  } as DropdownMatchExercise,

  // ─── ORDER 39 — Упр. 33 (стр. 69): лични въпроси — разговаряйте ──────────
  // TODO: Оригиналните въпроси 4–6 са дискусионни (лични). Апроксимирани с personal_choice (0 т.).
  {
    id: 'a2-l06-ex-33b',
    type: 'personal_choice',
    title: 'УПРАЖНЕНИЕ 33 — Разговаряйте',
    instruction: 'Отговорете на личните въпроси. Споделете мнението си с партньора.',
    order: 39,
    points: 0,
    blankOptions: ['Да', 'Не'],
    items: [
      { id: 'q4', question: 'Какви други български празници знаете?', positiveTemplate: 'Знам: Да.', negativeTemplate: 'Не знам много: Не.', positiveBlank: 'Да', negativeBlank: 'Не' },
      { id: 'q5', question: 'Кой е любимият Ви български празник?', positiveTemplate: 'Имам любим: Да.', negativeTemplate: 'Нямам любим: Не.', positiveBlank: 'Да', negativeBlank: 'Не' },
      { id: 'q6', question: 'Кой празник обичахте най-много, когато бяхте дете?', positiveTemplate: 'Помня: Да.', negativeTemplate: 'Не помня: Не.', positiveBlank: 'Да', negativeBlank: 'Не' },
    ],
  } as PersonalChoiceExercise,

  // ─── ORDER 40 — Упр. 34 (стр. 69): стихотворение „На Кирил и Методий" ──────
  {
  ...
  // ─── ORDER 41 — ТЕКСТ Упр. 35 (стр. 70): Кирил и Методий ──────────────────
  {
  ...
  // ─── ORDER 42 — Упр. 36 (стр. 70): вярно или грешно ───────────────────────
  {
    id: 'a2-l06-ex-36',
    type: 'true_false',
    title: 'УПРАЖНЕНИЕ 36',
