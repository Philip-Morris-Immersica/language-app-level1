...
export const exercises: Exercise[] = [
  ...
  // ─── ORDER 3 — Именни дни в България (стр. 60): справочна таблица ──────────
  {
    ...
    rows: [
      ...
      { pronoun: 'Цветница (м. март / м. април)', cells: ['всички с имена на цветя'], ttsText: 'Цветница, през март или април. Всички с имена на цветя.' },
  ...
  // ─── ORDER 15 — Упр. 11 (стр. 63): има/имаше/няма/нямаше ──────────────────
  {
    ...
    sentences: [
      ...
      { text: 'В кащата _____ много стаи.',                                                   blanks: [1], correctAnswers: ['има'],     options: ['има', 'имаше', 'няма', 'нямаше'], acceptableAnswers: [['има']] },
  ...
  // ─── ORDER 32 — Упр. 26 (стр. 66): слушайте и попълнете ────────────────────
  {
    ...
    listeningText: 'Вчера сутринта станах късно. Беше неделя и не бях на работа. Помогнах на майка ми в кухнята. На обяд пристигна на гости една приятелка. Обядвахме заедно супа, кюфтета и салата. Имаше и десерт. Вечерта се срещнах с колеги и вечеряхме в малка пицария. Върнах се вкъщи около единадесет часа и легнах да спя.',
    sentences: [
      {
