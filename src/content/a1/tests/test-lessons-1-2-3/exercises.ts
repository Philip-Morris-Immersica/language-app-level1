...
export const writingExercises: Exercise[] = [
  {
    ...
    puzzles: [
      ...
      { id: 'p-kiselo-mlyako',  imageUrl: '/assets/test-a1-1/pisane/kiselo-mlyako.jpg',  syllables: ['мля', 'ко', 'ки', 'се', 'ло'],              correctWord: 'кисело мляко' },
      { id: 'p-kashkaval', imageUrl: '/assets/test-a1-1/pisane/kashkaval.jpg',     syllables: ['л', 'а', 'в', 'а', 'к', 'ш', 'а', 'к'],           correctWord: 'кашкавал' },
      { id: 'p-portokalov-sok', imageUrl: '/assets/test-a1-1/pisane/portokalov-sok.jpg', syllables: ['сок', 'лов', 'ка', 'то', 'пор'],             correctWord: 'портокалов сок' },
