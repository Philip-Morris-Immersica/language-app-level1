...
export const workbookExercises: Exercise[] = [
  ...
  // WB Exercise 3: Предлози за време (от/до/в/във/през/на/преди/след)
  {
    ...
    sentences: [
      {
        text: 'Модел: Работя **от** 9:00 **до** 17:30 ч.',
        blanks: [],
        correctAnswers: [],
        isExample: true,
      },
      {
        text: 'Той има рожден ден _______ 8 март.',
        blanks: [4],
        correctAnswers: ['на'],
        options: ['в', 'на', 'от', 'до', 'през', 'преди', 'след'],
      },
      {
        text: '_______ лятото е горещо.',
        blanks: [0],
        correctAnswers: ['През'],
        options: ['В', 'На', 'От', 'До', 'През', 'Преди', 'След'],
      },
      {
        text: '_______ зимата е студено.',
        blanks: [0],
        correctAnswers: ['През'],
        options: ['В', 'На', 'От', 'До', 'През', 'Преди', 'След'],
      },
      {
        text: 'Учим _______ вторник и в петък.',
        blanks: [1],
        correctAnswers: ['във'],
        acceptableAnswers: [['в']],
        options: ['в', 'на', 'от', 'до', 'през', 'преди', 'след', 'във'],
      },
      {
        text: 'Отивам на кино _______ работа.',
        blanks: [3],
        correctAnswers: ['след'],
        acceptableAnswers: [['преди']],
        options: ['в', 'на', 'от', 'до', 'през', 'преди', 'след'],
      },
      {
        text: 'Роден съм _______ 1998 година.',
        blanks: [2],
        correctAnswers: ['през'],
        options: ['в', 'на', 'от', 'до', 'през', 'преди', 'след'],
      },
  ...
  // WB Exercise 4: Свържете въпросите с правилните отговори
  {
    ...
    pairs: [
      ...
      { id: 'p04', left: 'Колко е часът?',           correctRight: '14:05' },
