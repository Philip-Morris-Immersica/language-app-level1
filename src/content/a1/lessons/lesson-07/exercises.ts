...
export const exercises: Exercise[] = [
  ...
  // 01 → ден; 02 → вечер; 03 → утро; 04 → нощ.
  {
    ...
    sectionStart: {
      ...
      titleI18n: {
        en: 'Greetings, days and months',
        fr: 'Salutations, jours et mois',
        ar: 'التحيات والأيام والأشهر',
        fa: 'سلام‌ها، روزها و ماه‌ها',
        uk: 'Вітання, дні та місяці',
        ru: 'Приветствия, дни и месяцы',
      },
      subtitleI18n: {
        en: 'Greetings for the day, the days of the week and the months of the year',
        fr: 'Les salutations de la journée, les jours de la semaine et les mois de l\'année',
        ar: 'تحيات اليوم، وأيام الأسبوع، وأشهر السنة',
        fa: 'سلام‌های روز، روزهای هفته و ماه‌های سال',
        uk: 'Вітання протягом дня, дні тижня та місяці року',
        ru: 'Приветствия дня, дни недели и месяцы года',
      },
      theme: 'vocabulary',
    },
    points: 4,
  ...
  // ORDER 9: ГРАМАТИКА 1 — Редни числителни 1–10
  {
    ...
    sectionStart: {
      ...
      titleI18n: {
        en: 'Ordinal numbers and dates',
        fr: 'Les nombres ordinaux et les dates',
        ar: 'الأعداد الترتيبية والتواريخ',
        fa: 'اعداد ترتیبی و تاریخ‌ها',
        uk: 'Порядкові числівники та дати',
        ru: 'Порядковые числительные и даты',
      },
      subtitleI18n: {
        en: 'Ordinal numbers from first to tenth and dialogues about days and dates',
        fr: 'Les nombres ordinaux du premier au dixième et des dialogues sur les jours et les dates',
        ar: 'الأعداد الترتيبية من الأول إلى العاشر وحوارات عن الأيام والتواريخ',
        fa: 'اعداد ترتیبی از اول تا دهم و گفتگوهایی درباره‌ی روزها و تاریخ‌ها',
        uk: 'Порядкові числівники від першого до десятого та діалоги про дні й дати',
        ru: 'Порядковые числительные от первого до десятого и диалоги о днях и датах',
      },
      theme: 'grammar',
    },
  ...
  // ORDER 13: НОВИ ДУМИ 4 — Какво е времето днес?
  {
    ...
    sectionStart: {
      ...
      titleI18n: {
        en: 'The weather and the seasons',
        fr: 'Le temps et les saisons',
        ar: 'الطقس والفصول',
        fa: 'آب‌وهوا و فصل‌ها',
        uk: 'Погода та пори року',
        ru: 'Погода и времена года',
      },
      subtitleI18n: {
        en: 'New words for the weather and the four seasons',
        fr: 'Nouveaux mots pour le temps et les quatre saisons',
        ar: 'كلمات جديدة عن الطقس والفصول الأربعة',
        fa: 'کلمات جدید برای آب‌وهوا و چهار فصل',
        uk: 'Нові слова для погоди та чотирьох пір року',
        ru: 'Новые слова для погоды и четырёх времён года',
      },
      theme: 'vocabulary',
    },
    type: 'illustrated_cards',
  ...
  // На екрана: като учебник (= и /). За TTS: `ttsText` с точки за паузи където е зададено.
  {
    ...
    sectionStart: {
      ...
      titleI18n: {
        en: 'The time and the parts of the day',
        fr: 'L\'heure et les moments de la journée',
        ar: 'الساعة وأجزاء اليوم',
        fa: 'ساعت و بخش‌های شبانه‌روز',
        uk: 'Час та частини доби',
        ru: 'Время и части суток',
      },
      subtitleI18n: {
        en: 'What time is it and the parts of the day',
        fr: 'Quelle heure est-il et les moments de la journée',
        ar: 'كم الساعة وأجزاء اليوم',
        fa: 'ساعت چند است و بخش‌های شبانه‌روز',
        uk: 'Котра година та частини доби',
        ru: 'Который час и части суток',
      },
      theme: 'grammar',
    },
    type: 'grammar_examples',
  ...
  // Часовете-примери: зелено инфо-боксче под картите; всеки ред с отделно аудио по клик.
  {
    ...
    grammarHighlight: {
      ...
      exampleTtsTexts: [
        ...
        'Три часът следобед.', // "часа" в точен час без минути се изяжда от Flash — "часът" го произнася правилно
        'Осем часа вечерта.',
  ...
  // ORDER 32: НОВИ ДУМИ 6 — Посоки на света
  {
    ...
    sectionStart: {
      ...
      titleI18n: {
        en: 'Directions, travels and holidays',
        fr: 'Directions, voyages et fêtes',
        ar: 'الاتجاهات والأسفار والأعياد',
        fa: 'جهت‌ها، سفرها و جشن‌ها',
        uk: 'Напрямки, подорожі та свята',
        ru: 'Направления, путешествия и праздники',
      },
      subtitleI18n: {
        en: 'New words for directions, travel and holidays',
        fr: 'Nouveaux mots pour les directions, les voyages et les fêtes',
        ar: 'كلمات جديدة عن الاتجاهات والسفر والأعياد',
        fa: 'کلمات جدید برای جهت‌ها، سفر و جشن‌ها',
        uk: 'Нові слова для напрямків, подорожей та свят',
        ru: 'Новые слова для направлений, путешествий и праздников',
      },
      theme: 'vocabulary',
    },
    type: 'illustrated_cards',
  ...
  // ORDER 36: ГРАМАТИКА 7 — Глагол ОТИВАМ (вмъкнато по обратна връзка от клиента)
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 7',
    instruction: 'Запознайте се със спрежението на глагола **отивам**. Натиснете върху ред за произношение.',
    order: 36,
    tableTitle: 'ОТИВАМ',
    columns: ['Форма'],
    rows: [
  ...
  // ORDER 42: Упр. 34 — Прочетете текста (Ибрахим)
  {
    ...
    sectionStart: {
      ...
      titleI18n: {
        ...
        ar: 'نص للقراءة',
        fa: 'متن خواندنی',
        uk: 'Текст для читання',
        ru: 'Текст для чтения',
      },
      subtitleI18n: {
        en: 'Texts about the weather and everyday life',
        fr: 'Textes sur le temps et la vie quotidienne',
        ar: 'نصوص عن الطقس والحياة اليومية',
        fa: 'متن‌هایی درباره‌ی آب‌وهوا و زندگی روزمره',
        uk: 'Тексти про погоду та повсякденне життя',
        ru: 'Тексты о погоде и повседневной жизни',
      },
      theme: 'reading',
    },
    type: 'reading_text',
