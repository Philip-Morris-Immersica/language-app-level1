...
export const workbookExercises: Exercise[] = [
  ...
  // Exercise 4: Question forms of съм (?) + answers — qa-split layout
  {
    ...
    sentences: [
      ...
      {
        text: 'Ти алжирец _______ ? | Да, аз _______ алжирец.',
        blanks: [1, 2],
        correctAnswers: ['ли си', 'съм'],
        options: [
          ['ли съм', 'ли си', 'ли е', 'ли сме', 'ли сте', 'ли са'],
          ['съм', 'си', 'е', 'сме', 'сте', 'са'],
        ],
      },
      {
        text: 'То от София _______ ? | Не, не _______ от София.',
        blanks: [1, 2],
        correctAnswers: ['ли е', 'е'],
        options: [
          ['ли съм', 'ли си', 'ли е', 'ли сме', 'ли сте', 'ли са'],
          ['съм', 'си', 'е', 'сме', 'сте', 'са'],
        ],
      ...
      {
        text: 'Те иракчани _______ ? | Не, не _______ иракчани.',
        blanks: [1, 2],
        correctAnswers: ['ли са', 'са'],
        options: [
          ['ли съм', 'ли си', 'ли е', 'ли сме', 'ли сте', 'ли са'],
          ['съм', 'си', 'е', 'сме', 'сте', 'са'],
        ],
      ...
      {
        text: 'Аз учителка _______ ? | Да, аз _______ учителка.',
        blanks: [1, 2],
        correctAnswers: ['ли съм', 'съм'],
        options: [
          ['ли съм', 'ли си', 'ли е', 'ли сме', 'ли сте', 'ли са'],
          ['съм', 'си', 'е', 'сме', 'сте', 'са'],
        ],
