...
export const exercises: Exercise[] = [
  ...
  // ORDER 1: Упражнение 1 – Напишете думите под картинките
  {
    ...
    sectionStart: {
      ...
      subtitleI18n: {
        en: 'New words for food and drinks and exercises with the question „Какво е това?" (What is this?)',
        fr: 'Nouveaux mots pour les aliments et boissons et exercices avec la question « Какво е това ? » (Qu\'est-ce que c\'est ?)',
        ar: 'كلمات جديدة عن الطعام والمشروبات وتمارين مع سؤال «Какво е това?» (ما هذا؟)',
        fa: 'کلمات جدید درباره‌ی غذا و نوشیدنی و تمرین‌هایی با پرسش «Какво е това?» (این چیست؟)',
        uk: 'Нові слова про їжу та напої і вправи з питанням „Какво е това?" (Що це?)',
        ru: 'Новые слова о еде и напитках и упражнения с вопросом „Какво е това?" (Что это?)',
      },
      theme: 'vocabulary',
    },
    points: 4,
  ...
  // ORDER 7: ГРАМАТИКА 2 – Обичам / не обичам (NOT AN EXERCISE!)
  {
    ...
    sectionStart: {
      ...
      titleI18n: {
        en: 'The verbs „обичам" (to love) and „искам" (to want)',
        fr: 'Les verbes « обичам » (aimer) et « искам » (vouloir)',
        ar: 'الفعلان «обичам» (أحبّ) و«искам» (أريد)',
        fa: 'فعل‌های «обичам» (دوست داشتن) و «искам» (خواستن)',
        uk: 'Дієслова „обичам" (любити) і „искам" (хотіти)',
        ru: 'Глаголы „обичам" (любить) и „искам" (хотеть)',
      },
      subtitleI18n: {
        en: 'Expressing preferences, the prepositions „с" (with) and „без" (without), and dialogues',
        fr: 'Exprimer ses préférences, les prépositions « с » (avec) et « без » (sans), et dialogues',
        ar: 'التعبير عن التفضيلات، وحرفا الجر «с» (مع) و«без» (بدون)، وحوارات',
        fa: 'بیان ترجیحات، حروف اضافه‌ی «с» (با) و «без» (بدون)، و گفتگوها',
        uk: 'Вираження вподобань, прийменники „с" (з) і „без" (без) та діалоги',
        ru: 'Выражение предпочтений, предлоги „с" (с) и „без" (без) и диалоги',
      },
      theme: 'grammar',
    },
  ...
  // ORDER 23: ГРАМАТИКА 5 – Има / Няма
  {
    ...
    order: 23,
    sectionStart: {
      title: 'Има/няма и родът на съществителните',
      subtitle: 'Глаголът „има/няма" и родовите форми един, една, едно',
      titleI18n: {
        en: '„Има/няма" (there is / there isn\'t) and the gender of nouns',
        fr: '« Има/няма » (il y a / il n\'y a pas) et le genre des noms',
        ar: '«Има/няма» (يوجد / لا يوجد) وجنس الأسماء',
        fa: '«Има/няма» (هست / نیست) و جنس اسم‌ها',
        uk: '„Има/няма" (є / немає) і рід іменників',
        ru: '„Има/няма" (есть / нет) и род существительных',
      },
      subtitleI18n: {
        en: 'The verb „има/няма" (there is / there isn\'t) and the gender forms „един", „една", „едно" (one)',
        fr: 'Le verbe « има/няма » (il y a / il n\'y a pas) et les formes de genre « един », « една », « едно » (un)',
        ar: 'الفعل «има/няма» (يوجد / لا يوجد) وصيغ الجنس «един»، «една»، «едно» (واحد)',
        fa: 'فعل «има/няма» (هست / نیست) و صورت‌های جنسیتی «един»، «една»، «едно» (یک)',
        uk: 'Дієслово „има/няма" (є / немає) і родові форми „един", „една", „едно" (один)',
        ru: 'Глагол „има/няма" (есть / нет) и родовые формы „един", „една", „едно" (один)',
      },
      theme: 'grammar',
    },
    examples: [
  ...
  // ORDER 29: ГРАМАТИКА 7 – Бройни числителни 0–10
  {
    ...
    sectionStart: {
      ...
      titleI18n: {
        en: 'Numbers 0–10',
        fr: 'Les nombres 0–10',
        ar: 'الأعداد من 0 إلى 10',
        fa: 'اعداد ۰ تا ۱۰',
        uk: 'Числа 0–10',
        ru: 'Числа 0–10',
      },
      subtitleI18n: {
        en: 'Cardinal numbers and counting exercises',
        fr: 'Les nombres cardinaux et exercices de comptage',
        ar: 'الأعداد الأصلية وتمارين العدّ',
        fa: 'اعداد اصلی و تمرین‌های شمارش',
        uk: 'Кількісні числівники та вправи на лічбу',
        ru: 'Количественные числительные и упражнения на счёт',
      },
      theme: 'vocabulary',
    },
    cards: [
  ...
  // ORDER 30: Упражнение 20 – Свържете точките
  {
    ...
    type: 'connect_dots',
    title: 'УПРАЖНЕНИЕ 20',
    instructionKey: 'exercise.l02.ex20.instruction',
    instruction: 'Натиснете числата в нарастващ ред, от 0 до 11.',
    order: 30,
    points: 12,
    // Labels show digits (not the Bulgarian words) so they fit the dots cleanly —
    // the audio on tap still pronounces the full word (нула, едно, две…), which is
    // what actually teaches the vocabulary.
    dots: [
      { id: 'd0',  label: '0',  position: 0,  audioUrl: '/assets/lesson-02/audio/tts/words/n0.mp3'  },
      { id: 'd1',  label: '1',  position: 1,  audioUrl: '/assets/lesson-02/audio/tts/words/n1.mp3'  },
      { id: 'd2',  label: '2',  position: 2,  audioUrl: '/assets/lesson-02/audio/tts/words/n2.mp3'  },
      { id: 'd3',  label: '3',  position: 3,  audioUrl: '/assets/lesson-02/audio/tts/words/n3.mp3'  },
      { id: 'd4',  label: '4',  position: 4,  audioUrl: '/assets/lesson-02/audio/tts/words/n4.mp3'  },
      { id: 'd5',  label: '5',  position: 5,  audioUrl: '/assets/lesson-02/audio/tts/words/n5.mp3'  },
      { id: 'd6',  label: '6',  position: 6,  audioUrl: '/assets/lesson-02/audio/tts/words/n6.mp3'  },
      { id: 'd7',  label: '7',  position: 7,  audioUrl: '/assets/lesson-02/audio/tts/words/n7.mp3'  },
      { id: 'd8',  label: '8',  position: 8,  audioUrl: '/assets/lesson-02/audio/tts/words/n8.mp3'  },
      { id: 'd9',  label: '9',  position: 9,  audioUrl: '/assets/lesson-02/audio/tts/words/n9.mp3'  },
      { id: 'd10', label: '10', position: 10, audioUrl: '/assets/lesson-02/audio/tts/words/n10.mp3' },
      { id: 'd11', label: '11', position: 11, audioUrl: '/assets/lesson-02/audio/tts/words/n11.mp3' },
    ],
  ...
  // ORDER 33: Упражнение 23 – Оградете излишната дума
  {
    ...
    sectionStart: {
      ...
      subtitleI18n: {
        en: 'Reinforcement exercises, dialogues and reading texts',
        fr: 'Exercices de consolidation, dialogues et textes de lecture',
        ar: 'تمارين للترسيخ وحوارات ونصوص للقراءة',
        fa: 'تمرین‌های تثبیت، گفتگوها و متن‌های خواندنی',
        uk: 'Вправи на закріплення, діалоги та тексти для читання',
        ru: 'Упражнения на закрепление, диалоги и тексты для чтения',
      },
      theme: 'reading',
    },
    points: 4,
