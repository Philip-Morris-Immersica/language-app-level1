...
export const exercises: Exercise[] = [
...

  {
    id: 'l05-ex-02',
    type: 'dropdown_match',
    instruction: 'За всяка снимка изберете правилната дума.',
    order: 3,
    points: 12,
    questions: [
...

  {
    ...
    type: 'true_false',
    title: 'УПРАЖНЕНИЕ 5',
    instruction: 'Разгледайте картата. Кои от следните места ги има на нея?',
    order: 7,
...

  {
    id: 'l05-ex-18',
    type: 'true_false',
    instruction: 'Разгледайте картата и отбележете с „Вярно" или „Грешно".',
    order: 24,
    imageUrl: '/assets/lesson-05/03-upr-02-karta-grad/02-karta-grad-centar-s-nadpisi.jpg',
    points: 9,
    sentences: [
...

  {
    ...
    type: 'workbook_fill_blank',
    instruction:
      'Разгледайте картата и отговорете на въпросите.',
    order: 25,
    points: 6,
    layout: 'qa-split',
    imageUrl: '/assets/lesson-05/05-upr-03-karta-selo/02-karta-selo-centar-s-nadpisi.jpg',
    sentences: [
      {
