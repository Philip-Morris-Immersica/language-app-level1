...
Урокът включва нови думи за храни и напитки, граматика за Е-група глаголи и множествено число на съществителните, диалози от ресторанта и упражнения за практика.`,
  ...
  vocabulary: [
    ...
    { id: 'blagodarya', bulgarian: 'Благодаря!', translations: { en: 'Thank you!', fr: 'Merci !', ar: 'شكرًا!', fa: 'ممنون!', ru: 'Спасибо!', uk: 'Дякую!' }, ttsPrompt: 'Произнеси без ударение, плавно.' },
    ...
    { id: 'prav', bulgarian: 'прав, права', translations: { en: 'right, correct', fr: 'juste, correct(e)', ar: 'محق، على صواب', fa: 'درست، حق به جانب', ru: 'прав (м.р.), права (ж.р.)', uk: 'правий (ч.р.), права (ж.р.)' }, ttsPrompt: 'ударение на първата сричка: пРав, прАва' },
    { id: 'priyatno-prekazvane', bulgarian: 'Приятно прекарване!', translations: { en: 'Have a nice time!', fr: 'Bonne continuation !', ar: 'أتمنى لك وقتًا ممتعًا!', fa: 'خوش بگذرد!', ru: 'Приятного отдыха!', uk: 'Приємного відпочинку!' } },
    ...
    { id: 'udobno', bulgarian: 'удобно', translations: { en: 'comfortable, convenient', fr: 'confortable, commode', ar: 'مريح، ملائم', fa: 'راحت، مناسب', ru: 'удобно', uk: 'зручно' }, ttsPrompt: 'ударение на втора сричка: у-ДО-бно' },
  ...
  culturalNotes: [
    ...
    },
    {
      ...
      content: {
        bg: 'Най-популярната българска салата е шопската салата — смес от домати, краставици, лук, сурови или печени чушки и бяло сирене. Традиционно се подправя само със сол, слънчогледово олио или зехтин и оцет.',
    ...
    },
    {
      ...
      content: {
        bg: 'Българската парична единица е еврото, което замени левът от 1 януари 2026 г. Магазините и другите бизнеси в България обикновено не приемат чуждестранна валута. В големите градове кредитните карти се приемат навсякъде, а в селските райони хората плащат основно в брой.',
        en: 'The Bulgarian unit of currency is the euro, which replaced the lev on 1 January 2026. Shopkeepers and other businesses in Bulgaria will usually not accept foreign money. In major cities, credit cards are generally accepted; in rural areas people pay mainly in cash.',
        fr: "L'unité monétaire bulgare est l'euro, qui a remplacé le lev le 1er janvier 2026. Les commerçants et autres entreprises en Bulgarie n'acceptent généralement pas la monnaie étrangère. Dans les grandes villes, les cartes de crédit sont généralement acceptées ; dans les zones rurales, on paie principalement en espèces.",
        ar: 'الوحدة النقدية البلغارية هي اليورو، الذي حل محل الليف في الأول من يناير 2026. لا يقبل أصحاب المحلات والشركات في بلغاريا عادةً العملات الأجنبية. في المدن الكبرى تُقبل بطاقات الائتمان بشكل عام، بينما في المناطق الريفية يدفع الناس نقداً في الغالب.',
        fa: 'واحد پول بلغارستان یورو است که از اول ژانویه ۲۰۲۶ جایگزین لو شد. مغازه\u200Cداران و سایر کسب\u200Cوکارها در بلغارستان معمولاً پول خارجی قبول نمی\u200Cکنند. در شهرهای بزرگ کارت\u200Cهای اعتباری عموماً پذیرفته می\u200Cشوند؛ در مناطق روستایی مردم بیشتر نقدی پرداخت می\u200Cکنند.',
        ru: 'Денежная единица Болгарии — евро, которое заменило лев с 1 января 2026 года. Магазины и другие предприятия в Болгарии обычно не принимают иностранную валюту. В крупных городах кредитные карты принимаются повсеместно, а в сельской местности платят преимущественно наличными.',
        uk: 'Грошова одиниця Болгарії — євро, яке замінило лев з 1 січня 2026 року. Магазини та інші підприємства в Болгарії зазвичай не приймають іноземну валюту. У великих містах кредитні картки приймають повсюдно, а в сільській місцевості платять переважно готівкою.',
      },
    },
  ],
...
Бройна форма (мъжки род, неодушевени) — след числа, КОЛКО, НЯКОЛКО: +А/-Я
  два лева, три лева, пет лева
  колко лева?, няколко стола, десет сока

Специални форми за мъже (2–4): -(И)МА
  двама студенти, трима лекари, четирима мъже
  (Тези форми се използват само за мъжки род — хора.)

Примери:
  Имам двадесет лева.
  Колко струва? — Петнадесет лева.
  Тук има трима лекари и двама студенти.
  Дайте ми три сока, ако обичате.`,
...
Count plural (masculine, non-persons) — masculine nouns that do not refer to people have a special plural form used after cardinal numbers, КОЛКО and НЯКОЛКО:
  два лева, колко лева, няколко стола
  (+А after consonant: сандвич → сандвича; -Й → -Я: чай → чая)

Special forms for male persons (2–4): -(И)МА
  двама студенти (two male students), трима лекари (three male doctors), четирима мъже (four men)
  (Used only with masculine nouns referring to people.)

Examples in context:
  Имам двадесет лева. (I have twenty leva.)
  Колко струва? — Петнадесет лева. (How much is it? — Fifteen leva.)
  Тук има трима лекари и двама студенти. (There are three doctors and two students here.)
  Дайте ми три сока, ако обичате. (Three juices please.)`,
...
Forme cardinale (masculin, non-personnes) — après les nombres, КОЛКО, НЯКОЛКО : +А/-Я
  два лева, три лева, пет лева
  колко лева ?, няколко стола, десет сока

Formes spéciales pour les personnes de genre masculin (2–4) : -(И)МА
  двама студенти (deux étudiants)
  трима лекари (trois médecins)
  четирима мъже (quatre hommes)
  (Utilisé uniquement avec des noms masculins désignant des personnes.)

Exemples :
  Имам двадесет лева. (J'ai vingt leva.)
  Колко струва? — Петнадесет лева. (Combien ça coûte ? — Quinze leva.)
  Тук има трима лекари и двама студенти. (Il y a trois médecins et deux étudiants ici.)
  Дайте ми три сока, ако обичате. (Trois jus, s'il vous plaît.)`,
...
صيغة العَدّ (مذكر، غير أشخاص) — الأسماء المذكرة الدالة على غير الأشخاص لها صيغة جمع خاصة تسمى صيغة العَدّ، وتُستخدم مع أسماء الأعداد وКОЛКО وНЯКОЛКО:
  два лева، колко лева، няколко стола
  (يُضاف +А بعد الحرف الصامت: сандвич → сандвича؛ ويُستبدل -Й بـ -Я: чай → чая)

أسماء الأعداد اثنان وثلاثة وأربعة لها صيغة خاصة تنتهي بـ -(И)МА، وتُستخدم مع أسماء مذكرة تدل على أشخاص فقط:
  двама студенти (طالبان)، трима лекари (ثلاثة أطباء)، четирима мъже (أربعة رجال)

أمثلة:
  Имам двадесет лева. (معي عشرون ليف.)
  Колко струва? — Петнадесет лева. (كم سعره؟ — خمسة عشر ليف.)
  Тук има трима лекари и двама студенти. (هناك ثلاثة أطباء وطالبان هنا.)
  Дайте ми три сока, ако обичате. (ثلاثة عصائر من فضلك.)`,
...
فرم شمارشی (مذکر، غیر افراد) — اسامی مذکر برای جمع بستن (غیر افراد) حالت مخصوصی دارند که به آن فرم شمارشی می گوییم. بعد از قید مقدار КОЛКО و НЯКОЛКО استفاده می شوند:
  два лева، колко лева، няколко стола
  (+А بعد از حرف بی‌صدا: сандвич → сандвича؛ -Й → -Я: чай → чая)

اعداد شمارشی از دو تا چهار، فرم مخصوصی دارند که به -(И)МА ختم می‌شوند. این حالت‌ها فقط برای اسم‌های مذکر در مورد افراد به‌کار برده می‌شوند:
  двама студенти (دو دانشجو)، трима лекари (سه پزشک)، четирима мъже (چهار مرد)

مثال‌ها:
  Имам двадесет лева. (بیست لِوا دارم.)
  Колко струва? — Петнадесет лева. (چقدر می‌شود؟ — پانزده لِوا.)
  Тук има трима лекари и двама студенти. (اینجا سه دکتر و دو دانشجو هستند.)
  Дайте ми три сока, ако обичате. (سه آبمیوه لطفاً.)`,
...
Счётная форма (мужской род, неодушевлённые) — после числительных, КОЛКО, НЯКОЛКО: +А/-Я
  два лева, три лева, пет лева
  колко лева?, няколко стола, десет сока

Особые формы для лиц мужского пола (2–4): -(И)МА
  двама студенти (двое студентов-мужчин)
  трима лекари (трое врачей-мужчин)
  четирима мъже (четверо мужчин)
  (Используются только с существительными мужского рода, обозначающими людей.)

Примеры:
  Имам двадесет лева. (У меня двадцать левов.)
  Колко струва? — Петнадесет лева. (Сколько стоит? — Пятнадцать левов.)
  Тук има трима лекари и двама студенти. (Здесь три врача и двое студентов.)
  Дайте ми три сока, ако обичате. (Три сока, пожалуйста.)`,
...
Особливі форми для осіб чоловічого роду (2–4): -(И)МА
  двама студенти (двоє студентів-чоловіків)
  трима лекари (троє лікарів-чоловіків)
  четирима мъже (четверо чоловіків)
  (Вживаються лише з іменниками чоловічого роду на позначення людей.)

Приклади:
  Имам двадесет лева. (У мене двадцять левів.)
  Колко струва? — Петнадесет лева. (Скільки коштує? — П'ятнадцять левів.)
  Тук има трима лекари и двама студенти. (Тут троє лікарів і двоє студентів.)
  Дайте ми три сока, ако обичате. (Три соки, будь ласка.)`,
      },
    },
    {
      id: 'e-group-verbs',
...
Глагол ЯМ (to eat) — изключение, неправилен:
  ...
  (?) ям ли?, ядеш ли?, яде ли?, ядем ли?, ядете ли?, ядат ли?

ЯМ е стар неправилен глагол — основата му се мени от „я-" (1 л. ед.ч.) на „яд-" в останалите форми, за разлика от правилните Е-глаголи.
...
ЯМ is an ancient irregular verb. Its stem changes from я- (1st person sg.) to яд- in all other forms — unlike regular E-group verbs which keep the same stem throughout.
...
ЯМ est un verbe ancien irrégulier : son radical change de « я- » (1ère pers. sg.) à « яд- » dans toutes les autres formes, contrairement aux verbes réguliers du groupe E.
...
الفعل ЯМ (آكل) — استثناء، غير منتظم:
  (+) аз ям، ти ядеш، той/тя/то яде، ние ядем، вие ядете، те ядат
  (–) не ям، не ядеш، не яде، не ядем، не ядете، не ядат
  (?) ям ли؟، ядеш ли؟، яде ли؟، ядем ли؟، ядете ли؟، ядат ли؟

ЯМ فعل قديم غير منتظم — جذره يتغير من «я-» في صيغة المتكلم المفرد إلى «яд-» في جميع الصيغ الأخرى، على عكس أفعال مجموعة E المنتظمة.
...
ЯМ یک فعل نامنظم قدیمی است — ریشه آن از «я-» (اول شخص مفرد) به «яд-» در سایر اشکال تغییر می‌کند، برخلاف افعال منظم گروه E.
...
ЯМ — старый неправильный глагол: его основа меняется с «я-» (1-е лицо ед.ч.) на «яд-» во всех остальных формах, в отличие от правильных глаголов Е-группы.
...
ЯМ — стародавнє неправильне дієслово: його основа змінюється з «я-» (1-ша особа однини) на «яд-» в усіх інших формах, на відміну від правильних дієслів Е-групи.
