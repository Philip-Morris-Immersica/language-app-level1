...
export const exercises: Exercise[] = [
  ...
  // TODO: Needs crossword component or food/drink images
  {
    ...
    hiddenWords: ['КРОАСАН', 'ВОДА', 'СОК', 'ЧАЙ', 'МЕД', 'ЯЙЦЕ', 'БАНИЦА', 'ХЛЯБ'],
  ...
  // ORDER 6: НОВИ ДУМИ 2 – Пари (Page 26)
  {
    ...
    title: 'НОВИ ДУМИ 2',
    instruction: '',
    subtitle: '1 € = едно евро · 2 € = две евро\n1 ¢ = един евроцент · 2 ¢ = два евроцента\n\n0,50 € = петдесет евроцента · 5,50 € = пет евро и петдесет евроцента (пет и петдесет)\n0,51 € = петдесет и един евроцента · 51,00 € = петдесет и едно евро',
    order: 6,
    cards: [
      ...
      { id: '20-cent',   imageUrl: '/assets/lesson-03/novi-dumi-2-currency/20-cent.png',  label: 'двадесет евроцента', ttsLabel: 'двадесет евро цента' },
  ...
  // ORDER 13: Упр. 11 – Открийте скритите думи (Page 27)
  {
    id: 'l03-ex-11',
    type: 'word_search',
    instruction: 'Открийте скритите думи в таблицата.',
    order: 13,
    points: 6,
    ...
    hiddenWords: ['МАКАРОНИ', 'КЮФТЕ', 'САЛАТА', 'СУПА', 'КЕБАПЧЕ', 'ДЕСЕРТ'],
  } as WordSearchExercise,
  ...
  // ORDER 16: ГРАМАТИКА 2а – Сегашно време Е група: пия (Page 28)
  {
    ...
    rows: [
      ...
      { pronoun: 'вие/Вие',      cells: ['пиете', 'не пиете', 'пиете ли'] },
  ...
  // ORDER 17: ГРАМАТИКА 2б – Сегашно време Е група: ям (Page 28)
  {
    ...
    type: 'grammar_table',
    title: 'ГРАМАТИКА 2',
    instruction: 'Запознайте се с глагола ЯМ в сегашно време.',
    order: 17,
    ...
    rows: [
      ...
      { pronoun: 'вие/Вие',      cells: ['ядете', 'не ядете', 'ядете ли'] },
  ...
  // TODO: Needs food images for each answer (супа, мусака, вода, шишче, сладолед)
  {
    id: 'l03-ex-23',
    type: 'dropdown_match',
    instruction: 'Отговорете на въпросите по модела.',
    order: 25,
    points: 5,
    questions: [
      { id: 'model', left: 'Какво искате за закуска?', options: [], correctAnswer: 'За закуска искам филия с масло.', isExample: true },
  ...
  // ORDER 33: Упр. 31 – ТЕКСТОВЕ (Page 33)
  {
    ...
    images: [
      { ttsWordId: 'tarator', imageUrl: '/assets/lesson-03/tekstove/tarator.png', label: 'таратор' },
      { ttsWordId: 'shopska-salata', imageUrl: '/assets/lesson-03/tekstove/shopska-salata.png', label: 'шопска салата' },
      { ttsWordId: 'humus', imageUrl: '/assets/lesson-03/tekstove/humus.png', label: 'хумус' },
      { ttsWordId: 'sarmi', imageUrl: '/assets/lesson-03/tekstove/sarmi.png', label: 'сарми' },
      { ttsWordId: 'agneshko-s-oriz', imageUrl: '/assets/lesson-03/tekstove/agnesko-s-oriz.png', label: 'агнешко с ориз' },
      { ttsWordId: 'kyufte', imageUrl: '/assets/lesson-03/tekstove/kyufte.png', label: 'кюфте' },
      { ttsWordId: 'baklava', imageUrl: '/assets/lesson-03/tekstove/baklava.png', label: 'баклава' },
      { ttsWordId: 'banitsa', imageUrl: '/assets/lesson-03/tekstove/banitsa.png', label: 'баница' },
      { ttsWordId: 'krem-karamel', imageUrl: '/assets/lesson-03/tekstove/krem-karamel.png', label: 'крем карамел' },
    ],
    paragraphs: [
  ...
  // ORDER 34: Упр. 32 – Вярно или грешно? (Page 33)
  {
    id: 'l03-ex-32',
    type: 'true_false',
    instruction: 'На база на текстовете по-горе, определете дали твърденията са верни (✓) или неверни (✗).',
    order: 34,
    points: 6,
    sentences: [
