...
export const content: LessonContent = {
  introduction: `Добре дошли! В този уводен урок ще се запознаете с българската азбука — кирилицата. Ще научите 30-те букви, ще се упражните да ги разпознавате и ще направите първите си стъпки в четенето и писането на български.
