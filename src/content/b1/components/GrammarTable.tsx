...
/**
 * Parses inline `**bold**` markdown, e.g. „плащ**ах**" → „плащ" + bold „ах".
 * The shared `GrammarTable.tsx` doesn't do this (prints literal asterisks) —
 * see the type-conversion note on gramatika-05 in b1-lesson-04/exercises.ts.
 */
              ...
              return (
                <React.Fragment key={rIdx}>
                  <tr
                    ...
                    className={`${disableAudio ? '' : 'cursor-pointer hover:bg-[#edf5e4]'} transition-colors ${rIdx % 2 === 0 ? 'bg-white' : 'bg-[#f4faee]'}`}
                  >
