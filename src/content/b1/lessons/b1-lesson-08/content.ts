...
const BG_VOCAB_NATIVE =
  'Speak like a native Bulgarian from Sofia — hard consonants, clear Bulgarian vowels. NEVER Russian accent (no soft Russian л/щ/ж, no Russian vowel reduction). Capitals mark stress only; do not spell them out. Declarative word list, falling intonation — never a question.';
...
export const content: LessonContent = {
  introduction: `Калоян имаше дълъг списък със задачи за четвъртък, но когато вечерта прегледа деня си, оказа се, че много от тях не се осъществиха. В този урок ще учите как да говорите за такива нереализирани планове — с формите щях да..., нямаше да... и щеше ли да...? След това ще чуете и за пътувания, които не се състояха, и за една мечта: какво бихте направили с един милион.`,
  ...
  vocabulary: [
    { id: 'v-sravnenie-s', bulgarian: 'в сравнение с', ttsText: TTS_V_SRAVNENIE_S_TEXT, ttsModel: 'flash', translations: { en: 'compared with', fr: 'comparé à', ar: 'مقارنةً بـ', fa: 'در مقایسه با', ru: 'по сравнению с', uk: 'у порівнянні з' } },
    { id: 'dokolko-znam', bulgarian: 'доколкото знам', ttsText: 'доколкото знам', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Read verbatim: доколкото знам. Final word знам — zna-M, M like in дом. NEVER зман, NEVER знау, NEVER дополкото.`, translations: { en: 'as far as I know', fr: 'autant que je sache', ar: 'على حد علمي', fa: 'تا جایی که می‌دانم', ru: 'насколько я знаю', uk: 'наскільки я знаю' } },
    ...
    { id: 'izbor', bulgarian: 'избор', ttsText: 'избор.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Single noun избор — flat declarative statement, falling intonation at the end. NOT a question — no rising tone, no interrogative melody.`, translations: { en: 'choice', fr: 'choix', ar: 'اختيار', fa: 'انتخاب', ru: 'выбор', uk: 'вибір' } },
    ...
    { id: 'lift', bulgarian: 'лифт, -ове', ttsText: 'лифт. лифтове.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Plural лифтове: lif-TO-ve — clear TO syllable with stress, every vowel audible.`, translations: { en: 'ski lift, -s', fr: 'téléski, -s', ar: 'مصعد تزلج', fa: 'تله‌کابین', ru: 'подъёмник', uk: 'підйомник' } },
    ...
    { id: 'napalno', bulgarian: 'напълно', ttsText: 'напълно.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} na-PUL-no — P as in пълен, clear П syllable, NEVER натълно / na-TUL-no.`, translations: { en: 'completely', fr: 'complètement', ar: 'تمامًا', fa: 'کاملاً', ru: 'полностью', uk: 'повністю' } },
    ...
    { id: 'ot-druga-strana', bulgarian: 'от друга страна', ttsText: 'от друга страна', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Read verbatim: от друга страна. Final word страна — stra-NA, ends in -A. NEVER странам, NEVER -AM ending. Declarative, NOT question.`, translations: { en: 'on the other hand', fr: 'd\'autre part', ar: 'من ناحية أخرى', fa: 'از طرف دیگر', ru: 'с другой стороны', uk: 'з іншого боку' } },
    { id: 'ot-edna-strana', bulgarian: 'от една страна', ttsText: 'от една страна', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Read verbatim: от една страна. Clear crisp vowels — страна: stra-NA with audible -NA, no muffled/fuzzy speech. Declarative, NOT question.`, translations: { en: 'on the one hand', fr: 'd\'une part', ar: 'من ناحية', fa: 'از یک طرف', ru: 'с одной стороны', uk: 'з одного боку' } },
    ...
    { id: 'planiram', bulgarian: 'планирам, -аш', ttsText: 'планирам. планираш.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} pla-ni-RAM, pla-ni-RASH — hard Bulgarian Р, clear А vowels, standard Sofia Bulgarian ONLY — NEVER Russian accent, NEVER soft Russian vowels or melody.`, translations: { en: 'to plan', fr: 'planifier', ar: 'يخطط', fa: 'برنامه‌ریزی کردن', ru: 'планировать', uk: 'планувати' } },
    ...
    { id: 'razglejdam', bulgarian: 'разглеждам, -аш / разгледам, -аш', ttsText: 'разглеждам. разглеждаш. разгледам. разгледаш.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} raz-GLЕ-zhdam, raz-GLЕ-zhdash — hard Bulgarian ж (zh), clear Е in -gled-. Imperfective глеж- never Russian soft accent. NEVER разлгеждам.`, translations: { en: 'to look at, to view', fr: 'regarder, visiter', ar: 'يتفرج', fa: 'نگاه کردن', ru: 'рассматривать / рассмотреть', uk: 'розглядати' } },
    ...
    { id: 'servityor', bulgarian: 'сервитьор, -и', ttsText: 'сервитьор. сервитьори.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Plural сервитьори: ser-vi-TYO-ri — TYO as in тьор, NEVER сервитьоли.`, translations: { en: 'waiter, -s', fr: 'serveur, -s', ar: 'نادل', fa: 'گارسون', ru: 'официант', uk: 'офіціант' } },
    ...
    { id: 'struva-mi-se', bulgarian: 'Струва ми се...', ttsText: 'Струва ми се.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Natural conversational pace — brisk and flowing, NOT slow, NOT choppy/staccato. Three connected words: Stru-VA mi SE — smooth speech, clear final се with audible Е.`, translations: { en: 'I guess..., I think...', fr: 'Il me semble que...', ar: 'يبدو لي أن...', fa: 'به نظرم...', ru: 'Мне кажется...', uk: 'Мені здається...' } },
    { id: 'tolkova', bulgarian: 'толкова', ttsText: 'толкова', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Slightly energetic, clear pace — tol-KO-va. Not slow, not monotone.`, translations: { en: 'so', fr: 'tellement', ar: 'هكذا / جداً', fa: 'اینقدر', ru: 'так', uk: 'так' } },
    ...
    { id: 'hija', bulgarian: 'хижа, -и', ttsText: 'хижа. хижи.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Plural хижи: hi-ZHI — zh as in жаба, NEVER хизи / hi-ZI.`, translations: { en: 'hut, -s; mountain lodge', fr: 'refuge, -s', ar: 'كوخ', fa: 'کلبه', ru: 'хижина', uk: 'хижа' } },
    { id: 'himichesko-chistene', bulgarian: 'химическо чистене', ttsText: 'химическо чистене.', ttsModel: 'pro', ttsPrompt: `${BG_VOCAB_NATIVE} Second word чистене: chis-TE-ne — TE as in теле, noun suffix -ене — NEVER чискане, NEVER чистеме, NEVER чистя.`, translations: { en: 'dry cleaning', fr: 'pressing', ar: 'تنظيف جاف', fa: 'خشک‌شویی', ru: 'химчистка', uk: 'хімчистка' } },
