...
export const exercises: Exercise[] = [
    ...
    tables: [
      {
        ...
        rows: [
          { label: 'аз',        cells: [{ correctAnswers: ['пътувах'],   options: ['пътувах', 'пътува', 'пътувахме', 'пътувахте', 'пътуваха'] }] },
          { label: 'ти',        cells: [{ correctAnswers: ['пътува'],    options: ['пътувах', 'пътува', 'пътувахме', 'пътувахте', 'пътуваха'] }] },
          { label: 'той/тя/то', cells: [{ correctAnswers: ['пътува'],    options: ['пътувах', 'пътува', 'пътувахме', 'пътувахте', 'пътуваха'] }] },
          { label: 'ние',       cells: [{ correctAnswers: ['пътувахме'], options: ['пътувах', 'пътува', 'пътувахме', 'пътувахте', 'пътуваха'] }] },
          { label: 'вие',       cells: [{ correctAnswers: ['пътувахте'], options: ['пътувах', 'пътува', 'пътувахме', 'пътувахте', 'пътуваха'] }] },
          { label: 'те',        cells: [{ correctAnswers: ['пътуваха'],  options: ['пътувах', 'пътува', 'пътувахме', 'пътувахте', 'пътуваха'] }] },
        ],
      },
      {
        name: 'пия (-ИХ)',
        columns: ['минало свършено'],
        rows: [
          { label: 'аз',        cells: [{ correctAnswers: ['пих'],   options: ['пих', 'пи', 'пихме', 'пихте', 'пиха'] }] },
          { label: 'ти',        cells: [{ correctAnswers: ['пи'],    options: ['пих', 'пи', 'пихме', 'пихте', 'пиха'] }] },
          { label: 'той/тя/то', cells: [{ correctAnswers: ['пи'],    options: ['пих', 'пи', 'пихме', 'пихте', 'пиха'] }] },
          { label: 'ние',       cells: [{ correctAnswers: ['пихме'], options: ['пих', 'пи', 'пихме', 'пихте', 'пиха'] }] },
          { label: 'вие',       cells: [{ correctAnswers: ['пихте'], options: ['пих', 'пи', 'пихме', 'пихте', 'пиха'] }] },
          { label: 'те',        cells: [{ correctAnswers: ['пиха'],  options: ['пих', 'пи', 'пихме', 'пихте', 'пиха'] }] },
        ],
      },
      {
        name: 'взема (-ЕХ)',
        columns: ['минало свършено'],
        rows: [
          { label: 'аз',        cells: [{ correctAnswers: ['взех'],   options: ['взех', 'взе', 'взехме', 'взехте', 'взеха'] }] },
          { label: 'ти',        cells: [{ correctAnswers: ['взе'],    options: ['взех', 'взе', 'взехме', 'взехте', 'взеха'] }] },
          { label: 'той/тя/то', cells: [{ correctAnswers: ['взе'],    options: ['взех', 'взе', 'взехме', 'взехте', 'взеха'] }] },
          { label: 'ние',       cells: [{ correctAnswers: ['взехме'], options: ['взех', 'взе', 'взехме', 'взехте', 'взеха'] }] },
          { label: 'вие',       cells: [{ correctAnswers: ['взехте'], options: ['взех', 'взе', 'взехме', 'взехте', 'взеха'] }] },
          { label: 'те',        cells: [{ correctAnswers: ['взеха'],  options: ['взех', 'взе', 'взехме', 'взехте', 'взеха'] }] },
        ],
      },
    ],
...

  {
    ...
    title: 'УПРАЖНЕНИЕ 3',
    instruction: 'Изберете израза за време и правилната форма на глагола.',
    order: 6,
    points: 8,
    layout: 'single',
    sentences: [
      { text: 'Миналата седмица пътувах до Лондон.', blanks: [], correctAnswers: [], isExample: true },
      { text: '_______ _______ кафе с приятели.', blanks: [0, 1], correctAnswers: ['Онзи ден', 'пих'],
        options: [['Онзи ден', 'Утре', 'В момента'], ['пих', 'пи', 'пихме', 'взех']] },
      { text: '_______ _______ билети за концерт.', blanks: [0, 1], correctAnswers: ['Вчера', 'взех'],
        options: [['Вчера', 'Другата седмица', 'Докато'], ['взех', 'взе', 'взехме', 'пих']] },
      { text: '_______ той _______ вода.', blanks: [0, 1], correctAnswers: ['Преди малко', 'пи'],
        options: [['Преди малко', 'Утре', 'В момента'], ['пи', 'пих', 'пихме', 'взе']] },
      { text: '_______ те _______ до морето.', blanks: [0, 1], correctAnswers: ['Миналата година', 'пътуваха'],
        options: [['Миналата година', 'Другата седмица', 'Докато'], ['пътуваха', 'пътува', 'пътувахме', 'взеха']] },
    ],
...

  {
    ...
    rows: [
      ...
      { pronoun: 'той', cells: ['беше'],  ttsText: 'той беше', ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
      { pronoun: 'тя',  cells: ['беше'],  ttsText: 'тя беше',  ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
      { pronoun: 'то',  cells: ['беше'],  ttsText: 'то беше',  ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
      { pronoun: 'ние', cells: ['бяхме'], ttsText: 'ние бяхме', ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
      { pronoun: 'вие', cells: ['бяхте'], ttsText: 'вие бяхте', ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
      { pronoun: 'те',  cells: ['бяха'],  ttsText: 'те бяха', ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
    ],
  } as GrammarTableExercise,
...

  {
    ...
    points: 13,
    questions: [
      { id: 'q1',  left: 'пътувах',   options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-АХ' },
      { id: 'q2',  left: 'спрях',     options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ЯХ' },
      { id: 'q3',  left: 'пих',       options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ИХ' },
      { id: 'q4',  left: 'отидох',    options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ОХ' },
      { id: 'q5',  left: 'взех',      options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ЕХ' },
      { id: 'q6',  left: 'обядвах',   options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-АХ' },
      { id: 'q7',  left: 'продължих', options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ИХ' },
      { id: 'q8',  left: 'ядох',      options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ОХ' },
      { id: 'q9',  left: 'показах',   options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-АХ' },
      { id: 'q10', left: 'смях се',   options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ЯХ' },
      { id: 'q11', left: 'говорих',   options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ИХ' },
      { id: 'q12', left: 'дойдох',    options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-ОХ' },
      { id: 'q13', left: 'седнах',    options: ['-АХ', '-ЯХ', '-ИХ', '-ОХ', '-ЕХ'], correctAnswer: '-АХ' },
    ],
...

  {
    ...
    ttsParagraphs: [
      'Миналата седмица имах сериозен проблем с кръста и трябваше да отида при лекар. Той искаше да ми сложи инжекция против болките, но аз не исках. Страхувах се много. Тогава той ми предписа болкоуспокояващи таблетки, но не можах да ги купя, защото аптеката беше затворена.',
      'Взех ги на следващия ден. Пих ги няколко дена, защото исках да оздравея бързо. Благодарение на това лекарство сега съм добре.',
    ],
    paragraphVoiceGenders: ['female', 'female'],
    showDictionary: true,
    ...
    tables: [
      {
        ...
        rows: [
          { label: 'аз',        cells: [{ correctAnswers: ['можах'],   options: ['можах', 'можа', 'можахме', 'можахте', 'можаха'] }] },
          { label: 'ти',        cells: [{ correctAnswers: ['можа'],    options: ['можах', 'можа', 'можахме', 'можахте', 'можаха'] }] },
          { label: 'той/тя/то', cells: [{ correctAnswers: ['можа'],    options: ['можах', 'можа', 'можахме', 'можахте', 'можаха'] }] },
          { label: 'ние',       cells: [{ correctAnswers: ['можахме'], options: ['можах', 'можа', 'можахме', 'можахте', 'можаха'] }] },
          { label: 'вие',       cells: [{ correctAnswers: ['можахте'], options: ['можах', 'можа', 'можахме', 'можахте', 'можаха'] }] },
          { label: 'те',        cells: [{ correctAnswers: ['можаха'],  options: ['можах', 'можа', 'можахме', 'можахте', 'можаха'] }] },
        ],
      },
    ],
  } as TableFillExercise,
    ...
    sections: [
      ...
      { id: 'б.', lines: [
        { text: 'Знаеш ли, че Росица е заминала за Гърция?', voiceGender: 'female',
          ttsText: 'Знаеш ли, че Росѝца е заминала за Гърция.' },
    ...
    tables: [
      {
        ...
        columns: ['„съм"'],
        rows: [
          { label: 'аз ___ работил(а)', cells: [{ correctAnswers: ['съм'], options: ['съм', 'си', 'е', 'сме', 'сте', 'са'] }] },
          { label: 'ти ___ работил(а)', cells: [{ correctAnswers: ['си'],  options: ['съм', 'си', 'е', 'сме', 'сте', 'са'] }] },
          { label: 'той ___ работил',   cells: [{ correctAnswers: ['е'],   options: ['съм', 'си', 'е', 'сме', 'сте', 'са'] }] },
          { label: 'тя ___ работила',   cells: [{ correctAnswers: ['е'],   options: ['съм', 'си', 'е', 'сме', 'сте', 'са'] }] },
          { label: 'то ___ работило',   cells: [{ correctAnswers: ['е'],   options: ['съм', 'си', 'е', 'сме', 'сте', 'са'] }] },
          { label: 'ние ___ работили',  cells: [{ correctAnswers: ['сме'], options: ['съм', 'си', 'е', 'сме', 'сте', 'са'] }] },
          { label: 'вие ___ работили',  cells: [{ correctAnswers: ['сте'], options: ['съм', 'си', 'е', 'сме', 'сте', 'са'] }] },
          { label: 'те ___ работили',   cells: [{ correctAnswers: ['са'],  options: ['съм', 'си', 'е', 'сме', 'сте', 'са'] }] },
        ],
      },
    ],
  } as TableFillExercise,
    ...
    examples: [
      {
        ...
        ttsPrompt:
          'Прочетете плавно и естествено на книжовен български, топъл разговорен тон. Лека пауза между изреченията. Въпросите с леко покачване. Без чужд акцент.',
      },
      {
        imageUrl: '',
        text: '',
        lines: [
          'Аз **съм** работил в училище. = Работил **съм** в училище.',
        ],
...

  {
    ...
    rows: [
      ...
      { pronoun: 'излязох', cells: ['излязъл, излязла, излязло, излезли'],
        ttsText: 'излязох, излязъл, излязла, излязло, излезли', ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
      { pronoun: 'облякох', cells: ['облякъл, облякла, облякло, облекли'],
        ttsText: 'облякох, облякъл, облякла, облякло, облекли', ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
      { pronoun: 'съблякох', cells: ['съблякъл, съблякла, съблякло, съблекли'],
        ttsText: 'съблякох, съблякъл, съблякла, съблякло, съблекли', ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
    ],
  } as GrammarTableExercise,
...

  {
    ...
    examples: [
      ...
      { imageUrl: '', text: '', lines: ['**Скоро не** сме се срещали с Ана.'],
        ttsText: 'Скоро не сме се срещали с Ана.', voiceGender: 'male', ttsModel: 'pro', ttsPrompt: B1_GRAMMAR_TTS_PROMPT },
