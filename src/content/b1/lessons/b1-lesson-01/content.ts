...
Урокът включва диалози, кратки текстове и упражнения за практика.`,
  ...
  vocabulary: [
    ...
    { id: 'pohvalya-se', bulgarian: 'похваля се, -иш (виж хваля се)', ttsText: 'похваля се, похвалиш се', ttsModel: 'flash', translations: { en: 'to brag, to boast', fr: 'se vanter', ar: 'يفتخر', fa: 'افتخار کردن', ru: 'хвалиться', uk: 'хвалитися' } },
    ...
    { id: 'spuskam', bulgarian: 'спускам, -аш / спусна, -еш', ttsText: 'спускам, спускаш. спусна, спуснеш', ttsModel: 'flash', translations: { en: 'to lower', fr: 'baisser', ar: 'يُنزِل', fa: 'پایین آوردن', ru: 'опускать', uk: 'опускати' } },
    { id: 'subuzhdam', bulgarian: 'събуждам, -аш / събудя, -иш', ttsText: 'събуждам, събуждаш. събудя, събудиш', ttsModel: 'flash', translations: { en: 'to wake up', fr: 'réveiller', ar: 'يوقظ', fa: 'بیدار کردن', ru: 'будить, просыпаться', uk: 'будити, прокидатися' } },
    { id: 'upravlyavam', bulgarian: 'управлявам, -аш', ttsText: 'управлявам, управляваш', ttsModel: 'flash', translations: { en: 'to control', fr: 'contrôler', ar: 'يتحكم', fa: 'کنترل کردن', ru: 'управлять', uk: 'керувати' } },
    { id: 'hranya-se', bulgarian: 'храня се, -иш', ttsText: 'храня се, храниш се', ttsModel: 'flash', translations: { en: 'to eat', fr: 'manger', ar: 'يأكل', fa: 'غذا خوردن', ru: 'питаться', uk: 'харчуватися' } },
    { id: 'shtora', bulgarian: 'щора, -и', ttsText: 'щора, щори', ttsModel: 'flash', translations: { en: 'blind, -s', fr: 'store, stores', ar: 'ستارة', fa: 'پرده', ru: 'жалюзи, штора', uk: 'щора, щори' } },
  ],
