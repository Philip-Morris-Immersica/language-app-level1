...
export const listeningExercises: Exercise[] = [
  {
    ...
    hideText: true,
    paragraphs: [
      'Надя, Невена и Адриан са в ресторант „София". Те обядват. Надя яде шопска салата и риба. Тя пие минерална вода. Надя не иска десерт. Невена яде мусака и таратор и пие сок от грозде. Тя много обича сладолед и иска сладолед за десерт. Адриан яде пица и пие айран. За десерт иска плодова салата. Адриан плаща 60 лева. Сметката е 55 лева и 5 лева за бакшиш. Надя, Невена и Адриан много обичат ресторант „София".',
    ],
...

  {
    ...
    sentences: [
      ...
      { id: 's6', text: 'Адриан плаща 60 лева.', isTrue: true },
      { id: 's7', text: 'Сметката е 60 лева.', isTrue: false },
    ...
    sentences: [
      {
        ...
        blanks: [6],
        correctAnswers: ['3,00 лв.'],
        options: ['3,00 лв.', '2,50 лв.', '1,50 лв.', '4,00 лв.'],
      },
      {
        text: 'Колко е рестото? — _______',
        blanks: [4],
        correctAnswers: ['1,50 лв.'],
        options: ['1,50 лв.', '0,50 лв.', '2,00 лв.', '3,00 лв.'],
      },
    ],
...
export const grammarExercises: Exercise[] = [
  ...
  // ─── Упражнение 3: КАКЪВ / КАКВА / КАКВО / КАКВИ (8 т.) ──────────────────
  {
    id: 't02-gr-3',
    type: 'workbook_fill_blank',
    instruction: 'Изберете правилния въпрос – КАКЪВ / КАКВА / КАКВО / КАКВИ.',
    order: 10,
    points: 8,
    layout: 'single',
  ...
  // ─── Упражнение 5: Подредете думите в изречения (6 т.) ───────────────────
  {
    ...
    questions: [
      ...
      {
        words: ['лева', '5', 'сметката', 'е', '.'],
        correctSentence: 'Сметката е 5 лева .',
      },
      {
