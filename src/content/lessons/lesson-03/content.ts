...
Count form (masculine, non-persons) — used after numbers, КОЛКО, НЯКОЛКО: +А/-Я
  два лева, три лева, пет лева
  колко лева?, няколко стола, десет сока

Special forms for males (2–4): -(И)МА
  двама студенти (two male students)
  трима лекари (three male doctors)
  четирима мъже (four men)
  (Used only for masculine nouns referring to people.)
...
صيغة العدّ (مذكر، غير أشخاص) — مع الأعداد وКОЛКО وНЯКОЛКО: +А/-Я
  два лева، три лева، пет лева
  колко лева؟، няколко стола، десет сока

صيغ خاصة للذكور (2–4): -(И)МА
  двама студенти (طالبان/طالبون من الذكور)
  трима лекари (ثلاثة أطباء ذكور)
  четирима мъже (أربعة رجال)
  (تُستخدم فقط مع الأسماء المذكرة الدالة على أشخاص.)
...
فرم‌های مخصوص برای مذکر افراد (۲–۴): -(И)МА
  двама студенти (دو دانشجوی مذکر)
  трима лекари (سه پزشک مذکر)
  четирима мъже (چهار مرد)
  (فقط برای اسامی مذکر افراد استفاده می‌شود.)
