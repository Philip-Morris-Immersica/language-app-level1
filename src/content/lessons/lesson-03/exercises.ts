...
export const exercises: Exercise[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'Сервитьор', voiceGender: 'male',   text: '2,50 евро.', translations: { en: '2.50 euros.', ar: '٢٫٥٠ يورو.', fr: '2,50 euros.', fa: '۲٫۵۰ یورو.', uk: '2,50 євро.', ru: '2,50 евро.' } },
        ],
      },
    ],
  ...
  // ORDER 33: Упр. 31 – ТЕКСТОВЕ (Page 33)
  {
    ...
    title: 'ТЕКСТОВЕ',
    instruction:
      'Кликнете върху картинките, за да се запознаете с думите, и слушайте текста. Опитайте се да го прочетете.',
    order: 33,
