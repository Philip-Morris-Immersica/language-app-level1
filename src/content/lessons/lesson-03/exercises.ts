...
export const exercises: Exercise[] = [
  ...
  // ORDER 33: Упр. 31 – ТЕКСТОВЕ (Page 33)
  {
    ...
    paragraphs: [
      'Тихомир обядва в ресторант „Градина". Той яде таратор, печена риба с пържени картофи и шопска салата. За десерт яде крем карамел. Пие газирана вода. Плаща 28 лева. Сметката е 25 лева и три лева за бакшиш. Той обича ресторант „Градина".',
      'Ахмед е арабин. Той обича агнешко месо, не яде свинско. Сега вечеря в арабски ресторант. Той иска агнешки шишчета и хумус, за десерт – баклава. Пие айрян. Сметката е 29 лева.',
  ...
  // ORDER 35: Упр. 33 – Отговорете на въпросите (Page 33)
  {
    ...
    questions: [
      ...
      { id: 'q2', left: 'Колко лева плаща?',                  options: ['25 лева', '28 лева', '29 лева', '30 лева'], correctAnswer: '28 лева' },
      ...
      { id: 'q4', left: 'Колко лева е сметката на Ахмед?',   options: ['25 лева', '28 лева', '29 лева', '30 лева'], correctAnswer: '29 лева' },
