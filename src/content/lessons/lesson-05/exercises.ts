...
export const exercises: Exercise[] = [
...

  {
    ...
    order: 24,
    imageUrl: '/assets/lesson-05/03-upr-02-karta-grad/01-karta-grad-centar.jpg',
    // City map labels: approximate % positions for each institution label
    mapLabels: [
      { x: 13,  y: 9,  name: 'блок' },
      { x: 23,  y: 9,  name: 'хотел' },
      { x: 45,  y: 5,  name: 'университет' },
      { x: 75,  y: 9,  name: 'блок' },
      { x: 91,  y: 9,  name: 'блок' },
      { x: 34,  y: 19, name: 'библиотека' },
      { x: 57,  y: 19, name: 'театър' },
      { x: 87,  y: 19, name: 'болница' },
      { x: 7,   y: 33, name: 'ресторант' },
      { x: 37,  y: 33, name: 'хотел' },
      { x: 63,  y: 33, name: 'аптека' },
      { x: 91,  y: 33, name: 'блок' },
      { x: 7,   y: 67, name: 'музей' },
      { x: 31,  y: 67, name: 'библиотека' },
      { x: 48,  y: 67, name: 'кино' },
      { x: 68,  y: 67, name: 'кафе' },
      { x: 90,  y: 67, name: 'супермаркет' },
    ],
    mapLegend: [
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/04-blok.jpg',        name: 'блок' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/12-hotel.jpg',       name: 'хотел' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/15-universitet.jpg', name: 'университет' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/03-biblioteka.jpg',  name: 'библиотека' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/10-teatar.jpg',      name: 'театър' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/05-bolnitsa.jpg',    name: 'болница' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/13-restorant.jpg',   name: 'ресторант' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/01-apteka.jpg',      name: 'аптека' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/09-muzey.jpg',       name: 'музей' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/08-kino.jpg',        name: 'кино' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/07-kafe.jpg',        name: 'кафе' },
      { imageUrl: '/assets/lesson-05/02-novi-dumi-1-mesta-v-grada/14-supermarket.jpg', name: 'супермаркет' },
    ],
    points: 9,
    sentences: [
...

  {
    ...
    layout: 'qa-split',
    imageUrl: '/assets/lesson-05/05-upr-03-karta-selo/01-karta-selo-centar.jpg',
    // Village map labels: approximate % positions for each institution label
    mapLabels: [
      { x: 10,  y: 7,  name: 'къща' },
      { x: 25,  y: 7,  name: 'улица' },
      { x: 55,  y: 7,  name: 'детска площадка' },
      { x: 88,  y: 7,  name: 'парк' },
      { x: 10,  y: 33, name: 'джамия' },
      { x: 37,  y: 35, name: 'паметник' },
      { x: 57,  y: 26, name: 'училище' },
      { x: 77,  y: 32, name: 'пазар' },
      { x: 60,  y: 57, name: 'църква' },
      { x: 77,  y: 58, name: 'река' },
      { x: 33,  y: 55, name: 'мост' },
      { x: 10,  y: 72, name: 'поща' },
      { x: 25,  y: 72, name: 'магазин' },
      { x: 58,  y: 72, name: 'gemeente / община' },
      { x: 90,  y: 72, name: 'пазар' },
    ],
    mapLegend: [
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/04-kashta.jpg',             name: 'къща' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/02-detska-ploshtadka.jpg',  name: 'детска площадка' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/09-pametnik.jpg',           name: 'паметник' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/03-dzhamiya.jpg',           name: 'джамия' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/14-uchilishte.jpg',         name: 'училище' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/06-most.jpg',               name: 'мост' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/13-reka.jpg',               name: 'река' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/15-tsarkva.jpg',            name: 'църква' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/12-poshta.jpg',             name: 'поща' },
      { imageUrl: '/assets/lesson-05/04-novi-dumi-2-mesta/07-obshtina.jpg',           name: 'община' },
    ],
    sentences: [
      {
