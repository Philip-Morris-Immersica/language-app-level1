...
export const exercises: Exercise[] = [
  // ORDER 1: Exercise 1 - Flags (Page 9, top)
  {
    ...
    images: [
      ...
      { id: 'iran', imageUrl: '/assets/lesson-01/exercise-01-flags/flag-iraq.jpg', correctLabel: 'Иран' },
      { id: 'iraq', imageUrl: '/assets/lesson-01/exercise-01-flags/flag-iran.jpg', correctLabel: 'Ирак' },
  ...
  // ORDER 2: НОВИ ДУМИ 2 - Countries vocabulary (Page 10, top) - NOT AN EXERCISE!
  {
    ...
    order: 2,
    cards: [
      // Row 1: България — 4 separate cards with individual images (as in textbook)
      { id: 'bulgaria',  imageUrl: '/assets/lesson-01/novi-dumi-2-countries/bulgaria.jpg',  label: 'България' },
      { id: 'bulgarin',  imageUrl: '/assets/lesson-01/novi-dumi-2-countries/bulgarin.jpg',  label: 'българин' },
  ...
  // ORDER 3: Exercise 4 - Syllable blocks (Page 10, middle) - Custom component
  {
    ...
    puzzles: [
      ...
      { id: 'puzzle4', syllables: ['НЕЦ', 'И', 'КРА', 'У'], correctWord: 'УКРАИНЕЦ' },
  ...
  // ORDER 12: Exercise 8 - Fill with flags (Page 12, top right)
  {
    ...
    sentences: [
      ...
      { id: '5', pronoun: 'Вие', name: 'Зайнеб и Али', country: 'Ирак', flagUrl: '/assets/lesson-01/exercise-01-flags/flag-iran.jpg', correctVerb1: 'сте', correctVerb2: 'сте' },
      { id: '6', pronoun: 'Те', name: 'Амир и Ширин', country: 'Иран', flagUrl: '/assets/lesson-01/exercise-01-flags/flag-iraq.jpg', correctVerb1: 'са', correctVerb2: 'са' },
    ],
