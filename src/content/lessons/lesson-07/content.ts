...
export const content: LessonContent = {
  ...
  vocabulary: [
    ...
    { id: 'predi-obed',       bulgarian: 'преди обед',          translations: { en: 'before noon',          fr: 'avant midi',              ar: 'قبل الظهر',            fa: 'قبل از ظهر',            ru: 'до полудня',              uk: 'до обіду'                } },
    { id: 'na-obed',          bulgarian: 'на обед',             translations: { en: 'at noon, at lunch',    fr: 'à midi',                  ar: 'في الظهيرة',           fa: 'ظهر',                   ru: 'в обед',                  uk: 'в обід'                  } },
    ...
    { id: 'utro',             bulgarian: 'утре',                translations: { en: 'tomorrow',             fr: 'demain',                  ar: 'غداً',                 fa: 'فردا',                  ru: 'завтра',                  uk: 'завтра'                  } },
    ...
    { id: 'yugoisotk',        bulgarian: 'югоизток',            translations: { en: 'Southeast',            fr: 'sud-est',                 ar: 'جنوب شرقي',            fa: 'جنوب شرقی',             ru: 'юго-восток',              uk: 'південний схід'          } },
