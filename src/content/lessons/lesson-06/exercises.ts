...
export const exercises: Exercise[] = [
  ...
  // ORDER 22: Упр. 15 – Попълнете семейни връзки (Page 58)
  {
    ...
    points: 8,
    questions: [
      { id: 'q1', left: 'Латифа е ________ на Расул.', options: ['майка', 'баба', 'леля', 'съпруга', 'дядо', 'внучка'], correctAnswer: 'майка' },
      { id: 'q2', left: 'Расул е ________ на Мариам.', options: ['съпруг', 'брат', 'баща', 'чичо', 'дядо', 'внук'], correctAnswer: 'съпруг' },
      { id: 'q3', left: 'Саид е ________ на Санди.', options: ['баща', 'дядо', 'чичо', 'брат', 'съпруг', 'внук'], correctAnswer: 'баща' },
      { id: 'q4', left: 'Санди е ________ на Амира.', options: ['леля', 'майка', 'баба', 'съпруга', 'сестра', 'внучка'], correctAnswer: 'майка', alternateCorrectAnswers: ['леля'] },
      { id: 'q5', left: 'Расул е ________ на Ахмед.', options: ['брат', 'баща', 'чичо', 'дядо', 'съпруг', 'внук'], correctAnswer: 'брат' },
      { id: 'q6', left: 'Джоана е ________ на Латифа.', options: ['внучка', 'внук', 'дъщеря', 'леля', 'баба', 'сестра'], correctAnswer: 'внучка' },
      { id: 'q7', left: 'Саид е ________ на Сара.', options: ['дядо', 'баща', 'чичо', 'брат', 'съпруг', 'внук'], correctAnswer: 'дядо' },
      { id: 'q8', left: 'Ездар е ________ на Саид и Латифа.', options: ['внук', 'внучка', 'дете', 'чичо', 'брат', 'баща'], correctAnswer: 'внук' },
    ],
  ...
  // ORDER 28: Упр. 21 – Попълнете таблицата (прилагателни, родове) (Page 60)
  {
    ...
    type: 'table_fill',
    title: 'УПРАЖНЕНИЕ 21',
    instruction: 'Попълнете таблицата.',
    order: 28,
    points: 5,
    paragraphs: [],
    tables: [
      {
        name: 'Прилагателни — стар, стара, старо, стари (Модел)',
  ...
  // ORDER 29: Упр. 22 – Довършете списъка по модела (Page 60)
  {
    ...
    type: 'table_fill',
    title: 'УПРАЖНЕНИЕ 22',
    instruction: 'Довършете списъка по модела. Модел: умен, умна, умно, умни',
    order: 29,
    points: 5,
    paragraphs: [],
    tables: [
      {
        name: 'Прилагателни — родове',
        columns: ['мъжки', 'женски', 'среден', 'множествено'],
        rows: [
          {
            label: '1',
