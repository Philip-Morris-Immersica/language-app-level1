...
export const B1_TRANSLATIONS: Record<string, Record<SupportedLang, string>> = {
  ...
  'b1.exercise.chronologyOrder': {
    bg: 'Подредете тези периоди от българската история хронологически.',
    ar: 'رتّبوا هذه الفترات من التاريخ البلغاري ترتيبًا زمنيًا.',
    fr: 'Classez ces périodes de l’histoire bulgare par ordre chronologique.',
    en: 'Arrange these periods of Bulgarian history in chronological order.',
    fa: 'این دوره‌های تاریخ بلغارستان را به ترتیب زمانی مرتب کنید.',
    uk: 'Розташуйте ці періоди болгарської історії в хронологічному порядку.',
    ru: 'Расположите эти периоды болгарской истории в хронологическом порядке.',
  },
