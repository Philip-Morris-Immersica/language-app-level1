...
export const B1_TRANSLATIONS: Record<string, Record<SupportedLang, string>> = {
  ...
  'b1.exercise.chronologyOrder': {
    bg: 'Плъзнете периодите към правилния номер, за да ги подредите хронологически.',
    ar: 'اسحب الفترات إلى الرقم الصحيح لترتيبها ترتيبًا زمنيًا.',
    fr: 'Faites glisser les périodes vers le bon numéro pour les classer chronologiquement.',
    en: 'Drag the periods onto the correct number to put them in chronological order.',
    fa: 'دوره‌ها را به شمارهٔ درست بکشید تا به ترتیب زمانی مرتب شوند.',
    uk: 'Перетягніть періоди до правильного номера, щоб розташувати їх у хронологічному порядку.',
    ru: 'Перетащите периоды к правильному номеру, чтобы расположить их в хронологическом порядке.',
  },
