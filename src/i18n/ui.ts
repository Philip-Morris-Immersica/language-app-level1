...
export const UI_TRANSLATIONS: Record<string, Record<SupportedLang, string>> = {
  ...
  'nav.level':          { bg: 'Ниво A1',       ar: 'المستوى A1',     fr: 'Niveau A1',     en: 'Level A1',    fa: 'سطح A1',       uk: 'Рівень A1',     ru: 'Уровень A1'    },
  ...
  'home.description':   { bg: 'Цифрова платформа на UNHCR за изучаване на български език за бежанци. Безплатни интерактивни уроци, упражнения и тестове за ниво A1–A4.', ar: 'منصة UNHCR الرقمية لتعلم اللغة البلغارية للاجئين. دروس تفاعلية مجانية وتمارين واختبارات للمستوى A1–A4.', fr: 'Plateforme numérique du HCR pour apprendre le bulgare aux réfugiés. Leçons interactives gratuites, exercices et tests pour le niveau A1–A4.', en: 'UNHCR digital platform for learning Bulgarian for refugees. Free interactive lessons, exercises and tests for level A1–A4.', fa: 'پلتفرم دیجیتال کمیساریای عالی پناهندگان برای یادگیری زبان بلغاری. دروس تعاملی رایگان، تمرین‌ها و آزمون‌ها برای سطح A1–A4.', uk: 'Цифрова платформа УВКБ ООН для вивчення болгарської мови для біженців. Безкоштовні інтерактивні уроки, вправи та тести для рівня A1–A4.', ru: 'Цифровая платформа УВКБ ООН для изучения болгарского языка для беженцев. Бесплатные интерактивные уроки, упражнения и тесты для уровня A1–A4.' },
  ...
  'home.statsBar':      { bg: '11 урока · Ниво A1–A4 · Безплатно', ar: '11 درساً · المستوى A1–A4 · مجاناً', fr: '11 leçons · Niveaux A1–A4 · Gratuit', en: '11 lessons · Level A1–A4 · Free', fa: '۱۱ درس · سطح A1–A4 · رایگان', uk: '11 уроків · Рівень A1–A4 · Безкоштовно', ru: '11 уроков · Уровень A1–A4 · Бесплатно' },
