...
export const UI_TRANSLATIONS: Record<string, Record<SupportedLang, string>> = {
  ...
  'grammar.l01.g2.instruction': {
    bg: 'Запознайте се с формите на глагола съм с лични местоимения: аз съм, ти си, той/тя е...',
    en: 'Learn the forms of the verb СЪМ with personal pronouns: аз съм, ти си, той/тя е...',
    ar: 'تعرّف على صيغ الفعل СЪМ مع الضمائر الشخصية: аз съм، ти си، той/тя е...',
    fr: 'Découvrez les formes du verbe СЪМ avec les pronoms personnels\u00a0: аз съм, ти си, той/тя е...',
    fa: 'با شکل‌های فعل СЪМ با ضمایر شخصی آشنا شوید: аз съм, ти си, той/тя е...',
    uk: 'Ознайомтеся з формами дієслова СЪМ з особовими займенниками: аз съм, ти си, той/тя е...',
    ru: 'Познакомьтесь с формами глагола СЪМ с личными местоимениями: аз съм, ти си, той/тя е...',
  },
  ...
  'grammar.l01.g4.instruction': {
    bg: 'Запознайте се с въпросителни изречения. Кликнете върху картинката за да чуете.',
    en: 'Learn question sentences. Click the image to listen.',
    ar: 'تعرّف على الجمل الاستفهامية. انقر على الصورة للاستماع.',
    fr: 'Découvrez les phrases interrogatives. Cliquez sur l\'image pour écouter.',
    fa: 'با جملات پرسشی آشنا شوید. برای شنیدن روی تصویر کلیک کنید.',
    uk: 'Ознайомтеся з питальними реченнями. Натисніть на зображення, щоб почути.',
    ru: 'Познакомьтесь с вопросительными предложениями. Нажмите на картинку, чтобы услышать.',
  },
  'grammar.l01.g5.instruction': {
    bg: 'Запознайте се с глагол съм – сегашно време',
    en: 'Learn the verb СЪМ (to be) — present tense',
    ...
    uk: 'Ознайомтеся з дієсловом СЪМ (бути) — теперішній час',
    ru: 'Познакомьтесь с глаголом СЪМ (быть) — настоящее время',
  },

  // Lesson 2
  'grammar.l02.g1.instruction': {
    bg: 'Запознайте се с въпроса и отговора за предмети',
    en: 'Learn how to ask and answer about objects',
    ar: 'تعرّف على أسلوب السؤال والإجابة عن الأشياء',
    fr: 'Découvrez comment poser des questions et répondre sur les objets',
    fa: 'با روش پرسش و پاسخ درباره اشیاء آشنا شوید',
    uk: 'Ознайомтеся з питаннями та відповідями про предмети',
    ru: 'Познакомьтесь с вопросами и ответами о предметах',
  },
  'grammar.l02.g2.instruction': {
    bg: 'Запознайте се с глагола обичам – всички лица',
    en: 'Learn the verb ОБИЧАМ (love/like) — all persons',
    ar: 'تعرّف على الفعل ОБИЧАМ (أحبّ) في جميع صيغ الضمائر',
    fr: 'Découvrez le verbe ОБИЧАМ (aimer) — toutes les personnes',
    fa: 'فعل ОБИЧАМ (دوست داشتن) را در همه صیغه‌ها یاد بگیرید',
    uk: 'Ознайомтеся з дієсловом ОБИЧАМ (любити) — всі особи',
    ru: 'Познакомьтесь с глаголом ОБИЧАМ (любить) — все лица',
  },
